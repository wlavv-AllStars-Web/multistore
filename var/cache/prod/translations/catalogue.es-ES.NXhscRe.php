...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'Click the following link to track the delivery of your order' => 'Haga clic en el siguiente enlace para realizar el seguimiento de la entrega de su pedido',
    'Status' => 'Estado',
    'Date' => 'Fecha',
    'Follow your order\'s status step-by-step' => 'siga paso a paso, la situación de su pedido',
    'Message' => 'Mensaje',
    'You have requested gift wrapping for this order.' => 'Ha solicitado envoltorio de regalo para este pedido.',
    'You have given permission to receive your order in recycled packaging.' => 'Usted ha dado permiso para recibir su pedido en embalaje reciclado.',
    'Download your invoice as a PDF file.' => 'Descargue su factura en formato PDF.',
    'Order Reference %reference% - placed on %date%' => 'Referencia de pedido %reference% - realizada el %date%',
    'Order details' => 'Detalles del pedido',
    'View credit slip' => 'Ver comprobante de crédito',
    'Credit slip' => 'Deslizamiento de credito',
    'Credit slips you have received after canceled orders.' => 'Notas de crédito que ha recibido después de pedidos cancelados.',
    ...
    'If the conditions of return listed above are not respected, we reserve the right to refuse your package and/or reimbursement.' => 'Si no se respetan las condiciones de devolución indicadas anteriormente, nos reservamos el derecho de rechazar su paquete y/o reembolso.',
    'Please let us know if you have any questions.' => 'Por favor, háganos saber si usted tiene alguna pregunta.',
    'When we receive your package, we will notify you by email. We will then begin processing order reimbursement.' => 'Cuando recibamos su paquete, le notificaremos por correo electrónico. Luego comenzaremos a procesar el reembolso del pedido.',
    'Please check the [1]returns form[/1] for the correct address.' => 'Por favor revise el [1]formulario de devoluciones[/1] para obtener la dirección correcta.',
    ...
    'All merchandise must be returned in its original packaging and in its original state.' => 'Toda mercancía debe ser devuelta en su embalaje original y en su estado original.',
    ...
    'Search again what you are looking for' => 'Busca de nuevo lo que procuras',
  ...
  array (
    ...
    'There is %product_count% item in your cart.' => 'Hay %product_count% artículos en su carrito.',
    'Select your payment method' => 'Seleccione un método de pago',
    'Privacy policies' => 'Políticas de privacidad',
    'I declare that I have read and accept the privacy policies in force. To view the privacy policies, please click on:' => 'Declaro que he leído y acepto las políticas de privacidad vigentes. Para consultar las políticas de privacidad, por favor haga clic en:',
    'Use another address for invoice ?' => '¿Entregar a una dirección diferente?',
    'Contact us to update' => 'Contáctanos para actualizar sus datos',
    ...
    'please choose' => 'Por favor seleccione un país',
    'State' => 'Estado',
    'City is required' => 'Se requiere ciudad',
    'City is not valid' => 'La ciudad no es válida.',
    'City' => 'Ciudad ',
    'Other is required' => 'Se requiere mensaje',
    'Other is not valid' => 'El mensaje no es válido',
    'Additional information' => 'Información adicional',
    'Address Complement is required' => 'Se requiere Dirección Complementaria',
    'Address Complement is not valid' => 'La Dirección Complementaria no es válida',
    ...
    'Company is not valid' => 'La empresa no es válida',
    'Company' => 'Empresa',
    ...
    'First name' => 'Nombre',
    'Alias is required' => 'Se requiere alias',
    'Alias is not valid' => 'Alias ​​no es válido',
    'Alias' => 'Alias',
    'Yes' => 'Sí',
    'No' => 'No',
    'Public Administration' => 'Administración Pública',
    'EPC address is required' => 'Se requiere la dirección EPC',
    'PEC address is not valid' => 'La dirección PEC no es válida',
    'PEC address' => 'dirección PEC',
    'SDI code is required' => 'Se requiere código SDI',
    'SDI code is not valid' => 'El código SDI no es válido',
    'SDI code' => 'código IDE',
    'Private' => 'Privado',
    'Customer type' => 'Tipo de cliente',
    'VAT number is required' => 'Se requiere el número de IVA',
    'VAT number is not valid' => 'El número de IVA no es válido',
    'VAT number' => 'Número de IVA',
    'Identification number is required' => 'Se requiere número de identificación',
    'Identification number is not valid' => 'El número de identificación no es válido.',
    'Identification number' => 'Número de identificación',
    'Mobile phone is required' => 'Se requiere teléfono móvil',
    'Mobile phone is not valid' => 'El teléfono móvil no es válido.',
    'Mobile phone' => 'Teléfono móvil',
    'Privacy' => 'Confidencialidad',
    'Conditions' => 'Condiciones',
    'I have read and accept the current terms, conditions and policies.' => 'He leído y acepto la política, condiciones y terminos de uso',
    'Deliver to a different address?
' => '¿Entregar a una dirección diferente?',
    'Billing address' => 'Datos de facturación',
    'Qty' => 'Cant.',
    'Product' => 'Producto',
    'IMMEDIATE PROCESSING' => 'Gestión inmediata ',
    'CREDIT CARD' => 'TARJETA DE CRÉDITO',
    'PROCESSING UP TO 48H' => 'Gestion hasta 48H',
    'BANK TRANSFER' => 'TRANSFERENCIA BANCARIA',
    'VAT' => 'IVA',
    'Reference' => 'Referencia',
    'Price' => 'Precio',
    'Pick up with your carrier' => 'Solicita una recogida con su empresa de transporte',
    'Deliver to a different address?' => 'Entregar a una direccion diferente? ',
    'Door Nº' => 'Puerta',
    ...
    'fees' => 'de coste',
    'No fees' => 'Sin costes',
    'Stairs number is not valid' => 'El número de escalera no es válido',
    'Floor number is not valid' => 'El número de piso no es válido',
    'Building number is not valid' => 'El número de edificio no es válido',
    'Door number is not valid' => 'El número de puerta no es válido',
    ...
    'Montant' => 'Total',
    'Stairs number is required' => 'Se requiere el número de escaleras.',
    'Floor number is required' => 'Se requiere el número de piso',
    'Building number is required' => 'Se requiere el número de edificio',
    'Shipping' => 'Envío',
  ...
  array (
    'Become a Supplier' => 'Sea Revendedor',
    'Become a Dealer' => 'Sea Proveedor',
    'If you don’t make the sale, we don’t make the sale! Our design and communication teams, with the support of our IT department, are always working to provide our customers with the latest and best marketing resources. Available to all our partners/customers, these precious resources feature updated catalogues, CSV integration files, API feeds, product photos and digital content specific to each brand. Our newsletters and social media presence keep you informed, without any delay, of upcoming events, new products, new brands and the global news from our industry.' => 'Nuestros equipos de diseño y comunicación, con el apoyo de nuestro departamento web, trabajan a diario para crear las herramientas de marketing requeridas por nuestros clientes para facilitar la venta de los productos que ofrecemos. Estos importantes recursos, disponibles para nuestros socios / clientes, incluyen catálogos actualizados, archivos de integración CSV, feeds API, fotos de productos y contenidos digitales específicos para cada marca. El uso de herramientas de marketing y comunicación como newsletters o redes sociales nos permite mantener informados a nuestros clientes, sin demora, de las novedades globales de nuestra industria (nuevas marcas, nuevos productos, eventos...).',
    'Our purchasing department, made up of enthusiasts with solid knowledge of the market and products, works in close collaboration with each brand we carry, to offer the best, latest products ahead of the trend. In addition to the daily listing of new products added to our catalogues, we are always working on adding to our line card—only brands that meet our very strict quality requirements. Already with an exclusive offering of more than 30 specialized, performance enhancing brands, All Stars Distribution is your single source for the material you need to bring your customers’ projects to completion.' => 'Nuestro departamento de compras, formado por un equipo de entusiastas con sólidos conocimientos del mercado y de los productos, trabaja en estrecha colaboración con cada una de las marcas que distribuimos, con el fin de ofrecer una línea de productos a la vanguardia de la tendencia. Además de la lista diaria de nuevos productos que se agregan a nuestros catálogos, también enriquecemos regularmente nuestra oferta con marcas producidas por fabricantes líderes que cumplen con nuestros estrictos requisitos de calidad. Con más de 30 marcas de referencia, All Stars Distribution es el distribuidor exclusivo con la gama más amplia de piezas de alto rendimiento en Europa, lo que permite a nuestros clientes obtener los productos necesarios para la realización de sus proyectos en un solo lugar.',
    'Our online platform, developed in-house by our IT department, is constantly evolving to offer our customers more and more digital tools! Among other things, through our trade portal you can consult our products and stock levels, see the Retail Prices and your discounts, place your orders and follow their progress until the final delivery. In a few clicks, you can track your parcels, check your proforma and final invoices, see your statistics, manage your account or contact our support teams--currently available in 5 languages (French, English, Spanish, Portuguese and Romanian). Offering a unique platform in Europe, exclusively dedicated to wholesale, All Stars Distribution has all the products and services required to support and develop your business!' => 'Nuestra plataforma online, desarrollada exclusivamente por nuestros equipos, está en constante evolución para ofrecer a nuestros clientes cada vez más herramientas digitales. A través de nuestro portal puede, entre otras cosas, consultar nuestros productos y nivel de stock, los PVP y sus descuentos, realizar sus pedidos y seguirlos hasta la entrega. Con unos pocos Clics, puede rastrear sus paquetes, consultar sus presupuestos y facturas, sus estadísticas, administrar su cuenta o comunicarse con nuestros equipos de soporte actualmente disponibles en 5 idiomas (francés, inglés, español, portugués y rumano). Ofreciendo una plataforma única en Europa, dedicada exclusivamente a la venta al por mayor, All Stars Distribution ofrece todos los servicios necesarios para respaldar y desarrollar su negocio.',
    'As an international distributor we understand the importance of reliable third-party shipping partnerships and managing shipping expenses. To help limit and simplify these costs, we offer various options to our customers such as Flat Rate shipping charges, applying a scale of only two values per country of destination. Resellers can take advantage of our Drop Shipping option through which your customer receives the product directly from our warehouse, but showing the name of your company as the sender! Our Pick Up option allows our customers to organize the collection and the shipping of their goods via their own carrier.' => 'Debido a que enviamos nuestros productos a todo el mundo, el transporte de paquetes, palés o contenedores procesados por empresas subcontratadas es un punto muy importante debido a los costos que genera. Con el fin de limitar estos costos y los tiempos de tránsito, ofrecemos varias herramientas a nuestros clientes como el Drop Ship que permite el envío de un pedido directamente de nuestros almacenes al cliente final, el cual recibirá un paquete con el nombre de su empresa como remitente. El Bulk Packing, que consiste en agrupar los artículos pedidos en un mínimo de paquetes, lo que reduce considerablemente los costos de flete. Las tarifas de transporte Flat Rate simplifican al máximo los gastos de envío, aplicando una escala de dos valores por país de destino, mientras que la opción Pick Up permite a nuestros clientes organizar la recogida de sus mercancías a través de su propio transportista.',
    'Order management is at the foundation of our business. Our efficiency in picking, packing and dispatching will determine the level of satisfaction of your customers. To ensure a fast and reliable operation we use a specific Order Fulfillment Software developed in-house by our Information Technology Team. Our proprietary software, called "All Stars Log", applied to the picking, packing and reception, ensures a "double check control" providing us an error rate close to 0! Our system’s responsiveness and processing capacity assist us in getting 94% of orders processed and shipped, using premium packaging accessories, in less than 6 hours. Retail quality service for the wholesale market.' => 'La gestión de pedidos es la base de nuestro negocio. El Picking, el Packing y la expedición de sus pedidos de manera rápida determinará el nivel de satisfacción de sus clientes. Para asegurar un proceso logístico confiable y rápido, utilizamos un software de preparación de pedidos desarrollado internamente por nuestro equipo de IT combinando la sinergia de 3 herramientas que son el PDA/SCAN, la detección por vídeo y la escala 3D. Este Software llamado “ALLStars Log” aplicado al Picking, al Packing y a la Recepción, asegura un “doble control” permitiéndonos una tasa de error cercana a cero. Gracias a una excelente capacidad de respuesta y de procesamiento, el 94% de los pedidos en preparación se procesan en menos de 6 horas, utilizando accesorios de empaque premium, lo que garantiza un servicio de calidad minorista en un mercado mayorista.',
    'As a wholesaler, the importance of inventory, having it and managing it, cannot be overstated. All Stars Distribution places the highest priority on maintaining the depth and breadth of our inventory all year round. To quickly supply a wide range of specialized products, often manufactured in small quantities to serve the just-in-time market, WE STOCK 98% of our partner manufacturers’ product lines. By choosing All Stars Distribution as a supplier for your performance parts, you will have a direct access to the largest stock of niche market products in Europe, without any financial, human or logistical constraints! Our Warehouse Management and Enterprise Resource Planning Systems, developed in-house by our Information Technology Team, allow us to limit stockouts as much as possible using extremely reliable purchasing algorithms for quick order fulfillment!' => 'El inventario es la base fundamental para un mayorista, motivo por el cual All Stars Distribution concede gran importancia a mantener un volumen significativo de inventario durante todo el año. Para el rápido suministro de una amplia gama de productos particulares, fabricados en pequeñas cantidades por fabricantes que a menudo trabajan en un flujo justo a tiempo, almacenamos el 98% de las líneas de productos de nuestros socios fabricantes en 3 almacenes completamente automatizados. Al elegir All Stars Distribution como proveedor, tendrá acceso directo al mayor stock de productos de alto rendimiento en Europa, sin restricciones financieras, humanas o logísticas. Nuestro sistema de gestión de almacenes (WMS) y de stock (ERP) desarrollados internamente por nuestros equipos de IT nos permiten limitar el desabastecimiento tanto como sea posible mediante el uso de algoritmos de compra extremadamente confiables.',
    'View More' => 'Ver Más',
    'Supplying over 30 top of the line brands to automotive performance professionals worldwide, All Stars Distribution is one of the largest European wholesalers of performance and design parts. Dedicated to serving shops, tuners, e-dealers and other resellers, All Stars Distribution is committed to employing the best of inventory management and distribution practices to get our customers the performance parts they need to satisfy their customers.' => 'Como proveedor de más de 30 marcas a profesionales del mercado del alto rendimiento en todo el mundo, All Stars Distribution es un mayorista europeo de piezas performance y diseño, conocido como uno de los más grandes del mercado debido a su gran red de distribución y su nivel de stock. Clasificado como el mayor distribuidor europeo de piezas multimarca de alto rendimiento, All Stars Distribution se dedica únicamente a la venta al por mayor y utiliza sus almacenes automatizados para entregar, en un mínimo de tiempo, todas las piezas requeridas por sus clientes y socios (talleres, turners o e-dealers) para llevar a cabo los proyectos y cumplir con los requerimientos de los consumidores finales.',
    'Profile' => 'Perfil',
  ),
  'ShopThemeAbout' => 
  array (
  ...
  array (
    'European leader in the Automotive Distribution Industry, All Stars Distribution supplies daily hundreds specialized professionals around the world. ' => 'Líder europeo en distribución de piezas performance para automóviles, All Stars Distribution abastece diariamente a cientos de profesionales especializados en todo el mundo. ',
    'Why choose us ?' => '¿ Por qué elegirnos ?',
    'Fill out the become a dealer enquiry form' => 'SOLICITUD DE APERTURA DE CUENTA',
    'Tuning / building' => 'Repro / Preparador',
    'Performance parts' => 'Alto rendimiento',
    'Aftermarket parts' => 'Piezas aftermarket',
    'Activity' => 'Actividad',
    'Active social media' => 'Red social',
    'Active website' => 'Página web',
    'Visibility' => 'Visibilidad',
    'Valid bank account' => 'Cuenta bancaria',
    'Valid business license' => 'Licencia comercial',
    'Valid VAT number' => 'Número de IVA',
    'Trader' => 'Distribuidor',
    'E-dealer' => 'Tienda Online',
    'Tuner' => 'Taller Especializado',
    'Workshop' => 'Tienda',
    'Storefront' => 'Reprogramador',
    'Business' => '',
    '> NEW ACCOUNT REQUIREMENTS <' => '> Condiciones de elegibilidad <',
    'Betting on long-term partnership, we\'re very selective and approve new accounts only for companies matching with our requirements' => 'Al establecer colaboraciones a largo plazo, somos particularmente selectivos y solo abrimos nuevas cuentas para empresas que cumplen con nuestras condiciones de elegibilidad.',
    'Admin' => 'Admin',
  ),
...
Número de IVA',
    ...
    'Market Place Seller' => 'Vendedor en Marketplace',
    'Dyno Shop' => 'Repro',
    'E-dealer' => 'E-dealer',
    'Installer' => 'Taller',
    'Storefront' => 'Tienda',
    'Business Type (Check all that apply)' => 'Tipo de Negocio',
    'Please Select...' => 'Por favor seleccione..',
    'Country' => 'País',
    'Social Media Link' => 'Red Social',
    'Zip Code' => 'Código Postal',
    'City' => 'Ciudad',
    'Website' => 'Página Web',
    ...
    'Submit' => 'Enviar',
    'By my signature, I certify the information I provided on and in connection with this form is true and correct to the best of my knowledge. I also understand that any false statements or deliberate omissions on this form may subject me to legal actions for fraudulent misrepresentation.' => 'Con mi firma, certifico que la información que proporciono en este formulario es verdadera y correcta a mi leal saber y entender. También entiendo que cualquier declaración falsa u omisión deliberada en este formulario puede someterme a acciones legales por tergiversación fraudulenta.',
    'Important notice:' => 'Aviso importante:',
    'Signature' => 'Firma',
    'Comment' => 'Comentario',
    'Current Supplier 3' => 'Proveedor actual 3',
    'Current Supplier 2' => 'Proveedor actual 2',
    'Current Supplier 1' => 'Proveedor actual 1',
    'Main current suppliers' => 'Principales proveedores actuales',
    '1M€ +' => '1M€ +',
    '500K€ to 1M€' => '500K€ a 1M€',
    '100K to 500K€' => '100K a 500K€',
    'Under 100K€' => 'Menos de 100K€',
    'Annual sales volume' => 'Ventas anuales',
    'Diesel' => 'Diesel',
    'Offroad' => '4x4',
    'Classics' => 'Classicos',
    'Muscle' => 'Muscle',
    'JDM' => 'JDM',
    'Reset' => 'Reset',
    'Your request has been successfully sent and a human resources representative will respond to you shortly' => 'Su solicitud ha sido enviada correctamente y un representante de recursos humanos le responderá pronto.',
    'Your enquiry  has been successfully sent and a sales representative will respond to you shortly' => 'Su consulta ha sido enviada correctamente y un representante de ventas le responderá pronto.',
    'Additional information' => 'Información adicional',
  ),
  'ShopThemePayment' => 
  array (
    'Please also note that no items are reserved until payment for the order has been confirmed in our bank account.' => 'Tenga en cuenta también que no se reservan artículos hasta que hayamos recibido la confirmación del pago del pedido en nuestra cuenta bancaria.',
    'Please note that payment by bank transfer will result in additional processing time for the dispatch of an order as it will only be dispatched once payment has been received in our bank account.' => 'Tenga en cuenta que el pago por transferencia bancaria conllevará un tiempo de tramitación adicional para el envío de un pedido, ya que éste sólo se enviará una vez que se haya recibido el pago en nuestra cuenta bancaria. ',
    'Payments by bank transfer must be made within 72 hours after the order has been confirmed. If the payment is not made within this period, your order will be automatically cancelled.' => 'Los pagos por transferencia bancaria deben realizarse dentro de las 72 horas siguientes a la validación del pedido. Si el pago no se realiza dentro de este plazo, su pedido se cancelará automáticamente.',
    'Once you have selected payment by bank transfer on our website, you will receive a confirmation email with the details of our bank account, to which the payment should be made.Please note that these details must be exclusively in the name of ALL STARS DISTRIBUTION and based in Portugal.' => 'Una vez seleccionado el pago por transferencia bancaria en nuestro sitio web, recibirá un correo electrónico de confirmación con los datos de nuestra cuenta bancaria, a la que deberá efectuarse el pago. Tenga en cuenta que estos datos deben estar exclusivamente a nombre de ALL STARS DISTRIBUTION y domiciliados en Portugal.',
    'BANK TRANSFER :' => 'TRANSFERENCIA BANCARIA : ',
    'The total amount paid will be debited immediately and the rest of the process and the update of the order status will be instantaneous. A confirmation will then be sent to you by email as a digital archive.' => 'El importe total pagado se cargará inmediatamente así como el resto del proceso y el estado del pedido se actualizará al instante. A continuación, se le enviará una confirmación por correo electrónico como archivo digital.',
    'In order to validate the payment of an order, the name of the cardholder, its 16-digit number, its expiry date and its cryptogram will be requested by no other organisation other than our online payment service provider Ingenico.' => 'Para validar el pago de un pedido, se solicitará el nombre del titular de la tarjeta, su número de 16 dígitos, su fecha de caducidad y su criptograma, sin necesidad de otra organización que nuestro proveedor de servicios de pago en línea Ingenico.',
    'In the interest of security and confidentiality, all data communicated during the payment procedure is encrypted and only entered on the page of our financial partner Ingenico.' => 'Para garantizar la seguridad y la confidencialidad, todos los datos comunicados durante el procedimiento de pago están codificados y se introducen exclusivamente en la página de nuestro socio financiero Ingenico.',
    'Visa and Mastercard are the accepted bank cards for the payment of an order on our online platform.' => 'Visa y Mastercard son las tarjetas bancarias aceptadas para el pago de un pedido en nuestra plataforma online.',
    'CREDIT CARD :' => 'TARJETA DE CRÉDITO : ',
    'ALL STARS DISTRIBUTION offers two methods of payment :' => 'ALL STARS DISTRIBUTION ofrece dos métodos de pago :',
  ),
  'ShopThemePartners' => 
  array (
    'European platform, founded in 2013 and established in 3 countries, All Stars Motorsport has quickly become a key player in aftermarket automotive performance and design industry. Reseller of the most famous brands, All Stars Motorsport offers the best products at the best prices to allow to offer everyone their own vision of the automobile.' => 'Plataforma Europea, fundada en 2013 y establecida en 3 países, All Stars Motorsport se ha convertido rápidamente en una pieza clave en el sector de la distribución de piezas de alto rendimiento para coches deportivos. Distribuidor de las marcas más importantes del mercado, All Stars Motorsport ofrece los mejores productos a los mejores precios para dar vida a su propia visión del automóvil.',
    'Key partner of the biggest brands in the performance automotive industry, BR-Performance is a key player in the custom tuning software market thanks to solid knowledges and state-of-the-art equipment.' => 'Socio privilegiado de las marcas más importantes del sector de la distribución de piezas de alto rendimiento para coches deportivos, BR-Performance es un actor clave en el mundo de la reprogramación motor gracias a sus sólidos conocimientos y a sus equipos de última generación.',
    'Since 2008, ShifTech has been a specialist in custom tuning software that offers the perfect combination of increased engine power and more economical fuel consumption. Present in France, Belgium and Luxembourg, it is a reference in the market due to its quality of service and its experience.' => 'Desde 2008, ShifTech es especialista en el ámbito de la reprogramación motor ofreciendo soluciones que permiten aumentar el par y la potencia de los vehículos reduciendo al mismo tiempo su consumo de combustible. Presente en Francia, Bélgica y Luxemburgo, es una referencia en el sector por su calidad de servicio y su experiencia.',
    'Since 2003, the company DIGISERVICES is a reliable supplier of high quality and customized tuning software files. French leader with more than 30 auto centers in France, more than 6000 vehicles visit their workshops each year.' => 'Desde 2003, la empresa DIGISERVICES es referencia en el ámbito de la reprogramación motor. Líder francés con una red de más de 30 autocentros en Francia, pasan cada año más de 6000 vehículos por sus talleres.',
    'All Stars Web Solutions is a top range web agency specializing in website design and development, software and application creation, digital marketing, and SEO. Offering the latest technologies IT tools for warehouse management (ERP), cybersecurity, front and back end with optimal ergonomics, they make the management of a website accessible to everyone.' => 'All Stars Web Solutions es una agencia web líder, especializada en el diseño y desarrollo de páginas web, creación de software y aplicaciones, y en marketing digital y SEO. Ofrece las últimas tecnologías en términos de herramientas informáticas para la gestión de almacenes (ERP), ciberseguridad, front y back end con una ergonomía óptima, haciendo así la gestión de una página web accesible para todos.',
    'Norton or Norton by Symantec, is a division of NortonLifeLock based in California and offering a variety of products and services related to digital security. In 2014, it was announced that Norton\'s parent company Symantec would split its business into two units - one focused on security, and one focused on information management, with Norton being placed in the unit focused on security.' => 'NortonLifeLock INC es una compañía de software estadounidense con sede en Tempa, Arizona, que proporciona softwares y servicios de ciberseguridad tanto a clientes finales como a empresas en todo el mundo.',
    'Sonic Tools' => 'Sonic es el especialista en herramientas manuales, cajas de herramientas y soluciones de almacenamiento de alta gama. Con una amplia gama de productos, ofrecen eficiencia, calidad y estilo con soluciones de almacenaje inigualables en su sector. Sus fábricas en los Países Bajos, Alemania y Taiwán mantienen la certificación ISO9001, lo que garantiza los más altos estándares de fabricación.',
    'Smurfit Kappa' => 'Smurfit Kappa es innegablemente un líder de la industria, con más de 350 sitios de producción en todo el mundo, repartidos en 22 países de Europa y 13 países de América. Es el principal productor de embalajes, cajas y Bag-in-box de cartón corrugado en Europa, y el único productor panamericano de cajas y embalajes de cartón corrugado.',
    'Adobe Inc is an American multinational computer software company focused upon the creation on multimedia and creativity software products, with a more recent foray into digital marketing software. Adobe is best known for its Adobe Flash web software, Photoshop image editing software, Adobe Illustrator graphics editor and Acrobat Reader.' => 'Fundada en 1982 en San José, California, Adobe Systems Incorporated es una empresa destacada en el mundo del software por sus programas de edición de páginas web, de vídeo y de imagen digital.',
    'Banco Comercial Português (BCP) is a Portuguese bank, member of the PSI-20 index and the Next 150. It is present in Portugal as Millenium BCP and in Belgium and Luxembourg as Banque BCP. It is also present in other countries and is listed on the Euronext stock exchange. Banque BCP was born in 2001 from the merger of the French branches of the oldest Portuguese financial establishments.' => 'Banco Comercial Português (BCP) es un banco portugués, miembro del índice PSI-20 y del Next 150. Está presente en Portugal bajo el nombre Millenium BCP y en Bélgica y Luxemburgo bajo el nombre Banque BCP. También está presente en otros países y cotiza en la bolsa Euronext. Banque BCP nació en 2001 de la fusión de las sucursales francesas de los establecimientos financieros portugueses más antiguos.',
    'Ingenico is a France-based company, whose business is to provide the technology involved in secure electronic transactions. Its traditional business is based on the manufacture of point of sale (POS) payment terminals, but it also includes complete payment software and related services, also software for merchants.' => 'Ingenico es una empresa con sede en Francia que proporciona sistemas de transacciones financieras electrónicas con alto nivel de seguridad. Su negocio tradicional se basa en la fabricación de terminales de pago en puntos de venta (POS), pero también incluye software de pago completo y servicios relacionados para comerciantes.',
    'Vehicles transport specialist, TrancarPremium uses state-of-the-art logistics tools, allowing the team to offer unparalleled quality of service and great management flexibility. Based in Portugal, the company offers different premium solutions for shipping supercars, racing cars, classics or exotics throughout Europe.' => 'TranscarPremium es una empresa especializada en el transporte de vehículos que utiliza herramientas de logística de última generación para ofrecer un servicio de calidad y una flexibilidad inigualables. Con sede en Portugal, la empresa ofrece diferentes soluciones premium para el transporte de súper coches, coches de carreras, clásicos y exóticos por toda Europa.',
    'A.P. Møller-Mærsk, also known simply as Maersk is a Danish shipping and logistics company founded in 1904 by Arnold Peter Møller and Peter Mærsk Møller. Maersk\'s business activities include shipping, port operation, supply chain management and warehousing. The company is based in Copenhagen, Denmark, with subsidiaries and offices across 130 countries and 108.000 employees worldwide.' => 'El Grupo A.P. Møller-Mærsk, fundado en 1904, es un conglomerado de negocios internacionales con actividades en varias áreas, principalmente en los sectores del transporte y la energía. La compañía es conocida como Maersk y es famosa por su gran negocio de transporte marítimo. Es la compañía de transporte marítimo de mercancías más grande del mundo. Maersk tiene su sede principal en Copenhague, Dinamarca, pero también tiene oficinas en más de 135 países. El grupo tiene 108.000 empleados en todo el mundo.',
    'TNT Express is an international courier delivery services company founded in the Netherlands in 2011 and now a subsidiary of FedEx. TNT offers road and air delivery services in Europe, the region of the Asia Pacific, the Americas, the Middle East, and Africa.' => 'TNT Express es una empresa de servicios de mensajería internacional fundada en los Países Bajos en 2011 y ahora una subsidiaria de FedEx. TNT ofrece servicios de entrega por carretera y aire en Europa, la región de Asia Pacífico, América, Medio Oriente y África.',
    'UPS' => 'United Parcel Service es una empresa postal fundada en 1907. Recibe el sobrenombre de Big Brown, en referencia al color del uniforme de los empleados. Su sede está en Sandy Springs (Georgia), un suburbio de Atlanta. En 2007, UPS empleaba a 430.000 empleados, 320.000 de ellos en Estados Unidos, operaba más de 2.000 vuelos diarios y facturaba 43.000 millones de dólares. Entrega 15,6 millones de paquetes y documentos por día en más de 200 países. UPS, empresa líder mundial en transporte de paquetería express, es también uno de los principales proveedores de servicios, transporte especializado, logística, capital y comercio electrónico.',
    'Website' => 'Website',
    'DPD group is the largest parcel delivery network in Europe, carrying worldwide about 5.3 million parcels daily via 77000 workers through their 4 different brands DPD, Chronopost, SEUR and BRT.' => 'DPDgroup es la mayor empresa de transporte de paquetes en Europa, garantizando el tránsito y la entrega de más de 5 millones de envíos por día a través de sus 4 marcas de distribución (DPD, Chronopost, Seur y BRT).',
  ),
  'ShopThemeTerms' => 
  array (
    'ARTICLE 6: DELIVERY' => 'ARTÍCULO 6: ENTREGA',
    'The transfer of ownership of the product will only take place upon full payment of your order.' => 'La transferencia de propiedad del producto sólo se realizará tras el pago total de su pedido.',
    'You will receive an order confirmation email to the email address you provided when you created your customer account. Check the details and the amount of your order. Correct any errors in advance before making your payment.' => 'Recibirá un correo electrónico de confirmación del pedido en la dirección de correo electrónico proporcionada al crear su cuenta de cliente. Consulta los detalles y el importe de tu pedido. Corrija cualquier error por adelantado antes de realizar su pago. ',
    'To place an order on our site, choose your items and add them to the basket. Confirm the contents of your basket, choose your payment method and tick the box "acceptance of the T&Cs".' => 'Para realizar un pedido en nuestro sitio, elija sus artículos y agréguelos a la cesta. Valida el contenido de tu cesta, elige tu método de pago y marca la casilla "aceptación de CGV ". ',
    'A reply will be sent to you within 48 hours of receiving your request.' => 'Se le realizará una devolución dentro de las 48 horas posteriores a la recepción de su solicitud. ',
    'You can order our products directly on our website if you have a customer account. If you do not have one, you can request one via the following link:' => 'Puede pedir nuestros productos directamente en nuestro sitio web si tiene una cuenta de cliente. Si no dispone de una, puede solicitarlo a través del siguiente enlace:',
    'ARTICLE 5: ORDERING' => 'ARTÍCULO 5: PEDIDO',
    'If you have ordered a product that is unavailable after the validation of your order, you will be informed immediately. We will proceed with the cancellation of your order and you will be refunded immediately if payment for the order has already been made.' => 'Si ha pedido un producto que no está disponible después de la validación de su pedido, se le informará de inmediato. Procederemos a cancelar su pedido y se le reembolsará inmediatamente si ya se ha realizado el pago del pedido.',
    'The available products appear on our site accompanied by the mention "In stock". In order to best meet the expectations of our customers, the availability of our products is regularly updated.' => 'Los productos disponibles aparecen en nuestro sitio acompañados de la mención “En stock”. Para satisfacer mejor las expectativas de nuestros clientes, la disponibilidad de nuestros productos se actualiza periódicamente.',
    'ARTICLE 4: AVAILABILITY OF PRODUCTS' => 'ARTÍCULO 4: DISPONIBILIDAD DE PRODUCTOS',
    'The prices of the products present on the site www.all-stars-distribution.com are indicated in euros excluding taxes (HT).
            ...
            Delivery costs are not included in the prices displayed; they will be visible in a summary sent by email to the customer following the validation of his online order before making the payment.' => 'Los precios de los productos presentes en el sitio www.all-stars-distribution.com se indican en euros sin impuestos (sin IVA).
...
Los gastos de envío no están incluidos en los precios mostrados, serán visibles en un resumen enviado por correo electrónico al cliente tras la validación de su pedido online antes de realizar el pago.',
    'ARTICLE 3: PRICE' => 'ARTÍCULO 3: PRECIO',
    'The customer declares to have read and accepted the general conditions of sale prior to the validation of their order.' => 'El cliente declara haber leído y aceptado las condiciones generales de venta antes de la validación de su pedido.',
    'The website www.all-stars-ditribution.com offers for sale spare parts, accessories and consumables for vehicles and cars. ALL STARS DISTRIBUTION is specialised in the sale of performance spare parts.' => 'El sitio web www.all-stars-ditribution.com vende repuestos, accesorios y consumibles para vehículos y automóviles. ALL STARS DISTRIBUTION se especializa en la venta de repuestos de alto rendimiento. ',
    'ARTICLE 2: PRODUCTS' => 'ARTÍCULO 2: PRODUCTOS',
    'is the property of :' => 'es propiedad de:',
    'The website' => 'El sitio web',
    'ARTICLE 1: MANDATORY INFORMATION' => 'ARTÍCULO 1: INFORMACIÓN OBLIGATORIA',
    'These general terms and conditions of sale apply, without restriction or reservation, to all sales concluded on the website' => 'Estas condiciones generales de venta se aplican, sin restricciones ni reservas, a todas las ventas realizadas en el sitio web',
    'GENERAL CONDITIONS OF SALE' => 'CONDICIONES GENERALES DE VENTA',
    'Please note that payment by bank transfer will result in additional processing time for the dispatch of an order as it will only be dispatched once payment has been received in our bank account.' => 'Tenga en cuenta que el pago mediante transferencia bancaria conlleva un tiempo de tramitación adicional para el envío de un pedido ya que sólo se realizará una vez recibido el pago en nuestra cuenta bancaria. ',
    'Payments by bank transfer must be made within 72 hours after the order has been confirmed. If the payment is not made within this period, your order will be automatically cancelled.' => 'Los pagos por transferencia bancaria deben realizarse dentro de las 72 horas posteriores a la validación del pedido. Si el pago no se realiza dentro de este período, su pedido será cancelado automáticamente.',
    'Once the payment by bank transfer has been selected on our website, you will receive a confirmation email with the details of our bank account, to which the payment must be made. Please note that these details must be exclusively in the name of ALL STARS DISTRIBUTION based in Portugal.' => 'Una vez seleccionado el pago por transferencia en nuestro sitio, recibirá un email de confirmación con los datos de nuestra cuenta bancaria, a la que deberá realizar el pago. Tenga en cuenta que estos datos de contacto deben estar exclusivamente a nombre de ALL STARS DISTRIBUTION y domiciliados en Portugal. ',
    'BANK TRANSFER :' => 'TRANSFERENCIA BANCARIA :',
    'The total amount paid will be debited immediately and the rest of the process and the order status will be updated instantly. A confirmation will then be sent to you by email as a digital archive.' => 'El importe pagado, siendo debitado inmediatamente por su importe total, el resto del proceso y la actualización del estado del pedido serán instantáneos. A continuación, se le enviará una confirmación por correo electrónico como archivo digital. ',
    'In order to validate the payment of an order, the name of the cardholder, its 16-digit number, its expiry date and its cryptogram will be requested by no other organisation other than our online payment service provider Ingenico and only they will have access to it.' => 'Para validar el pago de un pedido se solicitará el nombre del titular de la tarjeta, su número de 16 dígitos, su fecha de caducidad y su criptograma sin que ningún otro organismo que no sea nuestro proveedor de servicios de pago online tenga acceso a ello Ingenico.',
    'In the interest of security and confidentiality, all data communicated during the payment procedure is encrypted entered exclusively on the page of our financial partner Ingenico.' => 'En aras de la seguridad y la confidencialidad, todos los datos comunicados durante el procedimiento de pago se codifican y se ingresan exclusivamente en la página de nuestro socio financiero Ingenico. ',
    'Visa and Mastercard are the bank cards accepted for the payment of an order on our online platform.' => 'Visa y Mastercard son las tarjetas bancarias aceptadas para el pago de un pedido en nuestra plataforma online. ',
    'BANK CARD :' => 'TARJETA DE CRÉDITO :',
    'We offer two methods of payment on our site:' => 'Ofrecemos dos métodos de pago en nuestro sitio:',
    'ARTICLE 7: TERMS OF PAYMENT' => 'ARTÍCULO 7: CONDICIONES DE PAGO',
    'In case of a parcel lost, a claim will be opened with the carrier to carry out in-depth research that may take up to 3 weeks before receiving the confirmation of the parcel loss. Once the loss confirmed by the carrier, a new shipment will be automatically scheduled depending on stock level. No refund will be issued in any case of parcel loss.' => 'En caso de un paquete perdido, se abrirá una reclamación ante el transportista para realizar una investigación exhaustiva. Estas búsquedas pueden tardar hasta 3 semanas antes de que la empresa de transporte emita una confirmación de pérdida. Una vez confirmada la pérdida del paquete, se programará automáticamente un nuevo envío dependiendo de la disponibilidad de los productos que constan en el pedido. No se realizará ningún reembolso en caso de pérdida comprobada de un paquete.',
    'Any complaint must be communicated to our customer service by e-mail within 48 hours (business days) following order’s delivery date, beyond which no complaint will be accepted by the carrier. In all cases of complaints, original packaging must be kept.' => 'Cualquier reclamación deberá ser enviada por correo electrónico a nuestro servicio al cliente dentro de las 48 horas (días laborables) siguientes a la entrega del paquete, más allá de las cuales el transportista no aceptará ninguna reclamación. En todos los casos de reclamación deberá conservarse el embalaje original del paquete.',
    'In case of any issues such as damaged packaging, missing or damaged products, reservations must be reported on the delivery slip to support any claim. It will also be necessary to provide pictures of the visible damages as well as the transport label showing tracking number and recipient\'s information. If this verification cannot be carried out directly with the driver, a written complaint must be sent to the carrier as soon as the damages are noted.' => 'En caso de problema como un embalaje dañado, productos en falta o dañados, se deberán consignar reservas en el albarán de entrega para justificar cualquier reclamación. También será necesario facilitarnos fotografías detalladas de los daños visibles, así como la etiqueta de transporte indicando el número de seguimiento del paquete y los datos del destinatario. Si esta verificación no puede realizarse en presencia del repartidor, se deberá enviar una reclamación por escrito al transportista tan pronto como se advierta el daño.',
    'We strongly recommend checking the packages condition directly with the driver during the delivery to ensure that there are no visible damages.' => 'Le recomendamos encarecidamente que compruebe el estado de los paquetes en presencia del repartidor para asegurarse de que no haya daños visibles.',
    'Orders are shipped from our European warehouses, provided with a specific tracking number that can be checked online at any moment through the carrier\'s website.' => 'Los pedidos se envían desde nuestros almacenes europeos con un número de seguimiento específico que permite acompañarlos en tiempo real a través de la página web del transportista.',
    'Parcels are entrusted to external service providers for their delivery (TNT, DPD, GLS, etc.). ALL STARS DISTRIBUTION cannot under any circumstances be held responsible for a dispute about the delivery of a package.' => 'Los paquetes se confían a proveedores de servicios externos para su entrega (TNT, DPD, GLS, etc.). ALL STARS DISTRIBUTION no se hace responsable de ninguna manera de una reclamación relacionada con la entrega de un paquete.',
    'Delivery times are given for information purposes only and may change due to various factors beyond our control.' => 'Los plazos de entrega se brindan solo a título informativo y pueden cambiar debido a diversos factores fuera de nuestro control.',
    'The amount of the delivery costs is calculated once your order is registered, according to the characteristics of the products purchased and the delivery address given. A confirmation email will be sent to you with the amount of the delivery costs to be expected for your order in order to proceed with the payment of the latter.' => 'El importe de los gastos de envío se calcula una vez registrado su pedido, en función de las características de los productos adquiridos y de la dirección de entrega facilitada. Se le enviará un correo electrónico de confirmación con el importe de los gastos de envío previstos para su pedido con el fin de proceder al pago de este último. ',
    'We deliver worldwide with the carrier of our choice. The delivery takes place at the address indicated by the buyer at the time of the validation of the order.' => 'Realizamos nuestras entregas en todo el mundo con el transportista de nuestra elección. La entrega se realiza en la dirección indicada por el comprador en el momento de la validación del pedido.',
    'This document was last updated on November 21, 2022' => 'Este documento fue actualizado por última vez en junio de 2024',
    '- By e-mail to ' => '- Por correo electrónico a',
    '- His personal space' => '- Su espacio personal ',
    'In accordance with articles 39 and 40 of the law dated 6 January 1978, the customer has the right to access, rectify, delete and oppose his personal data. The customer can exercise this right via :' => 'En virtud de los artículos 39 y 40 de la ley de 6 de enero de 1978, el cliente tiene derecho de acceso, rectificación, supresión y oposición de sus datos personales. El cliente puede ejercer este derecho a través de:',
    'The site ensures that the customer\'s personal information is collected and processed in compliance with law n°78-17 of January 6, 1978 relating to information technology, files and freedom.' => 'El sitio web proporciona al cliente la recopilación y el procesamiento de información personal con respecto a la privacidad de acuerdo con la ley n ° 78-17 del 6 de enero de 1978 relacionada con el procesamiento de datos, archivos y libertades.',
    'The commercial offers of the site will be sent to the customer by e-mail if no objection has been made. The customer may object at any time by logging into his personal space or by sending an email to our customer service department.' => 'Las ofertas comerciales del sitio web se enviarán al cliente por correo electrónico si no se ha emitido oposición. El cliente puede oponerse a esto en cualquier momento iniciando sesión en su espacio personal o enviando un correo electrónico a nuestro servicio de atención al cliente. ',
    'Certain customer information will be passed on to delivery and / or payment service providers (i.e., surname, first name, address, postal code and telephone number) in order to allow the processing and delivery of the products ordered.' => 'Cierta información relativa al cliente será transmitida a los proveedores de servicios de entrega y/o pago (a saber, apellidos, nombre, dirección, código postal y número de teléfono) para permitir el procesamiento y la entrega de los productos solicitados.',
    'ARTICLE 11: PERSONAL DATA' => 'ARTÍCULO 11: DATOS PERSONALES',
    'If cancellation of the order is possible, we will refund the order via the payment method originally used by the buyer within 30 days.' => 'Si la cancelación del pedido es posible, le reembolsaremos el pedido a través del método de pago utilizado inicialmente por el comprador en un plazo de 30 días.',
    'Cancellation of an order is possible as long as the order has not been shipped from our warehouse. Any cancellation request made after the order has been shipped will not be accepted.' => 'La cancelación de un pedido es posible siempre que no haya sido enviado desde nuestros almacenes. Cualquier solicitud de cancelación realizada después del envío del pedido no tendrá éxito. ',
    'ARTICLE 10: CONDITIONS AND DEADLINES FOR REIMBURSEMENT' => 'ARTÍCULO 10: CONDICIONES Y PLAZOS PARA EL REEMBOLSO',
    'All sales made on our site are final, they cannot in any case give rise to the return of a product (except in the context of a guarantee, see article 8).' => 'Todas las ventas realizadas en nuestro sitio web son definitivas, en ningún caso pueden dar lugar a la devolución de un producto (excepto en el marco de una garantía, véase el artículo 8).',
    'ARTICLE 9: PRODUCT RETURNS' => 'ARTÍCULO 9: DEVOLUCIÓN DEL PRODUCTO',
    'In no case will it be possible to request a refund for the product concerned from the company All Stars Distribution as part of a warranty claim.' => 'En ningún caso será posible solicitar el reembolso del producto en cuestión a All Stars Distribution como parte de un reclamo de garantía.',
    'For any warranty claim which will require the sending of the product to our premises in order to verify it, All Stars Distribution will reimburse the buyer for the shipping costs of the product if the warranty coverage by the supplier is confirmed, otherwise all shipping costs will be borne by the latter.' => 'Para cualquier reclamación de garantía que requiera el envío del producto a nuestras instalaciones para su verificación, All Stars Distribution reembolsará al comprador los gastos de envío del producto si se confirma la cobertura de la garantía por parte del proveedor, en caso contrario todos los gastos de envío. correrá a cargo de este último.',
    'Under no circumstances can a warranty claim be made due to a problem encountered with a product following a faulty installation. In this case, the buyer must contact the professional who installed the product in question.' => 'En ningún caso se podrá reclamar la garantía por un problema del producto debido a un defecto de instalación, en cuyo caso el comprador deberá contactar con el profesional que montó el producto en cuestión. ',
    'All warranty claims must be sent by email to sales@all-stars-distribution.com together with photos or videos showing the problem. As the guarantee is taken over directly by the supplier, the shipping costs for sending and returning the product will be at the customer\'s expense, with the supplier only covering the costs of repairing or replacing the product concerned by the warranty. If the supplier finds that the problem encountered is not covered by the conditions of the guarantee, the shipping costs for the return of the product remain the responsibility of the customer.' => 'Para cualquier reclamo de garantía, debe enviarse por correo electrónico a la dirección sales@all-stars-distribution.com acompañado de fotos o videos que muestren el problema encontrado. La asunción de la garantía la realiza directamente el proveedor, los portes del envío y la devolución del producto correrán a cargo del cliente, cubriendo el proveedor únicamente los gastos de reparación o sustitución del producto afectado por la garantía. Si el proveedor considera que el problema encontrado no está cubierto por las condiciones de la garantía, los gastos de envío para la devolución del producto quedan a cargo del cliente.',
    'The company All Stars Distribution ensures the guarantee of the hidden defects under the legal conditions, the purchaser has a deadline of eight days from the discovery of the hidden defect to notify his reservations by email.' => 'La empresa All Stars Distribution ofrece la garantía contra vicios ocultos en las condiciones legales, el comprador dispone de un plazo de ocho días desde el descubrimiento del vicio oculto para comunicar por correo electrónico. ',
    'ARTICLE 8: WARRANTY:' => 'ARTÍCULO 8: GARANTÍA',
    'Please also note that no items are reserved until payment for the order has been confirmed in our bank account.' => 'Tenga también en cuenta que no se reserva ningún artículo antes de la confirmación de la recepción del pago del pedido en nuestra cuenta bancaria.',
  ),
  'ShopThemeCareer' => 
  array (
    '- Knowledge of relational database systems, Object Oriented Programming and web applications development' => '- Conocimientos de sistemas de bases de datos relacionales, programación orientada a objetos y desarrollo de aplicaciones web.',
    '- Fluency in one of these languages : English or French' => '- Fluidez en uno de estos idiomas: inglés o francés.',
    '- Top-notch programming skills and in-depth knowledge of HTML, CSS, JavaScript, PHP,and other coding languages' => '- Habilidades de programación de alto nivel y sólidos conocimientos de HTML, CSS, JavaScript, PHP y otros lenguajes de codificación. ',
    '- 3 years working experience as web developer / programmer in company' => '- 3 años de experiencia laboral como desarrollador / programador web en una empresa. ',
    '- High School IT / coding / web design diploma' => '- Curso superior en IT / programación / diseño web. ',
    'The web programmers or web developers use a variety of programming languages to create web applications, online tools and resources mainly database-driven.
                      ...
                      They develop our back office programs and interfaces using the best practices and are responsibile for maintaining, expanding, and scaling our sites while staying plugged into emerging technologies / industry trends. ' => 'Los programadores o desarrolladores web utilizan una variedad de lenguajes de programación para crear aplicaciones web, herramientas y recursos en línea principalmente basados en bases de datos.
Trabajan en estrecha colaboración con los directores de proyecto y diseñadores para crear y mantener atractivas, seguras y fáciles de usar nuestras diferentes páginas web.
Desarrollan nuestros programas e interfaces de back office utilizando las mejores prácticas y son responsables de mantener, expandir y evaluar nuestras páginas web mientras permanecen en conexión con tecnologías emergentes / tendencias de la industria. ',
    'View More' => 'Ver Más',
    '- Knowledge in the automotive industry appreciated' => '- Se valorarán conocimientos en industria automotriz.',
    '- Ability to work harmoniously with diverse range of people' => '- Capacidad para trabajar en equipo. ',
    '- Foreign language spoken / written English or french' => '- Idioma extranjero hablado / escrito inglés o francés. ',
    '- Familiar with video edition softwares such as Premiere, AfterFX, Finalcut...' => '- Familiarizado con softwares de edición de vídeo como Premiere, AfterFX, Finalcut ...',
    '- Fluency with design softwares like Lightroom, Illustrator, Dreamweaver, Photoshop' => '- Dominio de softwares de diseño como Lightroom, Illustrator, Dreamweaver, Photoshop.',
    '- 2 years working experience as graphic designer in company' => '- 2 años de experiencia laboral como diseñador gráfico en empresa. ',
    '- High school graphic diploma or strong portfolio' => '- Curso superior en diseño gráfico o portafolio sólido.',
    ...
    'The graphic designer creates visual communications to convey messages in an effective and aesthetically pleasing manner.
                      ...
                      The graphic designer, with a strong creative presence and artistic flair, shapes the visual aspect of our websites; products, marketing supports, exhibitions and more ! ' => 'El diseñador gráfico crea comunicaciones visuales para transmitir mensajes de una forma eficaz y estéticamente agradable.
Esto incluye varias tareas y responsabilidades como ilustraciones, banners, logotipos y creación de contenidos de marketing.
El diseñador gráfico, con una marcada personalidad creativa y talento artístico, da forma al aspecto visual de nuestras páginas web; productos, soportes de marketing, exposiciones y más. ',
    'Full Time - Valenca, PT' => 'FULL TIME - Valenca, PT',
    '> OPEN POSITIONS <' => '> OFERTAS ABIERTAS <',
    'No open position matching with your skills at the moment ?
                    No problem, apply anyway, maybe we can find something for you...' => '¿No hay un puesto vacante que coincida con sus habilidades en este momento?

No hay problema, envíenos su currículum, tal vez podamos encontrar algo para usted…',
    'General application' => 'Candidatura espontánea',
    '- Warehouse experience or high school diploma required' => '- Se requiere experiencia en almacén o título de graduado en ESO.',
    'The warehouse associate uses various digital and mechanical tools to pack and ship the orders accurately.
                    ...
                    The warehouse associate may operate a drivable vertical mast lift, a forklift and perform duties up to 30kgs.' => 'El preparador de pedidos utiliza varias herramientas digitales y mecánicas para empaquetar y enviar los pedidos con precisión.
Participa en la recepción de productos, inventarios físicos, control de seguridad y configuración del software de gestión de almacén a la vez que organiza el espacio del almacén.
El puesto requiere el manejo de plataformas elevadoras, carretillas elevadoras y el transporte de cargas de hasta 30 Kg.',
    '- Foreign language spoken highly appreciated' => '- Se valorará conocimiento de inglés o francés.',
    '- Forklift licence appreciated' => '- Se valorará carné de carretillero.',
    '- Proficient organizational skills' => '- Habilidades organizativas. ',
    '- Physically agile and dexterous' => '- Agilidad y destreza física.',
    '- Excellent verbal and written communication skills' => '- Excelentes habilidades de comunicación verbal y escrita.',
    '- Proficient with using computers / electronic devices' => '- Conocimientos informáticos y uso de dispositivos electrónicos.',
    'The Picker is part of the order preparation process, using various digital and mechanical tools to pick a wide variety of items and bring them to the preparation area.
                    ...
                    The picker will operate a drivable vertical mast lift, a forklift and will perform duties up to 30kgs. ' => 'El Picker es parte del proceso de preparación de pedidos. Utiliza varias herramientas digitales y mecánicas para localizar una amplia variedad de artículos y llevarlos al área de preparación.
El Picker también participa en la recepción de productos y la realización de inventarios físicos e informes de problemas de calidad a la vez que asume las tareas diarias de mantenimiento del almacén.
El puesto requiere el manejo de plataformas elevadoras, carretillas elevadoras y el transporte de cargas de hasta 30 Kg.',
    '- Ability to stay calm, organized and focused' => '- Capacidad de gestión del estrés, organización y concentración.',
    '- Excellent proofreading skills to identify grammar, spelling or punctuation errors' => '- Excelentes habilidades de corrección para identificar errores gramaticales, ortográficos o de puntuación. ',
    '- Proficient with using computers and basic office softwares' => '- Competente en el uso de ordenadores y software básico de oficina. ',
    '- High school diploma, general education degree or equivalent.' => '- Diploma de bachillerato, título de ESO o equivalente. ',
    '- Absolute fluency in one of these languages (French, Spanish, English, German)' => '- Nivel nativo en uno de estos idiomas: francés, español, inglés o alemán. ',
    'The customer service representative helps customers, giving them precious information about products or services, following their orders and return / warranty processes.
                        The representative schedule is splitted between answering customers questions via e-mail and working closely with the purchase and marketing departments to elaborate products descriptions and online resources in various languages.' => 'El encargado del servicio al cliente ayuda a los usuarios brindándoles información valiosa sobre productos o servicios, así como siguiendo sus pedidos y los procesos de devolución / garantía.
Su misión se divide entre responder a las preguntas de los clientes por correo electrónico y trabajar en estrecha colaboración con los departamentos de compras y marketing para elaborar descripciones de productos y recursos en línea en varios idiomas.',
    '- Proficient organizational skills, detail-oriented, multitasking, good under pressure' => '- Habilidades organizativas, orientado a detalles, multitarea, capacidad para trabajar bajo presión.',
    '- Aggressive problem diagnosis and creative problem solving skills' => '- Diagnóstico de problemas y habilidades creativas de resolución de problemas.',
    '- Knowledge of Search Engine Optimization process' => '- Conocimientos de SEO. ',
    'Send' => 'Enviar',
    'You agree with our conditions terms' => 'Acepta nuestros terminos y condiciones de uso',
    'Upload your CV ( only PDF files )' => 'Sube tu CV (sólo archivos PDF)',
    'How did you know about this job position?' => ' Cómo encontraste esta oferta de trabajo ? ',
    'Zip Code' => ' Código postal ',
    'City' => 'Ciudad',
    'Address Line 2' => ' Dirección Complementaria ',
    'Address Line 1' => 'Dirección',
    'Which position are you applying to' => ' A qué puesto estás postulando ? ',
    'Country' => 'País',
    'How do you prefer to be contacted?' => ' Preferencias de contacto ',
  ...
  array (
    'Submit an enquiry' => 'ENVÍE SU SOLICITUD',
    'In order to preserve a fair market for all players in the industry, All Stars Distribution has no relationship with marketplaces or gray market players. Above all, we want our suppliers to be partners and not competitors for our customers and therefore expect our suppliers to show the same respect for this ethics.' => 'Con objeto de mantener un mercado justo para todos los que forman parte de nuestra industria, All Stars Distribution no tiene ninguna relación con marketplaces o mercado gris. Ante todo queremos que nuestros proveedores sean colaboradores y no competidores de nuestros clientes, por lo tanto, esperamos que nuestros proveedores tengan el mismo respeto por este principio.',
    'Deontology' => 'Ética',
    'Investing big money and time in developing the visibility and the fame of the brands we distribute, we expect our suppliers to be part of our efforts, supporting our projects and being involved in their own brand promotion.' => 'Como respuesta a nuestra inversión en dinero, tiempo y esfuerzo en desarrollar la imagen y fama de las marcas que distribuimos, esperamos que nuestros proveedores sean parte de nuestros esfuerzos, apoyando nuestros proyectos de marketing e involucrándose en la promoción de su propia marca.',
    'Marketing' => 'MARKETING',
    'Management and control tools development is an extremely important part of our daily work, so we expect our suppliers to have the same interest and the same commitment to technological research and development.' => 'El desarrollo de herramientas de gestión y control representa una parte importante de nuestro trabajo, por lo que esperamos que nuestros proveedores demuestren el mismo interés y compromiso con sus investigaciones y desarrollo tecnológico.',
    'Technology' => 'TECNOLOGÍA',
    'Key element of a business relationship, we attach great importance to the quality of our communication with our customers. The quick and clear transmission of informations is an asset that we must maintain and apply on a daily basis with our suppliers.' => 'Como elemento fundamental de una relación comercial, damos gran importancia a una comunicación de calidad con nuestros clientes. La rápida transmisión de información cierta y confiable es una ventaja que debemos mantener y aplicar cada día con nuestros proveedores.',
    'Communication' => 'COMUNICACIÓN',
    '> Our 4 key commitments <' => '> NUESTROS 4 COMPROMISOS <',
    'In order to offer our customers the best products and services, we are extremely selective when choosing our suppliers or our products and intend to work only with manufacturers sharing our values and our ethic.' => 'Con el objetivo de ofrecer a nuestros clientes el mejor servicio y los mejores productos, somos muy exigentes al elegir a nuestros proveedores, razón por la cual pretendemos trabajar solo con fabricantes que compartan nuestros valores, principios y ética.',
    'European leader in performance auto parts distribution, All Stars Distribution bets on long-term relationships with world-class suppliers.' => 'Líder europeo en distribución de piezas performance para automóviles, All Stars Distribution desarrolla relaciones a largo plazo con proveedores de clase mundial. ',
  ),
  ...
  array (
    ...
    'This Policy is a legally binding agreement between you (“User”, “you” or “your”) and All Stars Distribution Lda (“All Stars Distribution Lda”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.' => 'Esta política es un acuerdo legalmente vinculante entre usted ("Usuario", "usted") y All Stars Distribution Lda ("All Stars Distribution Lda", "nosotros", "nuestro"). Si está celebrando este Acuerdo en nombre de una empresa u otra entidad legal, declara que tiene la autoridad para obligar a esa entidad a este Acuerdo, en cuyo caso los términos "Usuario", "usted" o "su" se referirán a tal entidad. Si no tiene dicha autoridad, o si no está de acuerdo con los términos de este Acuerdo, no debe aceptar este Acuerdo y no puede acceder ni utilizar el Sitio web y sus Servicios. Al acceder y utilizar el sitio web y sus servicios, usted reconoce que ha leído, entendido y acepta estar sujeto a los términos de esta política. Esta política no se aplica a las prácticas de las empresas que no poseemos ni controlamos, ni a las personas que no empleamos ni administramos.',
    'We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the all-stars-distribution.com website (“Website” or “Service”) and any of its related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.' => 'Respetamos su privacidad y nos comprometemos a protegerla cumpliendo con esta política de privacidad ("Política"). Esta política describe los tipos de información que podemos recopilar de usted o que usted puede proporcionar ("Información personal") en el sitio web all-stars-distribution.com ("Sitio web"), nuestras prácticas de recopilación, uso, retención, protección y divulgación de dicha información personal. También describe las opciones disponibles para usted con respecto a nuestro uso de su información personal y cómo puede acceder a ella y actualizarla.',
    'Acceptance of this policy' => 'Aceptación de esta política',
    'Changes and amendments' => 'Enmiendas',
    'Data breach' => 'Violación de datos',
    'Information security' => 'Seguridad de la información',
    'Links to other resources' => 'Enlaces a otros sitios',
    'Email marketing' => 'Boletines ',
    'Social media features' => 'Características de las redes sociales',
    'Do Not Track signals' => 'No rastrear',
    'Data analytics' => 'Análisis de datos',
    'Cookies' => 'Cookies',
    'How to exercise your rights' => 'Cómo ejercer sus derechos',
    'Data protection rights under the GDPR' => 'Derechos de protección de datos bajo RGPD',
    'Transfer of information' => 'Transferencia de información',
    'Retention of information' => 'Retención de información',
    'Disclosure of information' => 'Divulgación de información',
    'Managing information' => 'Gestión de la información',
    'Payment processing' => 'Procesamiento de pagos',
    'Use and processing of collected information' => 'Uso y tratamiento de la información recopilada',
    'Privacy of children' => 'Confidencialidad de los menores',
    'Collection of personal information' => 'Recogida de datos personales',
    'Processing your Personal Information depends on how you interact with the Website and Services, where you are located in the world and if one of the following applies: (i) you have given your consent for one or more specific purposes; this, however, does not apply, whenever the processing of Personal Information is subject to European data protection law; (ii) provision of information is necessary for the performance of an agreement with you and/or for any pre-contractual obligations thereof; (iii) processing is necessary for compliance with a legal obligation to which you are subject; (iv) processing is related to a task that is carried out in the public interest or in the exercise of official authority vested in us; (v) processing is necessary for the purposes of the legitimate interests pursued by us or by a third party.' => 'El procesamiento de su información personal depende de cómo interactúa con el sitio web, en qué parte del mundo se encuentra y si se aplica alguna de las siguientes condiciones:
(i) ha dado su consentimiento para uno o más propósitos específicos; esto, sin embargo, no se aplica, siempre que el procesamiento de información personal esté sujeto a la ley europea de protección de datos;
(ii) el suministro de información es necesario para la ejecución de un acuerdo con usted y/o para cualquier obligación precontractual del mismo;
(iii) el procesamiento es necesario para el cumplimiento de una obligación legal a la que está sujeto;
(iv) el procesamiento está relacionado con una tarea realizada en interés público o en el ejercicio de la autoridad oficial que se nos ha conferido;
(v) el procesamiento es necesario para nuestros intereses legítimos o los de un tercero.',
    'Run and operate the Website and Services' => 'Ejecutar y operar el sitio web y sus servicios',
    'Respond to inquiries and offer support' => 'Responder a consultas de servicio al cliente',
    'Deliver products or services' => 'Entregar un pedido',
    'Fulfill and manage orders' => 'Crear y gestionar un pedido',
    'Create and manage user accounts' => 'Crear y administrar una cuenta',
    'In order to make the Website and Services available to you, or to meet a legal obligation, we may need to collect and use certain Personal Information. If you do not provide the information that we request, we may not be able to provide you with the requested products or services. Any of the information we collect from you may be used for the following purposes:' => 'Para que el sitio web y sus servicios estén disponibles para usted, o para cumplir con una obligación legal, es posible que debamos recopilar y utilizar cierta información personal. Si no proporciona la información que solicitamos, es posible que no podamos brindarle los productos o servicios solicitados. Toda la información que recopilamos de usted puede ser utilizada para los siguientes propósitos:',
    'We act in the capacity of a data processor in situations when you submit Personal Information through the Website and Services. We do not own, control, or make decisions about the submitted Personal Information, and such Personal Information is processed only in accordance with your instructions. In such instances, the User providing Personal Information acts as a data controller in terms of the GDPR.' => 'Actuamos como un procesador de datos en caso de que envíe información personal a través del sitio web y sus servicios. No poseemos, controlamos ni tomamos ninguna decisión sobre la información personal enviada, y dicha información personal solo se procesa de acuerdo con sus instrucciones. En este caso, el usuario que proporciona información personal actúa como controlador de datos bajo las obligaciones establecidas en el RGPD.',
    'Our role may also differ depending on the specific situation involving Personal Information. We act in the capacity of a data controller when we ask you to submit your Personal Information that is necessary to ensure your access and use of the Website and Services. In such instances, we are a data controller because we determine the purposes and means of the processing of Personal Information and we comply with data controllers’ obligations set forth in the GDPR.' => 'Nuestro papel también puede diferir según la situación que involucre el procesamiento de información personal. Actuamos como controlador de datos cuando le solicitamos que envíe la información personal necesaria para garantizar su acceso y uso del sitio web y sus servicios. En este caso, somos el controlador de datos porque determinamos los fines y medios del procesamiento de la información personal y cumplimos con las obligaciones establecidas en el RGPD.',
    'We act as a data controller and a data processor in terms of the GDPR when handling Personal Information, unless we have entered into a data processing agreement with you in which case you would be the data controller and we would be the data processor.' => 'Actuamos como controlador y procesador de datos bajo el RGPD cuando procesamos información personal, a menos que hayamos celebrado un acuerdo de procesamiento de datos con usted, en cuyo caso usted sería el controlador de datos y nosotros seríamos el procesador de datos.',
    'We encourage parents and legal guardians to monitor their children’s Internet usage and to help enforce this Policy by instructing their children never to provide Personal Information through the Website and Services without their permission. We also ask that all parents and legal guardians overseeing the care of children take the necessary precautions to ensure that their children are instructed to never give out Personal Information when online without their permission.' => 'Animamos a los padres y tutores legales a que supervisen el uso de Internet de sus hijos y a que ayuden a hacer cumplir esta Política, instruyendo a sus hijos a que nunca proporcionen Información Personal a través del Sitio Web y los Servicios sin su permiso. También pedimos que todos los padres y tutores legales que supervisan el cuidado de los niños tomen las precauciones necesarias para asegurarse de que sus hijos estén instruidos para que nunca proporcionen Información Personal en línea sin su permiso.',
    'We do not knowingly collect any Personal Information from children under the age of 18. If you are under the age of 18, please do not submit any Personal Information through the Website and Services. If you have reason to believe that a child under the age of 18 has provided Personal Information to us through the Website and Services, please contact us to request that we delete that child’s Personal Information from our Services.' => 'No recopilamos ninguna información personal de niños menores de 18 años. Si tiene menos de 18 años, no envíe ninguna información personal a través del sitio web. Si tiene motivos para creer que un niño menor de 18 años nos ha proporcionado información personal a través del sitio web, comuníquese con nosotros para solicitar que eliminemos esa información personal de nuestros servicios.',
    'You can choose not to provide us with your Personal Information, but then you may not be able to take advantage of some of the features on the Website. Users who are uncertain about what information is mandatory are welcome to contact us.' => 'Puede optar por no proporcionarnos su información personal, pero es posible que no pueda aprovechar algunas de las características del sitio web. Se recomienda a los usuarios que no estén seguros de la información requerida que se comuniquen con nosotros.',
    'Payment information (such as credit card details, bank details, etc)' => 'Información de pago (como datos de tarjetas de crédito, datos bancarios, etc.)',
    'Basic personal information (such as name, country of residence, etc)' => 'Información personal básica (como nombre, país de residencia, etc.)',
    '(viii) You have the right to complain to a data protection authority about our collection and use of your Personal Information. If you are not satisfied with the outcome of your complaint directly with us, you have the right to lodge a complaint with your local data protection authority. For more information, please contact your local data protection authority in the EEA. This provision is applicable provided that your Personal Information is processed by automated means and that the processing is based on your consent, on a contract which you are part of, or on pre-contractual obligations thereof.' => '(viii) Tiene derecho a quejarse ante una autoridad de protección de datos sobre nuestra recopilación y uso de su información personal. Si no está satisfecho con el resultado de su queja, tiene derecho a presentar una queja ante la autoridad local de protección de datos. Para obtener más información, comuníquese con su autoridad local de protección de datos en el EEE. Esta disposición es aplicable siempre que su información personal se procese por medios automatizados y que el procesamiento se base en su consentimiento, en un contrato del que forma parte o en obligaciones precontractuales.',
    '(vii) You have the right to receive your Personal Information that you have provided to us in a structured, commonly used, and machine-readable format and, if technically feasible, to have it transmitted to another controller without any hindrance from us, provided that such transmission does not adversely affect the rights and freedoms of others.' => '(vii) Tiene derecho a recibir la información personal que nos ha proporcionado y a transmitirla a otra entidad sin ningún impedimento por nuestra parte, siempre que dicha transmisión no afecte los derechos y libertades de otros.',
    '(vi) You have the right, under certain circumstances, to obtain the erasure of your Personal Information from us. These circumstances include: the Personal Information is no longer necessary in relation to the purposes for which it was collected or otherwise processed; you withdraw consent to consent-based processing; you object to the processing under certain rules of applicable data protection law; the processing is for direct marketing purposes; and the personal data have been unlawfully processed. However, there are exclusions of the right to erasure such as where processing is necessary: for exercising the right of freedom of expression and information; for compliance with a legal obligation; or for the establishment, to exercise or defense of legal claims.' => '(vi) Tiene derecho, en determinadas circunstancias, a obtener de nosotros la eliminación de su información personal. Estas circunstancias incluyen: la información personal ya no es necesaria para los fines para los que fue recopilada o procesada; retira su consentimiento para el procesamiento basado en el consentimiento; usted se opone al procesamiento bajo ciertas reglas de la ley de protección de datos aplicable; el procesamiento es para fines de marketing directo; y los datos personales han sido tratados ilícitamente. Sin embargo, existen exclusiones del derecho de supresión, por ejemplo cuando el tratamiento es necesario: para el ejercicio del derecho a la libertad de expresión e información; para el cumplimiento de una obligación legal; o para el establecimiento, ejercicio o defensa de reclamaciones legales.',
    '(v) You have the right, under certain circumstances, to restrict the processing of your Personal Information. These circumstances include: the accuracy of your Personal Information is contested by you and we must verify its accuracy; the processing is unlawful, but you oppose the erasure of your Personal Information and request the restriction of its use instead; we no longer need your Personal Information for the purposes of processing, but you require it to establish, exercise or defend your legal claims; you have objected to processing pending the verification of whether our legitimate grounds override your legitimate grounds. Where processing has been restricted, such Personal Information will be marked accordingly and, with the exception of storage, will be processed only with your consent or for the establishment, to exercise or defense of legal claims, for the protection of the rights of another natural, or legal person or for reasons of important public interest.' => '(v) Tiene derecho, en determinadas circunstancias, a restringir el procesamiento de su información personal. Estas circunstancias incluyen: usted cuestiona la exactitud de su información personal y necesitamos verificar su exactitud; el procesamiento es ilegal, pero usted se opone al borrado de su información personal y solicita en su lugar la restricción de su uso; ya no necesitamos su información personal para fines de procesamiento, pero usted la necesita para establecer, ejercer o defender sus derechos; usted se ha opuesto al procesamiento pendiente de verificar si nuestros motivos legítimos prevalecen sobre sus motivos legítimos. Cuando se haya restringido el acceso, dicha información personal se identificará en consecuencia y, excepto para el almacenamiento, solo se procesará con su consentimiento o para el establecimiento, ejercicio o defensa de reclamaciones legales, para la protección de los derechos de otra persona física, o una persona jurídica o por razones de interés público.',
    '(iv) You have the right to object to the processing of your information if the processing is carried out on a legal basis other than consent. Where Personal Information is processed for the public interest, in the exercise of an official authority vested in us, or for the purposes of the legitimate interests pursued by us, you may object to such processing by providing a ground related to your particular situation to justify the objection.' => '(iv) Tiene derecho a oponerse al procesamiento de su información si el procesamiento se lleva a cabo sobre una base legal distinta del consentimiento. Cuando la información personal se procese en interés público, en el ejercicio de una autoridad oficial conferida a nosotros, puede oponerse a dicho procesamiento proporcionando un motivo relacionado con su situación particular para justificar la objeción.',
    '(iii) You have the right to verify the accuracy of your information and ask for it to be updated or corrected. You also have the right to request us to complete the Personal Information you believe is incomplete.' => '(iii) Tiene derecho a verificar la exactitud de su información y solicitar que se actualice o corrija. También tiene derecho a solicitarnos que completemos la información personal que crea que está incompleta.',
    '(ii) You have the right to learn if your Personal Information is being processed by us, obtain disclosure regarding certain aspects of the processing, and obtain a copy of your Personal Information undergoing processing.' => '(ii) Tiene derecho a saber si su información personal está siendo procesada por nosotros, a obtener información sobre ciertos aspectos del procesamiento y a obtener una copia de su información personal procesada.',
    '(i) You have the right to withdraw consent where you have previously given your consent to the processing of your Personal Information. To the extent that the legal basis for our processing of your Personal Information is consent, you have the right to withdraw that consent at any time. Withdrawal will not affect the lawfulness of processing before the withdrawal.' => '(i) Tiene derecho a retirar su consentimiento si previamente ha dado su consentimiento para el procesamiento de su información personal. En la medida en que la base legal para procesar su información personal sea el consentimiento, tiene derecho a retirar ese consentimiento en cualquier momento. La retirada no afectará a la licitud del tratamiento anterior a la retirada.',
    'If you are a resident of the European Economic Area (“EEA”), you have certain data protection rights and we aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Information. If you wish to be informed what Personal Information we hold about you and if you want it to be removed from our systems, please contact us. In certain circumstances, you have the following data protection rights:' => 'Si es del Espacio Económico Europeo ("EEE"), tiene ciertos derechos de protección de datos y nos esforzamos por tomar medidas razonables para permitirle corregir, modificar, eliminar o limitar el uso de su información personal. Si desea que se le informe qué información personal tenemos sobre usted y si desea que se elimine de nuestros sistemas, comuníquese con nosotros. En determinadas circunstancias, usted tiene los siguientes derechos de protección de datos:',
    'Depending on your location, data transfers may involve transferring and storing your information in a country other than your own. However, this will not include countries outside the European Union and European Economic Area. If any such transfer takes place, you can find out more by checking the relevant sections of this Policy or inquire with us using the information provided in the contact section.' => 'Dependiendo de su ubicación, las transferencias de datos pueden implicar la transferencia y el almacenamiento de su información en un país que no sea el suyo. Sin embargo, esto no incluirá países fuera de la Unión Europea y el Espacio Económico Europeo. Si se lleva a cabo dicha transferencia, puede obtener más información consultando las secciones correspondientes de esta política o consultarnos utilizando la información provista en la sección "Contáctenos".',
    'We may use any aggregated data derived from or incorporating your Personal Information after you update or delete it, but not in a manner that would identify you personally. Once the retention period expires, Personal Information shall be deleted. Therefore, the right to access, the right to erasure, the right to rectification, and the right to data portability cannot be enforced after the expiration of the retention period.' => 'Podemos usar cualquier dato derivado de su información personal o que la incorpore después de que la actualice o la elimine sin identificarlo personalmente. Una vez que expire el período de retención, la información personal será eliminada. Por tanto, el derecho de acceso, el derecho de supresión, el derecho de rectificación y el derecho a la portabilidad de los datos no pueden ejercerse una vez transcurrido el plazo de conservación.',
    'We will retain and use your Personal Information for the period necessary as long as your user account remains active, to enforce our agreements, resolve disputes, and unless a longer retention period is required or permitted by law.' => 'Retendremos y utilizaremos su información personal mientras su cuenta de cliente permanezca activa, a menos que la ley exija o permita un período de retención más prolongado.',
    'Service Providers are not authorized to use or disclose your information except as necessary to perform services on our behalf or comply with legal requirements. Service Providers are given the information they need only in order to perform their designated functions, and we do not authorize them to use or disclose any of the provided information for their own marketing or other purposes.' => 'Los proveedores de servicios no están autorizados a usar o divulgar su información personal, excepto cuando sea necesario para realizar servicios en nuestro nombre o cumplir con los requisitos legales. Reciben solo la información que necesitan para realizar sus funciones laborales y no los autorizamos a usar o divulgar la información proporcionada para su propio marketing u otros fines.',
    'Depending on the requested Services or as necessary to complete any transaction or provide any Service you have requested, we may share your information with our affiliates, contracted companies, and service providers (collectively, “Service Providers”) we rely upon to assist in the operation of the Website and Services available to you and whose privacy policies are consistent with ours or who agree to abide by our policies with respect to Personal Information. We will not share any personally identifiable information with third parties and will not share any information with unaffiliated third parties.' => 'Dependiendo de los servicios solicitados o según sea necesario para completar una transacción, podemos compartir su información con nuestras empresas asociadas, en quienes confiamos para ayudarlo en el funcionamiento del sitio web y los servicios puestos a su disposición y cuyas políticas de privacidad son conformes con la nuestra. No compartiremos ninguna información con terceros no afiliados.',
    'You are able to delete certain Personal Information we have about you. The Personal Information you can delete may change as the Website and Services change. When you delete Personal Information, however, we may maintain a copy of the unrevised Personal Information in our records for the duration necessary to comply with our obligations to our affiliates and partners, and for the purposes described below. If you would like to delete your Personal Information or permanently delete your account, you can do so on the settings page of your account on the Website or simply by contacting us.' => 'Puede eliminar parte de la información personal que tenemos sobre usted. La información personal que puede eliminar puede cambiar a medida que evoluciona el sitio web. Sin embargo, cuando elimina información personal, podemos conservar una copia durante el tiempo que sea necesario para cumplir con nuestras obligaciones con nuestras empresas asociadas y para los fines que se describen a continuación. Si desea eliminar su información personal o eliminar su cuenta de forma permanente, puede hacerlo a través de su cuenta de cliente directamente en el sitio web o simplemente poniéndose en contacto con nosotros.',
    'Please note that the Payment Processors may collect some Personal Information from you, which allows them to process your payments (e.g., your email address, address, credit card details, and bank account number) and handle all the steps in the payment process through their systems, including data collection and data processing. The Payment Processors’ use of your Personal Information is governed by their respective privacy policies which may or may not contain privacy protections as protective as this Policy. We suggest that you review their respective privacy policies.' => 'Tenga en cuenta que el procesador de pagos puede recopilar cierta información personal sobre usted (por ejemplo, su dirección de correo electrónico, dirección, detalles de la tarjeta de crédito) para administrar todas las etapas del proceso de pago a través de su sistema informático. El uso que hace el procesador de pagos de su información personal se rige por su política de privacidad. Le sugerimos que consulte su propia política de privacidad para obtener más información sobre este tema.',
    'Payment Processors adhere to the latest security standards as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, MasterCard, American Express and Discover. Sensitive and private data exchange happens over a SSL secured communication channel and is encrypted and protected with digital signatures, and the Website and Services are also in compliance with strict vulnerability standards in order to create as secure of an environment as possible for Users. We will share payment data with the Payment Processors only to the extent necessary for the purposes of processing your payments, refunding such payments, and dealing with complaints and queries related to such payments and refunds.' => 'El procesador de pagos se adhiere a los últimos estándares de seguridad mantenidos por el PCI Security Standards Council, que es un grupo de marcas como Visa, MasterCard, American Express y Discover. El intercambio de datos confidenciales y privados se realiza a través de un canal de comunicación seguro SSL y está encriptado y protegido por firmas digitales. El sitio web también se adhiere a estrictos estándares de seguridad para crear un entorno lo más seguro posible para los usuarios. El procesador de pagos utiliza solo los datos necesarios para procesar sus pagos, reembolsarlos y procesar solicitudes relacionadas con estos pagos y reembolsos.',
    'In case of Services requiring payment, you may need to provide your credit card details or other payment account information, which will be used solely for processing payments. We use third-party payment processors (“Payment Processors”) to assist us in processing your payment information securely.' => 'En el caso de los Servicios que requieren pago, es posible que deba proporcionar los datos de su tarjeta de crédito u otra información que se utilizará únicamente para el procesamiento de pagos. Utilizamos un procesador de pagos de terceros ("procesador de pagos") para ayudarnos a procesar su información de pago de forma segura.',
    'Note that under some legislations we may be allowed to process information until you object to such processing by opting out, without having to rely on consent or any other of the legal bases above. In any case, we will be happy to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Information is a statutory or contractual requirement, or a requirement necessary to enter into a contract.' => 'Tenga en cuenta que, bajo algunas legislaciones, se nos puede permitir procesar información hasta que usted se oponga a dicho procesamiento optando por no participar, sin tener que depender del consentimiento o de cualquiera de las bases legales mencionadas anteriormente. En cualquier caso, estaremos encantados de aclarar la base legal específica que se aplica al procesamiento y, en particular, si la provisión de Información Personal es un requisito legal o contractual, o un requisito necesario para celebrar un contrato.',
    'This document was last updated on August 25, 2022' => 'Este documento fue actualizado por última vez en junio de 2024',
    'We will attempt to resolve complaints and disputes and make every reasonable effort to honor your wish to exercise your rights as quickly as possible and in any event, within the timescales provided by applicable data protection laws.' => 'Nos esforzaremos por responder a su solicitud lo antes posible y haremos todo lo posible para cumplir su deseo de ejercer sus derechos, dentro de los plazos previstos por las leyes de protección de datos aplicables.',
    'If you have any other questions, concerns, or complaints regarding this Policy, we encourage you to contact us using the details below:' => 'Si tiene alguna pregunta con respecto a la información que podemos tener sobre usted o si desea ejercer sus derechos, puede enviar su solicitud contactándonos a través del siguiente correo electrónico:',
    'You acknowledge that you have read this Policy and agree to all its terms and conditions. By accessing and using the Website and Services and submitting your information you agree to be bound by this Policy. If you do not agree to abide by the terms of this Policy, you are not authorized to access or use the Website and Services.' => 'Usted reconoce que ha leído esta política y acepta todos sus términos y condiciones. Al acceder, utilizar el sitio web, sus servicios y enviar su información, usted acepta estar sujeto a esta política. Si no acepta cumplir con sus términos, no está autorizado a acceder o utilizar el sitio web y sus servicios.',
    'An updated version of this Policy will be effective immediately upon the posting of the revised Policy unless otherwise specified. Your continued use of the Website and Services after the effective date of the revised Policy (or such other act specified at that time) will constitute your consent to those changes. However, we will not, without your consent, use your Personal Information in a manner materially different than what was stated at the time your Personal Information was collected.' => 'Una versión actualizada de esta Política entrará en vigencia inmediatamente después de la publicación de la versión revisada, a menos que se especifique lo contrario. Su uso continuo del sitio web y los servicios después de la fecha de entrada en vigencia de la Política revisada (o cualquier otro acto especificado en ese momento) constituirá su consentimiento para dichos cambios. Sin embargo, no utilizaremos su información personal, sin su consentimiento, de una manera materialmente diferente a la que se indicó en el momento en que se recopiló su información personal.',
    'We reserve the right to modify this Policy or its terms related to the Website and Services at any time at our discretion. When we do, we will post a notification on the main page of the Website. We may also provide notice to you in other ways at our discretion, such as through the contact information you have provided.' => 'Nos reservamos el derecho de modificar esta política o las condiciones relativas al sitio web y sus servicios de acuerdo con nuestras necesidades. Cuando lo hagamos, se le notificará a través de los datos de contacto que le hemos proporcionado.',
    'In the event we become aware that the security of the Website and Services has been compromised or Users’ Personal Information has been disclosed to unrelated third parties as a result of external activity, including, but not limited to, security attacks or fraud, we reserve the right to take reasonably appropriate measures, including, but not limited to, investigation and reporting, as well as notification to and cooperation with law enforcement authorities. In the event of a data breach, we will make reasonable efforts to notify affected individuals if we believe that there is a reasonable risk of harm to the User as a result of the breach or if notice is otherwise required by law. When we do, we will post a notice on the Website, send you an email.' => 'Si nos enteramos de que la seguridad del sitio web se ha visto comprometida o que la información personal de los usuarios se ha divulgado a terceros no afiliados, nos reservamos el derecho de tomar las medidas adecuadas, incluidas, entre otras, investigaciones e informes, así como la notificación. y la cooperación con las autoridades legales. En el caso de una violación de datos, notificaremos a las personas afectadas si creemos que existe un riesgo de daño para el usuario como resultado de la violación o si la ley exige que se notifique.',
    'As the security of Personal Information depends in part on the security of the device you use to communicate with us and the security you use to protect your credentials, please take appropriate measures to protect this information.' => 'Debido a que la seguridad de la información personal depende en parte de la seguridad del dispositivo que está utilizando y la seguridad que utiliza para proteger sus credenciales, tome las medidas adecuadas para proteger mejor esta información.',
    'Therefore, while we strive to protect your Personal Information, you acknowledge that (i) there are security and privacy limitations of the Internet which are beyond our control; (ii) the security, integrity, and privacy of any and all information and data exchanged between you and the Website and Services cannot be guaranteed; and (iii) any such information and data may be viewed or tampered with in transit by a third party, despite best efforts.' => 'Por lo tanto, mientras nos esforzamos por proteger su información personal, usted reconoce que (i) existen límites de seguridad y privacidad en Internet que escapan a nuestro control; (ii) no se puede garantizar la seguridad, integridad y confidencialidad de toda la información y los datos intercambiados entre usted y el sitio web; y (iii) dicha información y datos pueden ser vistos o alterados mientras están en tránsito a un sitio de terceros a pesar de nuestros mejores esfuerzos.',
    'We secure information you provide on computer servers in a controlled, secure environment, protected from unauthorized access, use, or disclosure. We maintain reasonable administrative, technical, and physical safeguards in an effort to protect against unauthorized access, use, modification, and disclosure of Personal Information in our control and custody. However, no data transmission over the Internet or wireless network can be guaranteed.' => 'Aseguramos la información que proporciona en servidores informáticos controlados que son seguros y están protegidos contra el acceso, uso o divulgación no autorizados. Mantenemos medidas de seguridad administrativas y técnicas para proteger contra el acceso, uso, modificación y divulgación no autorizados de datos personales. Sin embargo, no se puede garantizar la transmisión de datos a través de Internet o de una red inalámbrica.',
    'The Website and Services contain links to other resources that are not owned or controlled by us. Please be aware that we are not responsible for the privacy practices of such other resources or third parties. We encourage you to be aware when you leave the Website and Services and to read the privacy statements of each and every resource that may collect Personal Information.' => 'El sitio web contiene enlaces a otros sitios que no son de nuestra propiedad ni están controlados por nosotros. Tenga en cuenta que no somos responsables de las prácticas de privacidad de estos sitios de terceros. Cuando abandone el sitio web, lo alentamos a que lea las declaraciones de privacidad de cada sitio que pueda recopilar su información personal.',
    'In compliance with the CAN-SPAM Act, all e-mails sent from us will clearly state who the e-mail is from and provide clear information on how to contact the sender. You may choose to stop receiving our newsletter or marketing emails by following the unsubscribe instructions included in these emails or by contacting us. However, you will continue to receive essential transactional emails.' => 'De acuerdo con la Ley CAN-SPAM, todos los correos electrónicos que enviemos indicarán claramente de quién es el correo electrónico y brindarán información clara sobre cómo contactar al remitente. Puede optar por no recibir nuestros boletines siguiendo las instrucciones para darse de baja incluidas en esos correos electrónicos o poniéndose en contacto con nosotros. Sin embargo, seguirá recibiendo correos electrónicos esenciales para procesar sus pedidos y administrar su cuenta de cliente.',
    'We offer electronic newsletters to which you may voluntarily subscribe at any time. We are committed to keeping your e-mail address confidential and will not disclose your email address to any third parties except as allowed in the information use and processing section. We will maintain the information sent via e-mail in accordance with applicable laws and regulations.' => 'Ofrecemos boletines electrónicos a los que puede suscribirse en cualquier momento. Nos comprometemos a mantener la confidencialidad de su dirección de correo electrónico ya no revelarla a terceros, a menos que nos dé su permiso. Retendremos la información enviada por correo electrónico de acuerdo con las leyes y regulaciones aplicables.',
    'Our Website and Services may include social media features, such as the Facebook and Twitter buttons, Share This buttons, etc (collectively, “Social Media Features”). These Social Media Features may collect your IP address, what page you are visiting on our Website and Services, and may set a cookie to enable Social Media Features to function properly. Social Media Features are hosted either by their respective providers or directly on our Website and Services. Your interactions with these Social Media Features are governed by the privacy policy of their respective providers.' => 'Nuestro sitio web puede incluir ciertas funciones de redes sociales, como enlaces a Facebook e Instagram, botones para compartir, etc. Estas funciones de redes sociales pueden recopilar su dirección IP, la página que está visitando en nuestro sitio web y pueden establecer una cookie para que funcionen correctamente. Las funciones de las redes sociales están alojadas por sus respectivos proveedores o alojadas directamente en nuestro sitio web. Sus interacciones con estas funciones de redes sociales se rigen por las políticas de privacidad de sus respectivos proveedores.',
    'Some browsers incorporate a Do Not Track feature that signals to websites you visit that you do not want to have your online activity tracked. Tracking is not the same as using or collecting information in connection with a website. For these purposes, tracking refers to collecting personally identifiable information from consumers who use or visit a website or online service as they move across different websites over time. How browsers communicate the Do Not Track signal is not yet uniform. As a result, the Website and Services are not yet set up to interpret or respond to Do Not Track signals communicated by your browser. Even so, as described in more detail throughout this Policy, we limit our use and collection of your Personal Information.' => 'Algunos navegadores incorporan una función NO SEGUIMIENTO que indica a los sitios web que visita que no desea que se realice un seguimiento de su actividad en línea. El seguimiento no es lo mismo que el uso o la recopilación de información en relación con un sitio web. Para estos fines, el seguimiento se refiere a la recopilación de información de identificación personal de los consumidores que usan o visitan un sitio web o servicio en línea a medida que navegan por diferentes sitios web a lo largo del tiempo. La forma en que los navegadores comunican la señal de No rastrear aún no es uniforme. Por lo tanto, el sitio web y los servicios aún no están configurados para interpretar o responder a las señales de “No rastrear” comunicadas por su navegador. Aun así, como se describe con más detalle a lo largo de esta política, limitamos nuestro uso y recopilación de su información personal.',
    'Our Website and Services may use third-party analytics tools that use cookies, web beacons, or other similar information-gathering technologies to collect standard internet activity and usage information. The information gathered is used to compile statistical reports on User activity such as how often Users visit our Website and Services, what pages they visit and for how long, etc. We use the information obtained from these analytics tools to monitor the performance and improve our Website and Services. We do not use third-party analytics tools to track or to collect any personally identifiable information of our Users and we will not associate any information gathered from the statistical reports with any individual User.' => 'Nuestro sitio web puede utilizar herramientas de análisis de terceros que utilizan cookies u otras tecnologías de recopilación de información similares para recopilar información estándar sobre la actividad y el uso de Internet. La información recopilada se utiliza para compilar informes estadísticos sobre la actividad de los usuarios, como la frecuencia con la que los usuarios visitan nuestro sitio web, qué páginas visitan y durante cuánto tiempo, etc. Usamos la información obtenida de estas herramientas de análisis para monitorear el rendimiento y mejorar nuestro sitio web. No utilizamos herramientas de análisis de terceros para rastrear o recopilar información de identificación personal sobre nuestros usuarios y no asociaremos ninguna información recopilada de informes estadísticos con un usuario individual.',
    'We may use cookies to collect, store, and track information for security and personalization, to operate the Website and Services, and for statistical purposes. Please note that you have the ability to accept or decline cookies. Most web browsers automatically accept cookies by default, but you can modify your browser settings to decline cookies if you prefer.' => 'Podemos utilizar cookies para recopilar, almacenar y rastrear información con fines de seguridad y personalización, para operar el sitio web y con fines estadísticos. Tenga en cuenta que tiene la capacidad de aceptar o rechazar las cookies. La mayoría de los navegadores web aceptan automáticamente las cookies de forma predeterminada, pero puede modificar la configuración de su navegador para rechazar las cookies si lo prefiere.',
    'Our Website and Services use “cookies” to help personalize your online experience. A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you, and can only be read by a web server in the domain that issued the cookie to you. If you choose to decline cookies, you may not be able to fully experience the features of the Website and Services.' => 'Nuestro sitio web utiliza "cookies" para ayudarlo con su experiencia en línea. Una cookie es un archivo de texto que un servidor de páginas web coloca en su disco duro. Las cookies no se pueden utilizar para ejecutar programas o enviar virus a su computadora. Las cookies se le asignan de forma única y solo puede leerlas un servidor web en el dominio que le emitió la cookie. Si elige rechazar las cookies, es posible que no pueda experimentar completamente la funcionalidad del sitio web.',
    'You must include sufficient details to allow us to properly understand the request and respond to it. We cannot respond to your request or provide you with Personal Information unless we first verify your identity or authority to make such a request and confirm that the Personal Information relates to you.' => 'Debe incluir suficientes detalles para permitirnos comprender completamente y responder a la solicitud. No podemos responder a su solicitud ni proporcionarle información personal a menos que primero verifiquemos su identidad o autoridad para realizar dicha solicitud y confirmemos que dicha información personal se relaciona con usted.',
    'Any requests to exercise your rights can be directed to us through the contact details provided in this document. Please note that we may ask you to verify your identity before responding to such requests. Your request must provide sufficient information that allows us to verify that you are the person you are claiming to be or that you are the authorized representative of such person. If we receive your request from an authorized representative, we may request evidence that you have provided such an authorized representative with power of attorney or that the authorized representative otherwise has valid written authority to submit requests on your behalf.' => 'Cualquier solicitud para ejercer sus derechos puede dirigirse a nosotros a través del contacto proporcionado en este documento. Tenga en cuenta que es posible que le solicitemos que verifique su identidad antes de responder a dicha solicitud. Su solicitud debe proporcionar información suficiente para permitirnos verificar que usted es el titular de los datos o que es su representante legal. Si recibimos esta solicitud por parte de un representante legal, es posible que le solicitemos un poder notarial.',
    'We rely on user’s consent as a legal base as defined in the GDPR upon which we collect and process your Personal Information.' => 'Confiamos en el consentimiento del usuario como la base legal tal como se define en el RGPD sobre el cual recopilamos y procesamos su información personal.',
    'Contact information (such as email address, phone number, etc)' => 'Detalles de contacto (como dirección de correo electrónico, número de teléfono, etc.)',
    'Account details (such as user name, unique user ID, password, etc)' => 'Detalles de la cuenta (como nombre de usuario, contraseña, etc.)',
    'We receive and store any information you knowingly provide to us when you create an account, make a purchase, or fill any forms on the Website. When required, this information may include the following:' => 'Recibimos y almacenamos cualquier información que nos proporcione cuando crea una cuenta, realiza una compra o completa formularios en el sitio web. Cuando sea necesario, esta información puede incluir:',
    'You can access and use the Website and Services without telling us who you are or revealing any information by which someone could identify you as a specific, identifiable individual. If, however, you wish to use some of the features offered on the Website, you may be asked to provide certain Personal Information (for example, your name and e-mail address).' => 'Puede acceder y utilizar el sitio web y sus servicios sin revelar su identidad o cualquier información que lo identifique como individuo. Sin embargo, si desea utilizar algunas de las funciones que se ofrecen en el sitio web, es posible que se le solicite que proporcione cierta información personal (por ejemplo, su nombre y dirección de correo electrónico).',
    'Contacting us' => 'Contáctenos',
    'This document was last updated on June, 2024' => 'Este documento fue actualizado por última vez en junio de 2024.',
  ),
  'ShopThemeMenu' => 
  array (
    'Become a suplier' => 'Sea Proveedor',
    'Become a dealer' => 'Sea Revendedor',
    'About Us' => 'Conócenos',
    'Clearence' => 'LIQUIDACIÓN',
    'Catalogs' => 'RECURSOS',
    'Brands' => 'Marcas',
    'News' => 'Novedades',
  ...
  array (
    ...
    'In stock' => 'En stock',
    'Limited stock, please contact us' => 'Stock limitado, por favor consúltenos',
    'Canceled' => 'Cancelado',
    'Shipped' => 'Enviado',
    'Backorder' => 'Pedido pendiente',
    'In preparation' => 'En la preparación de',
    'Waiting payment' => 'Esperando el pago',
    'Waiting validation' => 'Esperando validación',
...
De acuerdo con la Rec.30;Art.7(1)(c)',
  ...
  'ShopThemeCopyrights' => 
  array (
    '@ 2024 All Stars Distribution. All Rights Reserved.' => '@ 2024 All Stars Distribution. Todos los derechos reservados.',
  ),
  'ShopThemeErrorsForm' => 
  array (
    'Please fill all required field!' => '¡Por favor, complete todos los campos obligatorios!',
    'error_message_6' => 'La URL ingresada para el campo \'Redes sociales\' no es válida. Por favor, verifique.',
    'error_message_5' => 'La URL ingresada para el campo \'Sitio web\' no es válida. Por favor, verifique.',
    'error_message_4' => 'El correo electrónico ingresado no es válido. Por favor, verifique.',
    'error_message_3' => 'Debe seleccionar al menos un \'Mercado principal\'.',
    'error_message_2' => 'Debe seleccionar al menos un \'Tipo de negocio\'.',
    'error_message_1' => 'Debe completar al menos uno de los campos \'Sitio web\' o \'Redes sociales\'.',
  ),
  'ShopThemeLegalNotice' => 
  array (
    'Copyright 2024 : All Stars Distribution - All Rights Reserved' => 'Copyright 2024 : All Stars Distribution - Todos los derechos reservados',
    'We do not share information about your use of our site with any third company.' => 'No compartimos información dobre su uso de nuetro sitio con ninguna tercera empresa.',
    'This website uses cookies for optimal performance and to analyze our traffic.' => 'Este sitio web utiliza cookies para un rendimento óptimo y para analizar nuestro tráfico.',
    ...
    'Company:' => 'Compañia:',
    'PT / 513881387' => 'PT / 513881387',
    'VAT Number / License:' => 'Numero de IVA / CIF: ',
  ),
  'ShopThemecatalog' => 
  array (
  ...
  array (
    ...
    'Allows you to extract your personal data in a CSV document!.' => 'Le permite extraer sus datos personales en un documento CSV!',
    'Portability of personal data' => 'Portabilidad de datos personales.',
    'Remove Account' => 'Eliminar Cuenta',
    'After the account has been removed you can not go back!.' => 'Después de que la cuenta ha sido eliminada no puede volver atrás!',
    'Remove account' => 'Eliminar cuenta',
    'General Data Protection Regulation' => 'Reglamento general de protección de datos',
    'Submit form' => 'Guardar',
    'Vat Number' => 'Número de IVA',
    'Company Name' => 'Empresa',
    'Your Company Information' => 'Empresa',
    'Sign up for our newsletter!' => 'Inscríbase a nuestra lista de correo !',
    'New Password Confirmation' => 'Confirmar',
    'New Password' => 'Nueva contraseña ',
    'Current Password' => 'Contraseña actual',
    ...
    'Last Name' => 'Apellidos',
    'First Name' => 'Nombre',
    'Please be sure to update your personal information if changed.' => 'Por favor actualice su información personal si éstas ha cambiado.',
    'Your Personal Information' => 'Datos personales',
    'Create new address' => 'Crear nueva dirección',
    'Total purchases by brand (€)' => 'Total compras por marca (€)',
    'Total purchases per month' => 'Total compras por mes',
    ...
    'Canceled' => 'Cancelado',
    'Shipped' => 'Enviado',
    'Backorder' => 'En Backorder',
    'In preparation' => 'En preparación',
    'Waiting payment' => 'Espera de pago',
    'Waiting validation' => 'En Validación',
    'Clean Filter' => 'Eliminar filtro',
    'Not Invoiced' => 'No facturado',
    'Partial Shipping' => 'Envío parcial',
    'On Backorder' => 'En backorder',
    'Packing in progress' => 'En preparacion',
    'Awaiting payment' => 'Espera de pago',
    'Awaiting confirmation' => 'En validación',
    'Order ID' => 'Referencia del pedido',
    'Tracking' => 'Seguimiento',
    'Carrier' => 'Transportadora',
    'Total Orders' => 'Total',
    'Rate per parcel up to 305cm girth ( 2 x H + 2 x B + 1 x L ) - Oversized applicable : 21.50 €' => 'Tarifa por paquete hasta 305 cm de circunferencia (2xH + 2xB + 1L) - Aplicable a paquetes grandes: 21,50€',
    'Euro shipping rates' => 'Tarifas de envío',
  ...
  array (
    ...
    'Name' => 'Nombre',
    'My contact does not refer to any order' => 'Mi contacto no se refiere a ningún pedido.',
  ...
  array (
    ...
    'In stock' => 'En stock',
    'Limited stock, please contact us' => 'Stock limitado, por favor contáctenos',
    'RRP / PVP' => 'RRP EX IVA',
    'Your Price' => 'SU PRECIO',
    'Your Margin' => 'SU MARGEN',
    'Discount' => 'DESCUENTO',
    'Price' => 'Precio',
  ),
  'ShopThemeStatistics' => 
  array (
    'You haven\'t made any purchases yet!' => '¡Aún no has realizado ninguna compra!',
    'You haven\'t viewed any products yet!' => '¡Aún no has visto ningún producto!',
    'Last viewed products' => 'Últimos productos vistos',
    'Average value per order' => 'Valor medio por pedido',
    'Total orders amount' => 'Valor total de los pedidos',
    'Number of orders' => 'Numero de pedidos',
    ...
    'Profile' => 'Perfil',
    'Shipping Rates' => 'Tarifas de envio',
    'Statistics' => 'Estadísticas',
    'Dashboard' => 'Panel',
    'Orders history' => 'Historial de Pedidos',
    'Most purchased products' => 'Productos más comprados',
    'Notifications' => 'Notificaciones',
    'Total purchases by brand (€)' => 'Total de compras por marca (€)',
    'Total purchases per month' => 'Total de compras por mes',
    'Contact' => 'Contacto',
    'Warranty' => 'Garantía',
  ),
  'ShopThemeLinklist' => 
  ...
  array (
    'View your order history' => 'Ver su historial de pedidos',
    'Order reference:' => 'Referencia del pedido:',
    'Once confirmed, an email will be sent within 48 hours with the total to be paid and a summary of the order. Please do not make the payment until you receive the email confirming the order.' => 'Una vez confirmado se le enviará un correo electrónico en las siguientes 48 horas con el total a pagar y un resumen del pedido.',
    'Your order has been received.' => 'Su pedido ha sido recibido.',
    'Thank you for your purchase at' => 'Gracias por su compra en',
    'Merci' => 'Gracias',
    'Attention, ne procedez à aucun paiement avant reception et controle de la validation de commande envoyée par notre service commercial.' => 'Por favor no realice ningún pago antes de recibir y comprobar la validación del pedido enviada por nuestro departamento comercial.',
    'Prêtez attention au commentaires éventuellement présents sur la confirmation de commande (délais, disponibilité,changement,etc...)' => 'Preste atención a cualquier comentario que pueda aparecer en la confirmación del pedido (plazo, disponibilidad, modificación, etc.).',
    'Dans les prochaines minutes, vouz recevrez par email une confirmation de commande incluant les frais de livraison afin de vous permettre d´effectuer votre paiement via les modalités sélectionnées.' => 'En los próximos minutos recibirá por correo electrónico una confirmación del pedido con los gastos de envío para que pueda realizar el pago mediante el método seleccionado.',
    'Thank you' => 'Gracias',
    'Please do not make any payment before receiving and checking the order confirmation sent by our sales department.' => 'Por favor no realice ningún pago antes de recibir y comprobar la validación del pedido enviada por nuestro departamento comercial.',
    'Please pay attention to any comments that may be present on the order confirmation (ETA, availability, modification, etc.).' => 'Preste atención a cualquier comentario que pueda aparecer en la confirmación del pedido (plazo, disponibilidad, modificación, etc.).',
    'In the next few minutes, you will receive an order confirmation by email including the delivery costs to allow you to make your payment via the selected method.' => 'En los próximos minutos recibirá por correo electrónico una confirmación del pedido con los gastos de envío para que pueda realizar el pago mediante el método seleccionado.',
  ...
  array (
    'Send' => 'Enviar',
    '(max 500 chars)' => '(max 500 caracteres)',
    'Message' => 'Mensaje',
  ...
  'ShopThemeReset' => 
  array (
    'Please enter the email address you used to register. You will receive a temporary link to reset your password.' => 'Por favor ingrese la dirección de correo electrónico que utilizó para registrarse. Recibirá un enlace temporal para restablecer su contraseña.',
    'Password Reset' => 'Restablecimiento de contraseña',
    'Reset' => 'RESTABLECER',
    'Cancel' => 'CANCELAR',
    'here' => 'aquí',
    'If necessary, you can contact our technical teams by clicking' => 'Si es necesario, puede contactar con nuestros equipos técnicos haciendo clic',
    'Click on "Cancel" to return to the main page.' => 'Haga clic en "Cancelar" para regresar a la página principal.',
    'Please enter the email associated with your customer account and click on "Reset" to receive a temporary link allowing you to reset your password.' => 'Introduce el correo electrónico asociado con su cuenta de cliente y luego haga clic en "Restablecer" para recibir un enlace temporal que le permitirá restablecer su contraseña.',
    'Reset your Password' => 'Restablecer su Contrasenã',
