...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  'ShopThemePartners' => 
  array (
    'DPD group is the largest parcel delivery network in Europe, carrying worldwide about 5.3 million parcels daily via 77000 workers through their 4 different brands DPD, Chronopost, SEUR and BRT.' => 'DPDgroup is the largest parcel delivery network in Europe, carrying worldwide about 5.3 million parcels daily via 77000 workers through their 4 different brands DPD, Chronopost, SEUR and BRT.',
    'UPS' => 'United Parcel Service is a postal company founded in 1907. It is nicknamed Big Brown, in reference to the color of the employees\' uniform. Its headquarters is in Sandy Springs (Georgia), a suburb of Atlanta. In 2007, UPS employed 430,000 employees, including 320,000 in the United States, operated more than 2,000 daily flights and had a turnover of 43 billion. It delivers 15.6 million packages and documents per day to more than 200 countries. UPS, the world\'s leading express parcel transportation company, is also one of the leading providers of services, specialized transportation, logistics, capital and e-commerce.',
    'Smurfit Kappa' => 'Smurfit Kappa is undeniably a leader in the industry, with more than 350 production sites around the world, spread across 22 countries in Europe and 13 countries in America. It is the leading producer of corrugated packaging, boxes and Bag-in-box in Europe, and the only Pan-American producer of corrugated boxes and packaging.',
    'Sonic Tools' => 'Sonic is the specialist in high-quality hand tools, toolboxes, and premium storage solutions. With all of our products, we deliver efficiency, quality and style with organization methods unrivaled in our industry. Their plants in the Netherlands, Germany, and Taiwan maintain ISO9001 certification, ensuring the highest manufacturing stan',
  ),
  'ShopThemeTerms' => 
  array (
  ...
  array (
    ...
    'Total price' => 'Total',
    'Total Orders' => 'Total',
    'Euro shipping rates' => 'Shipping rates',
  ...
  array (
    'VAT Number / License:' => 'VAT Number / Tax ID Number :',
  ),
  'ShopThemeOrderConfirmation' => 
  array (
    'Dans les prochaines minutes, vouz recevrez par email une confirmation de commande incluant les frais de livraison afin de vous permettre d´effectuer votre paiement via les modalités sélectionnées.' => 'In the next few minutes, you will receive an order confirmation by email including the delivery costs to allow you to make your payment via the selected method.',
    'Prêtez attention au commentaires éventuellement présents sur la confirmation de commande (délais, disponibilité,changement,etc...)' => 'Please pay attention to any comments that may be present on the order confirmation (ETA, availability, modification, etc.).',
    'Attention, ne procedez à aucun paiement avant reception et controle de la validation de commande envoyée par notre service commercial.' => 'Please do not make any payment before receiving and checking the order confirmation sent by our sales department.',
    'Merci' => 'Thank you',
  ),
  'ShopThemeCheckout' => 
  array (
    'Billing address' => 'Billing information',
    'Contact us to update' => 'Contact us to update your information',
    'Dropship' => 'Drop Shipping',
    'Pick up with your carrier' => 'Schedule a pick up with your carrier',
    'please choose' => 'Please choose your country',
    'Floor Nº' => 'Floor Number',
    'Stairs Nº' => 'Stairs Number',
    'Door Nº' => 'Door Number',
  ...
  array (
    ...
    'Total orders amount' => 'Total orders value',
  ),
  'messages' => 
  array (
