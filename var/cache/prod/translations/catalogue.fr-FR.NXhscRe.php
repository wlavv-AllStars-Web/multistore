...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'Close' => 'Fermer',
    'Not you? [1]Log out[/1]' => 'Ce n\'est pas toi ? [1]Déconnexion[/1]',
    ...
    'You have given permission to receive your order in recycled packaging.' => 'Vous avez donné votre autorisation pour recevoir votre commande dans un emballage recyclé.',
    'Download your invoice as a PDF file.' => 'Téléchargez votre facture en fichier PDF.',
    'Order Reference %reference% - placed on %date%' => 'Référence de commande %reference% - passée le %date%',
    ...
    'Search again what you are looking for' => 'Recherchez à nouveau ce que vous recherchez',
    'Order history' => 'Historique des Status',
  ...
  array (
    'Become a Supplier' => 'Devenir Revendeur',
    'Become a Dealer' => 'Devenir Fournisseur',
    'If you don’t make the sale, we don’t make the sale! Our design and communication teams, with the support of our IT department, are always working to provide our customers with the latest and best marketing resources. Available to all our partners/customers, these precious resources feature updated catalogues, CSV integration files, API feeds, product photos and digital content specific to each brand. Our newsletters and social media presence keep you informed, without any delay, of upcoming events, new products, new brands and the global news from our industry.' => 'Nos équipes design, avec l\'appui de notre département web, travaillent au quotidien pour créer les outils marketing nécessaires à la distribution efficace des produits que nous proposons. Ces ressources, d\'une importance capitale, sont mises à la disposition de nos clients partenaires qui profitent de catalogues actualisés, de fichiers d\'intégration CSV, de Feeds API, de photos produits ou encore de contenu digital propres à chacune de nos marques. Enfin, l\'utilisation d\'outils de communication marketing tels que les Newsletters ou les Réseaux Sociaux nous permettent de tenir nos clients informés, sans délai, de l\'actualité globale de notre industrie (nouvelles marques, nouveaux produits, événements, etc).',
    'Our purchasing department, made up of enthusiasts with solid knowledge of the market and products, works in close collaboration with each brand we carry, to offer the best, latest products ahead of the trend. In addition to the daily listing of new products added to our catalogues, we are always working on adding to our line card—only brands that meet our very strict quality requirements. Already with an exclusive offering of more than 30 specialized, performance enhancing brands, All Stars Distribution is your single source for the material you need to bring your customers’ projects to completion.' => 'Notre département achat, composé de passionnés disposant d\'une solide connaissance du marché et des produits, travaille en étroite collaboration avec chacune des marques que nous distribuons, afin de vous proposer des produits à la pointe de la tendance, à la fois pertinents et qualitatifs. Outre le référencement quotidien des nouveautés proposées par nos partenaires, nous enrichissons également régulièrement notre line card avec des marques exclusives provenant du catalogue de fabricants leaders venus des quatre coins du monde et répondant parfaitement à nos exigences de qualité. Avec plus de 30 marques référencées, All Stars Distribution est à ce jour le distributeur exclusif disposant de la plus large gamme de pièces performance en Europe, vous permettant de commander au même endroit tous les éléments nécessaires à la réalisation des projets de vos clients !',
    'Our online platform, developed in-house by our IT department, is constantly evolving to offer our customers more and more digital tools! Among other things, through our trade portal you can consult our products and stock levels, see the Retail Prices and your discounts, place your orders and follow their progress until the final delivery. In a few clicks, you can track your parcels, check your proforma and final invoices, see your statistics, manage your account or contact our support teams--currently available in 5 languages (French, English, Spanish, Portuguese and Romanian). Offering a unique platform in Europe, exclusively dedicated to wholesale, All Stars Distribution has all the products and services required to support and develop your business!' => 'Notre plateforme en ligne développée exclusivement par nos équipes web n\'a de cesse d\'évoluer pour vous offrir toujours plus d\'outils et une meilleure ergonomie ! Via notre portail vous pouvez, entre autres, très facilement consulter nos produits et leur niveau de stock, les tarifs RRP ainsi que vos remises, passer vos commandes et en suivre l\'évolution jusqu\'à leur livraison. En quelques clics, vous pouvez également accéder à vos numéros de suivi colis, vos pro forma ou factures, consulter vos statistiques, piloter votre compte et contacter nos équipes supports pour le moment disponibles en 5 langues (français, anglais, espagnol, portugais et roumain). Offrant une plateforme unique en Europe et exclusivement dédiée aux professionnels, All Stars Distribution dispose de tous les éléments et services nécessaires à l\'accompagnement et au développement de votre activité !',
    'As an international distributor we understand the importance of reliable third-party shipping partnerships and managing shipping expenses. To help limit and simplify these costs, we offer various options to our customers such as Flat Rate shipping charges, applying a scale of only two values per country of destination. Resellers can take advantage of our Drop Shipping option through which your customer receives the product directly from our warehouse, but showing the name of your company as the sender! Our Pick Up option allows our customers to organize the collection and the shipping of their goods via their own carrier.' => 'Assurant l\'expédition de nos marchandises dans le monde entier, l\'acheminement des colis, palettes ou containers confiés à des entreprises tiers est un poste sensible en raison des coûts qu\'il génère. Afin de limiter ces coûts ainsi que les temps de transit, nous offrons différents outils tels que le Drop Shipping permettant l\'expédition d\'une commande directement depuis nos entrepôts vers votre client final, ce dernier recevant un colis portant le nom de votre entreprise comme expéditeur ! Le Bulk Packing qui consiste à regrouper les articles commandés en un minimum de colis afin d\'en diminuer les coûts de transport. Les tarifs de transport Flat Rate permettent de simplifier au maximum les frais de livraison, appliquant un barème à deux valeurs par pays de destination, ou encore le Pick Up vous permettant d\'organiser vous même la ramasse de vos commandes par le biais de votre propre transporteur.',
    'Order management is at the foundation of our business. Our efficiency in picking, packing and dispatching will determine the level of satisfaction of your customers. To ensure a fast and reliable operation we use a specific Order Fulfillment Software developed in-house by our Information Technology Team. Our proprietary software, called "All Stars Log", applied to the picking, packing and reception, ensures a "double check control" providing us an error rate close to 0! Our system’s responsiveness and processing capacity assist us in getting 94% of orders processed and shipped, using premium packaging accessories, in less than 6 hours. Retail quality service for the wholesale market.' => 'La gestion des commandes est la base de notre métier. Préparer, contrôler et expédier rapidement vos commandes détermineront le niveau de satisfaction de vos clients, et c\'est, afin d\'assurer des opérations logistiques fiables et rapides, que nous utilisons un logiciel de préparation de commandes développé en interne et couplant la synergie de 3 outils qui sont le PDA/Scan, la vidéo détection et la balance 3D. Ce système informatique complexe baptisé \'AllStars Log\' appliqué au picking, au packing et à la réception des marchandises, assure un double contrôle nous permettant un taux d\'erreur proche de 0 ! Disposant d\'une excellente réactivité et d\'une grande capacité de traitement, 94% des commandes en préparation sont traitées et expédiées, à l\'aide d\'accessoires d\'emballage premium, en moins de 6 heures, assurant donc une qualité de service de type retail dans un marché wholesale.',
    'As a wholesaler, the importance of inventory, having it and managing it, cannot be overstated. All Stars Distribution places the highest priority on maintaining the depth and breadth of our inventory all year round. To quickly supply a wide range of specialized products, often manufactured in small quantities to serve the just-in-time market, WE STOCK 98% of our partner manufacturers’ product lines. By choosing All Stars Distribution as a supplier for your performance parts, you will have a direct access to the largest stock of niche market products in Europe, without any financial, human or logistical constraints! Our Warehouse Management and Enterprise Resource Planning Systems, developed in-house by our Information Technology Team, allow us to limit stockouts as much as possible using extremely reliable purchasing algorithms for quick order fulfillment!' => 'La disponibilité des produits étant la clé de tout commerce, All Stars Distribution attache une importance capitale à disposer d\'un colossale volume d\'articles stockés toute l\'année. Afin de vous permettre de répondre aux besoins de vos clients sur des produits particuliers, fabriqués en petites quantités par des fabricants travaillant souvent en flux tendus, nous stockons via 3 entrepôts totalement automatisés 98% des articles proposés par nos fournisseurs partenaires. En choisissant All Stars Distribution comme fournisseur pour vos pièces performance, vous disposerez du plus grand stock de produits niche en Europe, et ce, sans aucune contrainte financière, humaine ou logistique ! Notre système de gestion d\'entrepôts WMS et notre système de gestion de stock ERP développés exclusivement en interne par nos équipes informatiques, nous permettent, sinon de prévenir, au moins de limiter au maximum les ruptures de stock via l\'emploi d\'algorithmes d\'achats extrêmement fiables !',
    'View More' => 'Voir Plus',
    'Supplying over 30 top of the line brands to automotive performance professionals worldwide, All Stars Distribution is one of the largest European wholesalers of performance and design parts. Dedicated to serving shops, tuners, e-dealers and other resellers, All Stars Distribution is committed to employing the best of inventory management and distribution practices to get our customers the performance parts they need to satisfy their customers.' => 'Fournissant plus de 30 marques aux professionnels de la performance automobile aux quatre coins du monde, All Stars Distribution est un grossiste européen de pièces performance et design comptant parmi les plus importants du marché de par la taille de son réseau de distribution mais également de part son stock, classant l\'entreprise comme le plus gros stockiste multimarques européen. Dédié uniquement au wholesale (vente aux professionnels), All Stars Distribution dispose d\'entrepôts de stockage automatisés en Europe, permettant de fournir en un minimum de temps les pièces nécessaires à la réalisation des projets des ateliers de montage, mappeurs ou e-dealers composant le marché de la performance automobile.',
    'Profile' => 'Profil',
  ),
  'ShopThemeFormBecomedealer' => 
  array (
    'Submit' => 'Soumettre',
    'By my signature, I certify the information I provided on and in connection with this form is true and correct to the best of my knowledge. I also understand that any false statements or deliberate omissions on this form may subject me to legal actions for fraudulent misrepresentation.' => 'Je certifie que les informations transmises par le biais de ce formulaire sont exactes et véridiques. Je comprends que toute fausse déclaration ou omission volontaire quant aux informations transmises pourrait m\'exposer à des poursuites pour fausse déclaration.',
    'Reset' => 'Reset',
    'Signature' => 'Signature',
    'Comment' => 'Commentaire',
    'Main current suppliers' => 'Principaux fournisseurs actuels',
    '1M€ +' => '1M€ +',
    '500K€ to 1M€' => '500K€ to 1M€',
    '100K to 500K€' => '500K€ to 1M€',
    'Under 100K€' => 'Moins de 100K€',
    'Annual sales volume' => 'Chiffre d\'affaires annuel',
    'Diesel' => 'Diesel',
    'Offroad' => 'Tout terrain',
    'Classics' => 'Classiques',
    'Muscle' => 'Muscle',
    'JDM' => 'JDM',
    'Address 2' => 'Adresse ligne 2',
    'Phone' => 'Téléphone',
    'Address' => 'Adresse',
    'Email' => 'Email',
    ...
    'Other' => 'Autre',
    'Wholesaler' => 'Distributeur',
    'Market Place Seller' => 'Vendeur sur Market Place',
    'Dyno Shop' => 'Mappeur',
    'E-dealer' => 'E-commerce',
    'Installer' => 'Atelier',
    'Storefront' => 'Magasin',
    'Business Type (Check all that apply)' => 'Type d\'activité',
    'Please Select...' => 'Veuillez sélectionner',
    'Country' => 'Pays',
    'Social Media Link' => 'Réseau Social Actif',
    'Zip Code' => 'Code Postal',
    'City' => 'Ville',
    'Website' => 'Site Web',
    'Current Supplier 3' => 'Fournisseur actuel 3',
    'Current Supplier 2' => 'Fournisseur actuel 2',
    'Current Supplier 1' => 'Fournisseur actuel 1',
    'Important notice:' => 'Avis important:',
    'Additional information' => 'Informations Complémentaires',
    'Your request has been successfully sent and a human resources representative will respond to you shortly' => 'Votre demande a été envoyée avec succès et un représentant des ressources humaines vous répondra sous peu.',
    'Your enquiry  has been successfully sent and a sales representative will respond to you shortly' => 'Votre demande a été envoyée avec succès et un représentant des ventes vous répondra sous peu.',
  ),
  'ShopThemeBecomeDealer' => 
  array (
    'Why choose us ?' => 'Pourquoi nous choisir ?',
    'European leader in the Automotive Distribution Industry, All Stars Distribution supplies daily hundreds specialized professionals around the world. ' => 'Leader Européen de la distribution de pièces automobiles performance, All Stars Distribution fournit quotidiennement des centaines de professionnels spécialisés dans le monde.',
    'Fill out the become a dealer enquiry form' => 'FORMULAIRE DE DEMANDE D\'OUVERTURE DE COMPTE',
    'Tuning / building' => 'Mappeur / préparateur',
    'Performance parts' => 'Pièces performance',
    'Aftermarket parts' => 'Pièces aftermarket',
    'Activity' => 'ACTIVITÉ',
    'Active social media' => 'Réseau social',
    'Active website' => 'Site web',
    'Visibility' => 'VISIBILITÉ',
    'Valid bank account' => 'Compte bancaire',
    'Valid business license' => 'Licence commerciale',
    'Valid VAT number' => 'Numéro de TVA',
    'Admin' => 'Admin',
    'Trader' => 'Trader',
    'E-dealer' => 'E-commerce',
    'Tuner' => 'Tuner',
    ...
    'Storefront' => 'Magasin',
    'Business' => 'Business',
    '> NEW ACCOUNT REQUIREMENTS <' => '> CONDITIONS D\'OUVERTURE DE COMPTE <',
    'Betting on long-term partnership, we\'re very selective and approve new accounts only for companies matching with our requirements' => 'Établissant des partenariats à long terme, nous sommes particulièrement sélectifs et ne validons de nouveaux comptes que pour les entreprises répondant à nos conditions d\'éligibilité.',
  ),
  'ShopThemeAbout' => 
  array (
    'View More' => 'Voir Plus',
  ...
  'ShopThemePayment' => 
  array (
    'Please also note that no items are reserved until payment for the order has been confirmed in our bank account.' => 'Veuillez également prendre en considération qu\'aucun article n\'est réservé avant la confirmation de réception du paiement de la commande sur notre compte bancaire.',
    'Please note that payment by bank transfer will result in additional processing time for the dispatch of an order as it will only be dispatched once payment has been received in our bank account.' => 'Notez que le paiement par virement bancaire entraîne un délai de traitement supplémentaire pour l\'expédition d\'une commande puisqu\'elle ne se fera qu\'une fois le règlement réceptionné sur notre compte bancaire.',
    'Payments by bank transfer must be made within 72 hours after the order has been confirmed. If the payment is not made within this period, your order will be automatically cancelled.' => 'Les paiements par virement bancaire doivent être effectués dans un délai de 72 heures après la validation de la commande. Si le paiement n\'est pas effectué dans ce délai, votre commande sera automatiquement annulée.',
    'Once you have selected payment by bank transfer on our website, you will receive a confirmation email with the details of our bank account, to which the payment should be made.Please note that these details must be exclusively in the name of ALL STARS DISTRIBUTION and based in Portugal.' => 'Une fois le paiement par virement sélectionné sur notre site, vous recevrez un email de confirmation avec les coordonnées de notre compte bancaire, vers lequel le paiement doit être effectué. Notez que ces coordonnées doivent exclusivement être au nom de ALL STARS DISTRIBUTION et domiciliées au Portugal.',
    'BANK TRANSFER :' => 'VIREMENT BANCAIRE :',
    'The total amount paid will be debited immediately and the rest of the process and the update of the order status will be instantaneous. A confirmation will then be sent to you by email as a digital archive.' => 'Le montant réglé, étant debité immédiatement pour son montant total, la suite du processus et l\'actualisation du statut de commande seront alors instantanés. Une confirmation vous sera alors envoyée par mail à titre d\'archive numérique.',
    'In order to validate the payment of an order, the name of the cardholder, its 16-digit number, its expiry date and its cryptogram will be requested by no other organisation other than our online payment service provider Ingenico.' => 'Afin de valider le règlement d\'une commande, le nom du titulaire de la carte, son numéro à 16 chiffres, sa date d’expiration ainsi que son cryptogramme seront demandés sans qu\'aucun organisme autre que notre prestataire de service de paiement en ligne Ingenico n\'y ait accès.',
    'In the interest of security and confidentiality, all data communicated during the payment procedure is encrypted and only entered on the page of our financial partner Ingenico.' => 'Dans un souci de sécurité et de confidentialité, l\'intégralité des données communiquées lors de la procédure de paiement sont cryptées et renseignées exclusivement sur la page de notre partenaire financier Ingenico.',
    'Visa and Mastercard are the accepted bank cards for the payment of an order on our online platform.' => 'Visa et Mastercard sont les cartes bancaires acceptées pour le paiement d’une commande sur notre plateforme en ligne.',
    'CREDIT CARD :' => 'CARTE BANCAIRE : ',
    'ALL STARS DISTRIBUTION offers two methods of payment :' => 'ALL STARS DISTRIBUTION propose deux modes de règlement :',
  ),
  'ShopThemePartners' => 
  array (
    'All Stars Web Solutions is a top range web agency specializing in website design and development, software and application creation, digital marketing, and SEO. Offering the latest technologies IT tools for warehouse management (ERP), cybersecurity, front and back end with optimal ergonomics, they make the management of a website accessible to everyone.' => 'All Stars Web Solutions est une agence web de premier plan, spécialisée dans la conception et le développement de sites web, création de logiciels et applications, marketing digital et référencement SEO. Elle propose les dernières technologies en matière d’outils informatiques de gestion d\'entrepôt (ERP), de cybersécurité, de front et back end avec une ergonomie optimale, rendant ainsi la gestion d’un site web accessible à tous.',
    'Norton or Norton by Symantec, is a division of NortonLifeLock based in California and offering a variety of products and services related to digital security. In 2014, it was announced that Norton\'s parent company Symantec would split its business into two units - one focused on security, and one focused on information management, with Norton being placed in the unit focused on security.' => 'Norton est un logiciel antivirus pour les systèmes d\'exploitation Windows et Mac édité par la société américaine Symantec qui figure aujourd\'hui dans le top 3 des classements des meilleurs antivirus du marché.',
    'Sonic Tools' => 'Sonic est le spécialiste de l’outillage manuel, des boîtes à outils et des solutions de stockage haut de gamme. Avec une large gamme de produits, ils offrent efficacité, qualité et style avec des solution de rangement inégalées dans leur secteur. Leurs usines aux Pays-Bas, en Allemagne et à Taiwan maintiennent la certification ISO9001, garantissant ainsi les normes de fabrication les plus élevées.',
    'Smurfit Kappa' => 'Smurfit Kappa est indéniablement un leader du secteur, avec plus de 350 sites de production à travers le monde, répartis dans 22 pays en Europe et dans 13 pays aux Amériques. C’est la première entreprise de production d’emballages en carton ondulé, de caisses et de Bag-in-box en Europe, et l’unique producteur panaméricain de caisses et d’emballages en carton ondulé. ',
    'Adobe Inc is an American multinational computer software company focused upon the creation on multimedia and creativity software products, with a more recent foray into digital marketing software. Adobe is best known for its Adobe Flash web software, Photoshop image editing software, Adobe Illustrator graphics editor and Acrobat Reader.' => 'Adobe est une entreprise informatique de logiciels graphiques dont InDesign, Acrobat, Photoshop, Illustrator et Flash. La société a également créé des logiciels de montage vidéo (Adobe Premiere Pro et After Effects) et audio qui sont maintenant des références mondiales dans le domaine de l\'édition digitale.',
    'Ingenico is a France-based company, whose business is to provide the technology involved in secure electronic transactions. Its traditional business is based on the manufacture of point of sale (POS) payment terminals, but it also includes complete payment software and related services, also software for merchants.' => 'Ingenico Group est une société spécialisée dans les prestations de paiements, figurant parmi les leaders mondiaux du marché des terminaux de paiement.',
    'TNT Express is an international courier delivery services company founded in the Netherlands in 2011 and now a subsidiary of FedEx. TNT offers road and air delivery services in Europe, the region of the Asia Pacific, the Americas, the Middle East, and Africa.' => 'TNT est une entreprise de transport spécialisée dans les services de livraison de documents, colis et palettes offrant la possibilité de choisir parmi de multiples solutions de transport express ou économique.',
    'UPS' => 'United Parcel Service est une entreprise postale fondée en 1907. Elle est surnommée la Big Brown, par allusion à la couleur de l\'uniforme des employés. Son siège est à Sandy Springs (Géorgie), dans la banlieue d’Atlanta. En 2007, UPS emploie 430 000 employés, dont 320 000 aux États-Unis, assure plus de 2 000 vols quotidiens et réalise un chiffre d\'affaires s\'élevant à 43 milliards. Elle livre 15,6 millions de colis et documents par jour dans plus de 200 pays. Numéro un du transport express de colis à travers le monde, UPS est aussi l\'un des premiers fournisseurs de services, de transports spécialisés, de logistique, de capital et de commerce électronique.',
    'Website' => 'Website',
    'DPD group is the largest parcel delivery network in Europe, carrying worldwide about 5.3 million parcels daily via 77000 workers through their 4 different brands DPD, Chronopost, SEUR and BRT.' => 'DPDgroup est le premier réseau de transport terrestre de colis en Europe assurant la prise en charge, le suivi et la livraison de plus de 5 millions de colis par jour via leurs 77.000 collaborateurs regroupés au sein de 4 marques (DPD, Chronopost, Seur et BRT)',
    'A.P. Møller-Mærsk, also known simply as Maersk is a Danish shipping and logistics company founded in 1904 by Arnold Peter Møller and Peter Mærsk Møller. Maersk\'s business activities include shipping, port operation, supply chain management and warehousing. The company is based in Copenhagen, Denmark, with subsidiaries and offices across 130 countries and 108.000 employees worldwide.' => 'A.P. Møller-Mærsk, société créée en 1904, est et la plus grande entreprise du Danemark. Connu aussi sous le simple nom de Mærsk, le groupe est présent dans le transport maritime avec Maersk Line, première compagnie maritime et plus grand armateur de porte-conteneurs du monde. Le groupe compte 108 000 employés dans le monde.',
    'Key partner of the biggest brands in the performance automotive industry, BR-Performance is a key player in the custom tuning software market thanks to solid knowledges and state-of-the-art equipment.' => 'Partenaire privilégié des plus grandes marques du secteur de la performance automobile, BR-Performance est un acteur incontournable dans le monde de la préparation automobile grâce à des connaissances solides et des équipements haut de gamme.',
    'Since 2008, ShifTech has been a specialist in custom tuning software that offers the perfect combination of increased engine power and more economical fuel consumption. Present in France, Belgium and Luxembourg, it is a reference in the market due to its quality of service and its experience.' => 'Depuis 2008, ShifTech est un spécialiste de la reprogrammation moteur permettant d\'augmenter le couple et la puissance des véhicules tout en réduisant leur consommation de carburant. Présente en France, en Belgique et au Luxembourg, c’est une référence dans le domaine en raison de sa qualité de service et de son savoir-faire.',
    'Since 2003, the company DIGISERVICES is a reliable supplier of high quality and customized tuning software files. French leader with more than 30 auto centers in France, more than 6000 vehicles visit their workshops each year.' => 'Depuis 2003, la société DIGISERVICES est spécialisée dans la mise au point et l’optimisation des gestions électroniques moteur les plus complexes. Leader français avec plus de 30 centres en France, plus de 6000 véhicules passent dans leurs ateliers chaque année.',
    'Banco Comercial Português (BCP) is a Portuguese bank, member of the PSI-20 index and the Next 150. It is present in Portugal as Millenium BCP and in Belgium and Luxembourg as Banque BCP. It is also present in other countries and is listed on the Euronext stock exchange. Banque BCP was born in 2001 from the merger of the French branches of the oldest Portuguese financial establishments.' => 'Banco Comercial Português (BCP) est une banque portugaise membre de l\'indice PSI-20 et du Next 150. Elle est présente au Portugal sous le nom de Millenium BCP et en Belgique et au Luxembourg sous le nom de Banque BCP. Elle est aussi présente dans d\'autres pays et est cotée en bourse Euronext. La Banque BCP est née en 2001 de la fusion des succursales françaises des plus anciens établissements financiers portugais.',
    'Vehicles transport specialist, TrancarPremium uses state-of-the-art logistics tools, allowing the team to offer unparalleled quality of service and great management flexibility. Based in Portugal, the company offers different premium solutions for shipping supercars, racing cars, classics or exotics throughout Europe.' => 'Spécialiste du transport de véhicules, TrancarPremium utilise des outils à la pointe de la technologie en matière de logistique, permettant d\'offrir une qualité de service et une flexibilité inégalables. Basée au Portugal, la société offre différentes solutions premium pour le transport de Supercars, voitures de course, classiques ou exotiques à travers toute l\'Europe.',
    'European platform, founded in 2013 and established in 3 countries, All Stars Motorsport has quickly become a key player in aftermarket automotive performance and design industry. Reseller of the most famous brands, All Stars Motorsport offers the best products at the best prices to allow to offer everyone their own vision of the automobile.' => 'Plateforme Européenne, fondée en 2013 et implantée dans 3 pays, All Stars Motorsport est rapidement devenu un acteur incontournable de la performance et du design automobile aftermarket. Revendeur des plus grandes marques, All Stars Motorsport propose au quotidien les meilleurs produits aux meilleurs prix afin d’offrir à chacun sa propre vision de l’automobile.',
  ),
  'ShopThemeBecomesupplier' => 
  array (
    'Submit an enquiry' => 'Soumettre uNE DEMANDE',
    'In order to preserve a fair market for all players in the industry, All Stars Distribution has no relationship with marketplaces or gray market players. Above all, we want our suppliers to be partners and not competitors for our customers and therefore expect our suppliers to show the same respect for this ethics.' => 'Afin de préserver un marché équitable pour tous les acteurs de notre industrie, All Stars Distribution ne dispose d\'aucune relation avec les marketplaces ou les acteurs du marché gris. Nous voulons avant tout que nos fournisseurs soient des partenaires, et non des concurrents, pour nos clients et attendons donc de nos fournisseurs le même respect pour cette éthique.',
    'Deontology' => 'DÉONTOLOGIE',
    'Investing big money and time in developing the visibility and the fame of the brands we distribute, we expect our suppliers to be part of our efforts, supporting our projects and being involved in their own brand promotion.' => 'Investissant argent, temps et effort dans le développement de l\'image et la médiatisation des marques que nous distribuons, nous attendons de nos fournisseurs le même investissement et leur support dans le cadre de projets marketing.',
    'Marketing' => 'MARKETING',
    'Management and control tools development is an extremely important part of our daily work, so we expect our suppliers to have the same interest and the same commitment to technological research and development.' => 'Le développement d\'outils de gestion et de contrôle occupent une part extrêmement importante de notre travail interne, nous attendons donc de nos fournisseurs le même intérêt et le même engagement pour la recherche et le développement technologique.',
    'Technology' => 'TECHNOLOGIE',
    'Key element of a business relationship, we attach great importance to the quality of our communication with our customers. The quick and clear transmission of informations is an asset that we must maintain and apply on a daily basis with our suppliers.' => 'Elément clé d\'une relation d\'affaires, nous accordons une grande importance à la qualité de notre communication avec nos clients. La transmission rapide d\'informations claires et précises est un atout que nous devons conserver et appliquer au quotidien avec nos fournisseurs.',
    'Communication' => 'COMMUNICATION',
    '> Our 4 key commitments <' => '> Nos 4 engagements clés <',
    'In order to offer our customers the best products and services, we are extremely selective when choosing our suppliers or our products and intend to work only with manufacturers sharing our values and our ethic.' => 'Afin d\'offrir à nos clients les meilleurs produits et services, nous sommes extrêmement sélectifs quant au choix de nos fournisseurs et de nos produits, et entendons ne travailler qu\'avec des fabricants partageant nos valeurs et notre éthique.',
    'European leader in performance auto parts distribution, All Stars Distribution bets on long-term relationships with world-class suppliers.' => 'Leader Européen de la distribution de pièces automobiles performance, All Stars Distribution développe des relations à long terme avec des fournisseurs de classe internationale.',
  ),
  ...
  array (
    ...
    'Comment' => 'Commentaire',
    'Email' => 'Email',
    'Social media' => 'Réseau Social Actif',
    'Website' => 'Website',
    'Phone' => 'Téléphone',
    'Company' => 'Société',
  ),
  'ShopThemeCareer' => 
  array (
    '- Knowledge of relational database systems, Object Oriented Programming and web applications development' => '- Connaissances en logiciels de bases de données relationnelles, en Object Oriented Programming et en développement d\'applications web ',
    '- Fluency in one of these languages : English or French' => '- Maîtrise de l\'une de ces langues : anglais ou français ',
    '- Top-notch programming skills and in-depth knowledge of HTML, CSS, JavaScript, PHP,and other coding languages' => '- Compétences élevées en programmation et excellentes connaissances du HTML, CSS, JavaScript, PHP et autres langages de programmation ',
    '- 3 years working experience as web developer / programmer in company' => '- 3 ans d\'expériences professionnelles en tant que développeur / programmeur web en entreprise',
    '- High School IT / coding / web design diploma' => '- Diplôme d\'études supérieures en informatique / programmation / conception de sites web ',
    'The web programmers or web developers use a variety of programming languages to create web applications, online tools and resources mainly database-driven.
                      ...
                      They develop our back office programs and interfaces using the best practices and are responsibile for maintaining, expanding, and scaling our sites while staying plugged into emerging technologies / industry trends. ' => 'Les programmeurs web ou développeurs web utilisent divers langages de programmation informatique pour créer des applications web, des outils en ligne et des contenus web principalement basés sur les bases de données relationnelles. Ils travaillent en étroite collaboration avec les chefs de projets et designers pour créer et maintenir attrayants, sécurisés et faciles d\'utilisation nos différents sites web.
Ils développent nos programmes et interfaces de back-office en utilisant les meilleures solutions existantes et sont responsables de la maintenance, de l\'expansion et de l\'évaluation de nos sites web, tout en restant attentifs aux technologies émergentes / nouvelles tendances du secteur. ',
    'View More' => 'Voir Plus',
    '- Knowledge in the automotive industry appreciated' => '- Connaissances dans le secteur de l\'industrie automobile appréciées',
    '- Ability to work harmoniously with diverse range of people' => '- Capacité à travailler en équipe avec plusieurs départements ',
    '- Foreign language spoken / written English or french' => '- Maîtrise de l\'une de ces langues (parlé / écrit) : anglais ou français ',
    '- Familiar with video edition softwares such as Premiere, AfterFX, Finalcut...' => '- Familier avec les logiciels de montage vidéo tels que Première, AfterFX, Finalcut, ...',
    '- Fluency with design softwares like Lightroom, Illustrator, Dreamweaver, Photoshop' => '- Maîtrise des logiciels de conception tels que Lightroom, Illustrator, Dreamweaver, Photoshop',
    '- 2 years working experience as graphic designer in company' => '- 2 ans d\'expérience professionnelle en tant que graphiste en entreprise',
    '- High school graphic diploma or strong portfolio' => '- Diplôme d\'études supérieures en graphisme ou portfolio élaboré ',
    '- REQUIREMENTS -' => '- Requis -',
    'The graphic designer creates visual communications to convey messages in an effective and aesthetically pleasing manner.
                      ...
                      The graphic designer, with a strong creative presence and artistic flair, shapes the visual aspect of our websites; products, marketing supports, exhibitions and more ! ' => 'Le designer graphique est un professionnel de la conception de visuels visant à transmettre des messages alliant sens artistique et enjeux commerciaux.
Il peut s\'agir d\'illustrations, de bannières publicitaires, de logos et de contenus marketing. Doté d\'un fort esprit créatif et d\'un flair artistique, il est responsable de l\'aspect visuel de nos sites web, incluant les images des produits, supports marketing, contenus multimédias et plus encore. ',
    'Full Time - Valenca, PT' => 'Temps complet - Valenca, PT',
    '> OPEN POSITIONS <' => '> OFFRES ACTIVES <',
    'No open position matching with your skills at the moment ?
                    No problem, apply anyway, maybe we can find something for you...' => 'Pas de poste correspondant à votre profil pour le moment ?
Aucun problème, faites nous suivre votre CV, nous avons peut être quelque chose pour vous...',
    'General application' => 'Candidature spontanée',
    '- Warehouse experience or high school diploma required' => '- Expérience logistique ou diplôme d\'études supérieures requis',
    'The warehouse associate uses various digital and mechanical tools to pack and ship the orders accurately.
                    ...
                    The warehouse associate may operate a drivable vertical mast lift, a forklift and perform duties up to 30kgs.' => 'Le préparateur de commandes utilise divers outils digitaux et mécaniques pour procéder à l\'emballage et l\'expédition des commandes avec précision.
Il participe également à la réception des produits, aux inventaires, aux contrôles de conformité, à la programmation des logiciels de gestion de l\'entrepôt tout en organisant l\'espace de ce dernier.
Le poste requiert l\'utilisation de nacelles élévatrices et de chariots élévateurs mais également le transport de charges pouvant aller jusqu\'à 30 kgs. ',
    '- Foreign language spoken highly appreciated' => '- Maîtrise de l\'anglais et / ou de l\'espagnol valorisée',
    '- Forklift licence appreciated' => '- Permis chariot élévateur valorisé ',
    '- Proficient organizational skills' => '- Profil organisé, minutieux et appliqué ',
    '- Physically agile and dexterous' => '- Agilité et dextérité physique',
    '- Excellent verbal and written communication skills' => '- Excellente capacité d\'expression orale et écrite',
    '- Proficient with using computers / electronic devices' => '- Maîtrise de l\'outil informatique (utilisateur) ',
    'The Picker is part of the order preparation process, using various digital and mechanical tools to pick a wide variety of items and bring them to the preparation area.
                    ...
                    The picker will operate a drivable vertical mast lift, a forklift and will perform duties up to 30kgs. ' => 'Le Picker tient un rôle important dans le processus de préparation des commandes, utilisant différents outils mécaniques ou digitaux afin de localiser et transporter des marchandises jusqu\'aux zones d\'emballage.
Le Picker participe également aux réceptions des marchandises, aux inventaires et aux contrôles de conformité, tout en assurant des tâches de maintenance globales au sein de l\'entrepôt.
Le poste requiert l\'utilisation de nacelles élévatrices et de chariots élévateurs mais également le transport de charges pouvant aller jusqu\'à 30 kgs. ',
    '- Ability to stay calm, organized and focused' => '- Excellente capacité à rester calme, organisé et concentré ',
    '- Excellent proofreading skills to identify grammar, spelling or punctuation errors' => '- Excellente capacité de relecture pour identifier les erreurs de grammaire, d\'orthographe ou de ponctuation ',
    '- Proficient with using computers and basic office softwares' => '- Bonne maîtrise de l\'outil informatique ',
    '- High school diploma, general education degree or equivalent.' => '- Diplôme d\'études supérieures d\'enseignement général ou équivalent',
    '- Absolute fluency in one of these languages (French, Spanish, English, German)' => '- Totalement bilingue sur l\'une des langues suivantes : français, espagnol, anglais, allemand ',
    'The customer service representative helps customers, giving them precious information about products or services, following their orders and return / warranty processes.
                        The representative schedule is splitted between answering customers questions via e-mail and working closely with the purchase and marketing departments to elaborate products descriptions and online resources in various languages.' => 'Le chargé de service client joue un rôle de support en donnant des informations précieuses sur les produits ou services et en suivant les commandes et processus de retour / garantie des clients.
Son planning est divisé entre les réponses apportées aux clients par e-mail et un travail en étroite collaboration avec les départements achats et marketing pour élaborer des descriptions de produits et des contenus digitaux dans différentes langues. ',
    '- Proficient organizational skills, detail-oriented, multitasking, good under pressure' => '- Organisé, minutieux, polyvalent, excellente gestion du travail sous pression',
    '- Aggressive problem diagnosis and creative problem solving skills' => '- Diagnostic des problèmes et force de proposition dans leur résolution',
    '- Knowledge of Search Engine Optimization process' => '- Connaissances en optimisation du référencement des moteurs de recherche (SEO) ',
    'Send' => 'Envoyer',
    'You agree with our conditions terms' => 'Vous acceptez nos conditions générales',
    'Upload your CV ( only PDF files )' => 'Téléchargez votre CV (uniquement les fichiers PDF)',
    'How did you know about this job position?' => ' Comment avez-vous trouvé cette offre d\'emploi ? ',
    'Zip Code' => ' Code postal ',
    'City' => 'Ville',
    'Address Line 2' => ' Adresse (ligne 2) ',
    'Address Line 1' => ' Adresse (ligne 1) ',
    'Which position are you applying to' => ' Pour quel poste postulez-vous ? ',
    'Country' => 'Pays',
    'How do you prefer to be contacted?' => ' Préférences de contact ',
  ...
  'ShopThemeTerms' => 
  array (
    'ARTICLE 6: DELIVERY' => 'ARTICLE 6 : LIVRAISON',
    'The transfer of ownership of the product will only take place upon full payment of your order.' => 'Le transfert de propriété du produit n’aura lieu qu’au paiement complet de votre commande.',
    'You will receive an order confirmation email to the email address you provided when you created your customer account. Check the details and the amount of your order. Correct any errors in advance before making your payment.' => 'Vous recevrez un email de confirmation de commande sur l’adresse mail indiquée lors de la création de votre compte client. Vérifiez les détails et le montant de votre commande. Rectifiez au préalable les éventuelles erreurs avant d’effectuer votre paiement.',
    'To place an order on our site, choose your items and add them to the basket. Confirm the contents of your basket, choose your payment method and tick the box "acceptance of the T&Cs".' => 'Pour passer une commande sur notre site, choisissez vos articles et ajoutez-les au panier. Validez le contenu de votre panier, choisissez votre mode de paiement et cochez la case « acceptation des CGV ». ',
    'A reply will be sent to you within 48 hours of receiving your request.' => 'Un retour vous sera effectué sous 48h suite à la réception de votre demande. ',
    'You can order our products directly on our website if you have a customer account. If you do not have one, you can request one via the following link:' => 'Vous avez la possibilité de commander nos produits directement sur notre site internet si vous possédez un compte client. Si vous n’en possédez pas, vous pouvez en faire la demande via le lien suivant :',
    'ARTICLE 5: ORDERING' => 'ARTICLE 5 : COMMANDE',
    'If you have ordered a product that is unavailable after the validation of your order, you will be informed immediately. We will proceed with the cancellation of your order and you will be refunded immediately if payment for the order has already been made.' => 'Si vous avez commandé un produit indisponible postérieurement à la validation de votre commande, vous en serez immédiatement informé. Nous procéderons à l’annulation de votre commande et vous serez immédiatement remboursé si le paiement de la commande a déjà été effectué.',
    'The available products appear on our site accompanied by the mention "In stock". In order to best meet the expectations of our customers, the availability of our products is regularly updated.' => 'Les produits disponibles apparaissent sur notre site accompagnés de la mention « En stock ». Afin de répondre au mieux aux attentes de notre clientèle, la disponibilité de nos produits est régulièrement mise à jour.',
    'ARTICLE 4: AVAILABILITY OF PRODUCTS' => 'ARTICLE 4 : DISPONIBILITE DES PRODUITS',
    'The prices of the products present on the site www.all-stars-distribution.com are indicated in euros excluding taxes (HT).
            ...
            Delivery costs are not included in the prices displayed; they will be visible in a summary sent by email to the customer following the validation of his online order before making the payment.' => 'Les prix des produits présents sur le site www.all-stars-distribution.com sont indiqués en euros hors taxes (HT).
...
Les frais de livraison ne sont pas compris dans les prix affichés, ils seront visibles dans un récapitulatif envoyé par mail au client suite à la validation de sa commande en ligne avant d’en effectuer le paiement.',
    'ARTICLE 3: PRICE' => 'ARTICLE 3 : PRIX',
    'The customer declares to have read and accepted the general conditions of sale prior to the validation of their order.' => 'Le client déclare avoir pris connaissance et accepté les conditions générales de vente antérieurement à la validation de sa commande.',
    'The website www.all-stars-ditribution.com offers for sale spare parts, accessories and consumables for vehicles and cars. ALL STARS DISTRIBUTION is specialised in the sale of performance spare parts.' => 'Le site internet www.all-stars-ditribution.com propose à la vente des pièces détachées, des accessoires et des consommables pour véhicules et automobiles. ALL STARS DISTRIBUTION est spécialisée dans la vente de pièces détachées performance.',
    'ARTICLE 2: PRODUCTS' => 'ARTICLE 2 : PRODUITS',
    'is the property of :' => 'est la propriété de :',
    'The website' => 'Le site Internet',
    'ARTICLE 1: MANDATORY INFORMATION' => 'ARTICLE 1 : MENTIONS OBLIGATOIRES',
    'These general terms and conditions of sale apply, without restriction or reservation, to all sales concluded on the website' => 'Les présentes conditions générales de vente s’appliquent, sans restriction ni réserve, à toutes les ventes conclues sur le site Internet',
    'GENERAL CONDITIONS OF SALE' => 'CONDITIONS GENERALES DE VENTE',
    'Please note that payment by bank transfer will result in additional processing time for the dispatch of an order as it will only be dispatched once payment has been received in our bank account.' => 'Notez que le paiement par virement bancaire entraîne un délai de traitement supplémentaire pour l\'expédition d\'une commande puisqu\'elle ne se fera qu\'une fois le règlement réceptionné sur notre compte bancaire. ',
    'Payments by bank transfer must be made within 72 hours after the order has been confirmed. If the payment is not made within this period, your order will be automatically cancelled.' => 'Les paiements par virement bancaire doivent être effectués dans un délai de 72 heures après la validation de la commande. Si le paiement n\'est pas effectué dans ce délai, votre commande sera automatiquement annulée. ',
    'Once the payment by bank transfer has been selected on our website, you will receive a confirmation email with the details of our bank account, to which the payment must be made. Please note that these details must be exclusively in the name of ALL STARS DISTRIBUTION based in Portugal.' => 'Une fois le paiement par virement sélectionné sur notre site, vous recevrez un email de confirmation avec les coordonnées de notre compte bancaire, vers lequel le paiement doit être effectué. Notez que ces coordonnées doivent exclusivement être au nom de ALL STARS DISTRIBUTION et domiciliées au Portugal.',
    'BANK TRANSFER :' => 'VIREMENT BANCAIRE :',
    'The total amount paid will be debited immediately and the rest of the process and the order status will be updated instantly. A confirmation will then be sent to you by email as a digital archive.' => 'Le montant réglé, étant débité immédiatement pour son montant total, la suite du processus et l\'actualisation du statut de commande seront alors instantanés. Une confirmation vous sera alors envoyée par mail à titre d\'archive numérique.',
    'In order to validate the payment of an order, the name of the cardholder, its 16-digit number, its expiry date and its cryptogram will be requested by no other organisation other than our online payment service provider Ingenico and only they will have access to it.' => 'Afin de valider le règlement d\'une commande, le nom du titulaire de la carte, son numéro à 16 chiffres, sa date d’expiration ainsi que son cryptogramme seront demandés sans qu\'aucun organisme autre que notre prestataire de service de paiement en ligne Ingenico n\'y ait accès. ',
    'In the interest of security and confidentiality, all data communicated during the payment procedure is encrypted entered exclusively on the page of our financial partner Ingenico.' => 'Dans un souci de sécurité et de confidentialité, l\'intégralité des données communiquées lors de la procédure de paiement sont cryptées et renseignées exclusivement sur la page de notre partenaire financier Ingenico. ',
    'Visa and Mastercard are the bank cards accepted for the payment of an order on our online platform.' => 'Visa et Mastercard sont les cartes bancaires acceptées pour le paiement d’une commande sur notre plateforme en ligne.
',
    'BANK CARD :' => 'CARTE BANCAIRE : ',
    'We offer two methods of payment on our site:' => 'Nous proposons deux modes de règlement sur notre site : ',
    'ARTICLE 7: TERMS OF PAYMENT' => 'ARTICLE 7 : MODALITES DE PAIEMENT',
    'In case of a parcel lost, a claim will be opened with the carrier to carry out in-depth research that may take up to 3 weeks before receiving the confirmation of the parcel loss. Once the loss confirmed by the carrier, a new shipment will be automatically scheduled depending on stock level. No refund will be issued in any case of parcel loss.' => 'En cas de perte présumée d\'un colis, une réclamation sera ouverte auprès du transporteur pour effectuer des recherches approfondies. Ces recherches peuvent prendre jusqu\'à 3 semaines avant qu\'une confirmation de perte ne soit émise par la société de transport. Une fois la perte du colis confirmée, un nouvel envoi sera automatiquement programmé sous réserve des stocks disponibles. Il est important de souligner qu\'aucun remboursement ne sera effectué en cas de perte avérée d\'un colis.',
    'Any complaint must be communicated to our customer service by e-mail within 48 hours (business days) following order’s delivery date, beyond which no complaint will be accepted by the carrier. In all cases of complaints, original packaging must be kept.' => 'Toute réclamation devra nous être communiquée par e-mail dans les 48h (jours ouvrés) suivant la livraison du colis, au-delà desquelles aucune réclamation ne sera acceptée par le transporteur. Dans tous les cas de réclamation, l\'emballage d\'origine du colis devra être conservé.',
    'In case of any issues such as damaged packaging, missing or damaged products, reservations must be reported on the delivery slip to support any claim. It will also be necessary to provide pictures of the visible damages as well as the transport label showing tracking number and recipient\'s information. If this verification cannot be carried out directly with the driver, a written complaint must be sent to the carrier as soon as the damages are noted.' => 'En cas de problème tel qu\'un emballage abîmé, des produits manquants ou endommagés, des réserves devront obligatoirement être reportées sur le bordereau de livraison pour justifier de toute réclamation. Il sera également nécessaire de nous fournir des photos détaillées des dommages apparents ainsi que de l\'étiquette de transport indiquant le numéro de suivi du colis et les coordonnées du destinataire. Si cette vérification ne peut être faite en présence du livreur, une réclamation écrite devra être adressée au transporteur aussitôt le dommage constaté.',
    'We strongly recommend checking the packages condition directly with the driver during the delivery to ensure that there are no visible damages.' => 'Nous vous recommandons vivement de vérifier l\'état des colis en présence du livreur afin de vous assurer qu\'ils ne présentent aucun dommage visible.',
    'Orders are shipped from our European warehouses, provided with a specific tracking number that can be checked online at any moment through the carrier\'s website.' => 'Les commandessont expédiées depuis nos entrepôts européens, munies d\'un numéro de suivi spécifique permettant de les accompagner en temps réel via le site du transporteur.',
    'Parcels are entrusted to external service providers for their delivery (TNT, DPD, GLS, etc.). ALL STARS DISTRIBUTION cannot under any circumstances be held responsible for a dispute about the delivery of a package.' => 'Les colis sont confiés à des prestataires externes pour leur acheminement (TNT, DPD, GLS, ...). La société ALL STARS DISTRIBUTION ne pourra en aucun cas être tenue responsable d\'un litige lié à la livraison d\'un colis.',
    'Delivery times are given for information purposes only and may change due to various factors beyond our control.' => 'Les délais de livraison sont donnés à titre indicatif et peuvent évoluer en raison de différents facteurs indépendants de notre volonté.',
    'The amount of the delivery costs is calculated once your order is registered, according to the characteristics of the products purchased and the delivery address given. A confirmation email will be sent to you with the amount of the delivery costs to be expected for your order in order to proceed with the payment of the latter.' => 'Le montant des frais de livraison est calculé une fois que votre commande est enregistrée, en fonction des caractéristiques des produits achetés et l’adresse de livraison renseignée. Un email de confirmation vous sera envoyé avec le montant des frais de livraison à prévoir pour votre commande afin de procéder au paiement de cette dernière.',
    'We deliver worldwide with the carrier of our choice. The delivery takes place at the address indicated by the buyer at the time of the validation of the order.' => 'Nous effectuons nos livraisons dans le monde entier avec le transporteur de notre choix. La livraison a lieu à l’adresse indiquée par l’acheteur au moment de la validation de la commande. ',
    'This document was last updated on November 21, 2022' => 'This document was last updated on June , 2024',
    '- By e-mail to ' => '- Par mail à l’adresse',
    '- His personal space' => '- Son espace personnel',
    'In accordance with articles 39 and 40 of the law dated 6 January 1978, the customer has the right to access, rectify, delete and oppose his personal data. The customer can exercise this right via :' => 'En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, le client dispose d’un droit d’accès, de rectification, de suppression et d’opposition de ses données personnelles. Le client peut exercer ce droit via : ',
    'The site ensures that the customer\'s personal information is collected and processed in compliance with law n°78-17 of January 6, 1978 relating to information technology, files and freedom.' => 'Le site assure au client une collecte et un traitement d’informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés. ',
    'The commercial offers of the site will be sent to the customer by e-mail if no objection has been made. The customer may object at any time by logging into his personal space or by sending an email to our customer service department.' => 'Les offres commerciales du site seront adressées au client par mail si aucune opposition n’a été émise. Le client peut à tout moment s’y opposer en se connectant à son espace personnel ou en envoyant un email à notre service client. ',
    'Certain customer information will be passed on to delivery and / or payment service providers (i.e., surname, first name, address, postal code and telephone number) in order to allow the processing and delivery of the products ordered.' => 'Certaines informations relatives au client seront transmises aux prestataires de livraison et / ou paiement (à savoir le nom, prénom, adresse, code postal et numéro de téléphone) et ce, afin de permettre le traitement et la livraison des produits commandés.',
    'ARTICLE 11: PERSONAL DATA' => 'ARTICLE 11 : DONNEES A CARACTERE PERSONNEL',
    'If cancellation of the order is possible, we will refund the order via the payment method originally used by the buyer within 30 days.' => 'Si l’annulation de la commande est possible, nous effectuerons le remboursement de la commande via le mode de paiement initialement utilisé par l’acheteur dans un délai de 30 jours.',
    'Cancellation of an order is possible as long as the order has not been shipped from our warehouse. Any cancellation request made after the order has been shipped will not be accepted.' => 'L’annulation d’une commande est possible tant que cette dernière n’a pas été expédiée de nos entrepôts. Toute demande d’annulation faite postérieurement à l’expédition de la commande ne pourra aboutir. ',
    'ARTICLE 10: CONDITIONS AND DEADLINES FOR REIMBURSEMENT' => 'ARTICLE 10 : CONDITIONS ET DELAIS DE REMBOURSEMENT',
    'All sales made on our site are final, they cannot in any case give rise to the return of a product (except in the context of a guarantee, see article 8).' => 'Toutes les ventes réalisées sur notre site sont finales, elles ne peuvent en aucun cas donner lieu au retour d’un produit (sauf dans le cadre d’une garantie, voir article 8).',
    'ARTICLE 9: PRODUCT RETURNS' => 'ARTICLE 9 : RETOUR DU PRODUIT',
    'In no case will it be possible to request a refund for the product concerned from the company All Stars Distribution as part of a warranty claim.' => 'En aucun cas, il ne sera possible de demander un remboursement pour le produit concerné à la société All Stars Distribution dans le cadre d\'une demande de garantie.',
    'For any warranty claim which will require the sending of the product to our premises in order to verify it, All Stars Distribution will reimburse the buyer for the shipping costs of the product if the warranty coverage by the supplier is confirmed, otherwise all shipping costs will be borne by the latter.' => 'Pour toute demande de garantie qui nécessitera l\'envoi du produit dans nos locaux afin d\'en effectuer la vérification, All Stars Distribution remboursera à l\'acheteur les frais d\'envoi du produit si la prise en charge en garantie par le fournisseur se confirme, dans le cas contraire, tous les frais d\'expédition resteront à la charge de ce dernier. ',
    'Under no circumstances can a warranty claim be made due to a problem encountered with a product following a faulty installation. In this case, the buyer must contact the professional who installed the product in question.' => 'En aucun cas, une demande de garantie ne pourra être effectuée en raison d\'un problème rencontré avec un produit suite à un défaut d\'installation, l\'acheteur devra dans ce cas se rapprocher du professionnel ayant procédé au montage du produit en question. ',
    'All warranty claims must be sent by email to sales@all-stars-distribution.com together with photos or videos showing the problem. As the guarantee is taken over directly by the supplier, the shipping costs for sending and returning the product will be at the customer\'s expense, with the supplier only covering the costs of repairing or replacing the product concerned by the warranty. If the supplier finds that the problem encountered is not covered by the conditions of the guarantee, the shipping costs for the return of the product remain the responsibility of the customer.' => 'Pour toute demande de garantie, celle-ci devra être envoyée par email à l\'adresse sales@all-stars-distribution.com accompagnée de photos ou vidéos montrant le problème rencontré. La prise en charge de la garantie se faisant directement par le fournisseur, les frais de port pour l\'envoi et le retour du produit seront à la charge du client, le fournisseur ne couvrant que les frais de réparation ou de substitution du produit concerné par la garantie. Si le fournisseur constate que le problème rencontré n\'est pas couvert par les conditions de la garantie, les frais de port pour le retour du produit restent à la charge du client. ',
    'The company All Stars Distribution ensures the guarantee of the hidden defects under the legal conditions, the purchaser has a deadline of eight days from the discovery of the hidden defect to notify his reservations by email.' => 'La société All Stars Distribution assure la garantie des vices cachés dans les conditions légales, l\'acquéreur dispose d\'un délai de huit jours à compter de la découverte du vice caché pour notifier ses réserves par email. ',
    'ARTICLE 8: WARRANTY:' => 'ARTICLE 8 : GARANTIE',
    'Please also note that no items are reserved until payment for the order has been confirmed in our bank account.' => 'Veuillez également prendre en considération qu\'aucun article n\'est réservé avant la confirmation de réception du paiement de la commande sur notre compte bancaire.',
  ),
  'ShopThemePrivacy' => 
  array (
    'Table of contents' => 'Sommaire',
    'This Policy is a legally binding agreement between you (“User”, “you” or “your”) and All Stars Distribution Lda (“All Stars Distribution Lda”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.' => 'Cette politique est un accord juridiquement conclu entre vous ("Utilisateur", "vous") et All Stars Distribution Lda ("All Stars Distribution Lda ", "nous", "notre"). Si vous concluez cet accord au nom d\'une entreprise ou d\'une autre entité juridique, vous déclarez que vous avez le pouvoir de lier cette entité à cet accord, auquel cas les termes "Utilisateur", "vous" ou " votre " feront référence à une telle entité. Si vous ne disposez pas d\'une telle autorité, ou si vous n\'êtes pas d\'accord avec les termes de cet accord, vous ne devez pas accepter cet accord et ne pouvez pas accéder et utiliser le site Web et ses services. En accédant et en utilisant le site Web et ses services, vous reconnaissez avoir lu, compris et accepté d\'être lié par les termes de cette politique. Cette politique ne s\'applique pas aux pratiques des entreprises que nous ne possédons ni ne contrôlons pas, et aux personnes que nous n\'employons ni ne gérons pas.',
    'We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the all-stars-distribution.com website (“Website” or “Service”) and any of its related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.' => 'Nous respectons votre vie privée et nous nous engageons à la protéger en nous conformant à cette politique de confidentialité ("Politique"). Cette politique décrit les types d\'informations que nous pouvons collecter auprès de vous ou que vous pouvez fournir ("Informations personnelles") sur le site Web all-stars-distribution.com ("Site Web"), nos pratiques de collecte, d\'utilisation, de conservation, de protection et de divulgation de ces informations personnelles. Il décrit également les choix qui s\'offrent à vous concernant notre utilisation de vos informations personnelles et comment vous pouvez y accéder et les mettre à jour.',
    'Acceptance of this policy' => 'Acceptation de cette politique',
    'Changes and amendments' => 'Amendements',
    'Data breach' => 'Violation de données',
    'Information security' => 'Sécurité des informations',
    'Links to other resources' => 'Liens vers d’autres sites',
    'Email marketing' => 'Newsletters',
    'Social media features' => 'Fonctionnalités des réseaux sociaux',
    ...
    'Data protection rights under the GDPR' => 'Droits de protection des données en vertu du RGPD',
    'Transfer of information' => 'Transfert d’informations',
    'Retention of information' => 'Conservation des informations',
    'Disclosure of information' => 'Divulgation d’informations',
    'Managing information' => 'Gestion des informations',
    'Payment processing' => 'Traitement des paiements',
    'Use and processing of collected information' => 'Utilisation et traitement des informations collectées',
    'Privacy of children' => 'Confidentialité des mineurs',
    'Collection of personal information' => 'Recueil des données personnelles',
    'Contacting us' => 'Nous contacter',
    'Processing your Personal Information depends on how you interact with the Website and Services, where you are located in the world and if one of the following applies: (i) you have given your consent for one or more specific purposes; this, however, does not apply, whenever the processing of Personal Information is subject to European data protection law; (ii) provision of information is necessary for the performance of an agreement with you and/or for any pre-contractual obligations thereof; (iii) processing is necessary for compliance with a legal obligation to which you are subject; (iv) processing is related to a task that is carried out in the public interest or in the exercise of official authority vested in us; (v) processing is necessary for the purposes of the legitimate interests pursued by us or by a third party.' => 'Le traitement de vos informations personnelles dépend de la manière dont vous interagissez avec le site Web, de l\'endroit où vous vous trouvez dans le monde et si l\'une des conditions suivantes s\'applique : (i) vous avez donné votre consentement pour une ou plusieurs finalités spécifiques ; ceci, cependant, ne s\'applique pas, chaque fois que le traitement des informations personnelles est soumis à la législation européenne sur la protection des données ; (ii) la fourniture d\'informations est nécessaire à l\'exécution d\'un accord avec vous et/ou pour toute obligation précontractuelle de celui-ci ; (iii) le traitement est nécessaire au respect d\'une obligation légale à laquelle vous êtes soumis ; (iv) le traitement est lié à une tâche effectuée dans l\'intérêt public ou dans l\'exercice de l\'autorité publique dont nous sommes investis ; (v) le traitement est nécessaire pour servir nos intérêts légitimes ou ceux d’un tiers.',
    'Run and operate the Website and Services' => 'Exécuter et exploiter le site Web et ses services',
    'Respond to inquiries and offer support' => 'Répondre aux demandes de renseignements dans le cadre du service client',
    'Deliver products or services' => 'Livrer une commande',
    'Fulfill and manage orders' => 'Créer et gérer une commande',
    'Create and manage user accounts' => 'Créer et gérer un compte',
    'In order to make the Website and Services available to you, or to meet a legal obligation, we may need to collect and use certain Personal Information. If you do not provide the information that we request, we may not be able to provide you with the requested products or services. Any of the information we collect from you may be used for the following purposes:' => 'Afin de mettre le site Web et ses services à votre disposition, ou pour répondre à une obligation légale, nous pouvons être amenés à collecter et à utiliser certaines informations personnelles. Si vous ne fournissez pas les informations que nous demandons, nous pourrions ne pas être en mesure de vous fournir les produits ou services demandés. Toutes les informations que nous recueillons auprès de vous peuvent être utilisées dans les buts suivants :',
    'We act in the capacity of a data processor in situations when you submit Personal Information through the Website and Services. We do not own, control, or make decisions about the submitted Personal Information, and such Personal Information is processed only in accordance with your instructions. In such instances, the User providing Personal Information acts as a data controller in terms of the GDPR.' => 'Nous agissons en qualité de processeur des données dans le cas où vous soumettez des informations personnelles via le site Web et ses services. Nous ne possédons, ne contrôlons ni ne prenons de décisions concernant les informations personnelles soumises, et ces informations personnelles ne sont traitées que conformément à vos instructions. Dans ce cas, l\'utilisateur fournissant des informations personnelles agit en tant que responsable du traitement des données selon les obligations énoncées dans le RGPD.',
    'Our role may also differ depending on the specific situation involving Personal Information. We act in the capacity of a data controller when we ask you to submit your Personal Information that is necessary to ensure your access and use of the Website and Services. In such instances, we are a data controller because we determine the purposes and means of the processing of Personal Information and we comply with data controllers’ obligations set forth in the GDPR.' => 'Notre rôle peut également différer en fonction de la situation impliquant le traitement des informations personnelles. Nous agissons en qualité de contrôleur des données lorsque nous vous demandons de soumettre des informations personnelles nécessaires à garantir votre accès et votre utilisation du site Web et de ses services. Dans ce cas, nous sommes contrôleur des données car nous déterminons les finalités et moyens du traitement des informations personnelles et nous nous conformons aux obligations énoncées dans le RGPD.',
    'We act as a data controller and a data processor in terms of the GDPR when handling Personal Information, unless we have entered into a data processing agreement with you in which case you would be the data controller and we would be the data processor.' => 'Nous agissons en tant que contrôleur et processeur des données aux termes du RGPD lors du traitement des informations personnelles, sauf si nous avons conclu un accord de traitement de données avec vous, auquel cas vous seriez le contrôleur des données et nous serions le processeur des données.',
    'We encourage parents and legal guardians to monitor their children’s Internet usage and to help enforce this Policy by instructing their children never to provide Personal Information through the Website and Services without their permission. We also ask that all parents and legal guardians overseeing the care of children take the necessary precautions to ensure that their children are instructed to never give out Personal Information when online without their permission.' => 'Nous encourageons les parents et les tuteurs légaux à surveiller l’utilisation d’Internet par leurs enfants et à contribuer à l’application de cette politique en demandant à leurs enfants de ne jamais fournir d’informations personnelles via le site Web et les services sans leur autorisation. Nous demandons également à tous les parents et tuteurs légaux supervisant la garde des enfants de prendre les précautions nécessaires pour garantir que leurs enfants ont pour instruction de ne jamais divulguer d\'informations personnelles lorsqu\'ils sont en ligne sans leur autorisation.',
    'We do not knowingly collect any Personal Information from children under the age of 18. If you are under the age of 18, please do not submit any Personal Information through the Website and Services. If you have reason to believe that a child under the age of 18 has provided Personal Information to us through the Website and Services, please contact us to request that we delete that child’s Personal Information from our Services.' => 'Nous ne collectons aucune information personnelle d\'enfants de moins de 18 ans. Si vous avez moins de 18 ans, veuillez ne pas soumettre d\'informations personnelles via le site Web. Si vous avez des raisons de croire qu\'un enfant de moins de 18 ans nous a fourni des informations personnelles via le site Web, veuillez nous contacter pour nous demander de supprimer ces informations personnelles de nos services.',
    'You can choose not to provide us with your Personal Information, but then you may not be able to take advantage of some of the features on the Website. Users who are uncertain about what information is mandatory are welcome to contact us.' => 'Vous pouvez choisir de ne pas nous fournir vos informations personnelles, mais vous ne pourrez peut-être pas profiter de certaines des fonctionnalités du site Web. Les utilisateurs qui ne sont pas certains des informations obligatoires sont invités à nous contacter.',
    'Payment information (such as credit card details, bank details, etc)' => 'Informations de paiement (telles que les détails de la carte de crédit, les coordonnées bancaires, etc.)',
    'Basic personal information (such as name, country of residence, etc)' => 'Informations personnelles de base (telles que nom, pays de résidence, etc.)',
    'Contact information (such as email address, phone number, etc)' => 'Coordonnées (telles que l\'adresse e-mail, le numéro de téléphone, etc.)',
    'Account details (such as user name, unique user ID, password, etc)' => 'Détails du compte (tels que l\'identifiant, le mot de passe, etc.)',
    'We receive and store any information you knowingly provide to us when you create an account, make a purchase, or fill any forms on the Website. When required, this information may include the following:' => 'Nous recevons et stockons toutes les informations que vous nous fournissez lorsque vous créez un compte, effectuez un achat ou remplissez des formulaires sur le site Web. Lorsque requis, ces informations peuvent comprendre :',
    'You can access and use the Website and Services without telling us who you are or revealing any information by which someone could identify you as a specific, identifiable individual. If, however, you wish to use some of the features offered on the Website, you may be asked to provide certain Personal Information (for example, your name and e-mail address).' => 'Vous pouvez accéder et utiliser le site Web et ses services sans révéler votre identité ni aucune information permettant de vous identifier en tant qu\'individu. Si, toutefois, vous souhaitez utiliser certaines des fonctionnalités proposées sur le site Web, il peut vous être demandé de fournir certaines informations personnelles (par exemple, votre nom et votre adresse e-mail).',
    '(viii) You have the right to complain to a data protection authority about our collection and use of your Personal Information. If you are not satisfied with the outcome of your complaint directly with us, you have the right to lodge a complaint with your local data protection authority. For more information, please contact your local data protection authority in the EEA. This provision is applicable provided that your Personal Information is processed by automated means and that the processing is based on your consent, on a contract which you are part of, or on pre-contractual obligations thereof.' => '(viii) Vous avez le droit de porter plainte auprès d\'une autorité de protection des données concernant notre collecte et notre utilisation de vos informations personnelles. Si vous n\'êtes pas satisfait du résultat de votre plainte, vous avez le droit de déposer une plainte auprès de votre autorité locale de protection des données. Pour plus d\'informations, veuillez contacter votre autorité locale de protection des données dans l\'EEE. Cette disposition est applicable à condition que vos informations personnelles soient traitées par des moyens automatisés et que le traitement soit basé sur votre consentement, sur un contrat dont vous faites partie ou sur des obligations précontractuelles.',
    '(vii) You have the right to receive your Personal Information that you have provided to us in a structured, commonly used, and machine-readable format and, if technically feasible, to have it transmitted to another controller without any hindrance from us, provided that such transmission does not adversely affect the rights and freedoms of others.' => '(vii) Vous avez le droit de recevoir les informations personnelles que vous nous avez fournies et de les transmettre à une autre entité sans aucune entrave de notre part, à condition que cette transmission ne porte pas atteinte aux droits et libertés d\'autrui.',
    '(vi) You have the right, under certain circumstances, to obtain the erasure of your Personal Information from us. These circumstances include: the Personal Information is no longer necessary in relation to the purposes for which it was collected or otherwise processed; you withdraw consent to consent-based processing; you object to the processing under certain rules of applicable data protection law; the processing is for direct marketing purposes; and the personal data have been unlawfully processed. However, there are exclusions of the right to erasure such as where processing is necessary: for exercising the right of freedom of expression and information; for compliance with a legal obligation; or for the establishment, to exercise or defense of legal claims.' => '(vi) Vous avez le droit, dans certaines circonstances, d\'obtenir de notre part la suppression de vos informations personnelles. Ces circonstances incluent : les informations personnelles ne sont plus nécessaires pour les raisons pour lesquelles elles ont été collectées ou autrement traitées ; vous retirez votre consentement au traitement fondé sur le consentement ; vous vous opposez au traitement en vertu de certaines règles de la législation applicable en matière de protection des données ; le traitement est à des fins de marketing direct ; et les données personnelles ont été traitées illégalement. Cependant, il existe des exclusions du droit à la suppression, par exemple lorsque le traitement est nécessaire : pour l\'exercice du droit à la liberté d\'expression et d\'information ; pour le respect d\'une obligation légale ; ou pour la constatation, l\'exercice ou la défense de droits en justice.',
    '(v) You have the right, under certain circumstances, to restrict the processing of your Personal Information. These circumstances include: the accuracy of your Personal Information is contested by you and we must verify its accuracy; the processing is unlawful, but you oppose the erasure of your Personal Information and request the restriction of its use instead; we no longer need your Personal Information for the purposes of processing, but you require it to establish, exercise or defend your legal claims; you have objected to processing pending the verification of whether our legitimate grounds override your legitimate grounds. Where processing has been restricted, such Personal Information will be marked accordingly and, with the exception of storage, will be processed only with your consent or for the establishment, to exercise or defense of legal claims, for the protection of the rights of another natural, or legal person or for reasons of important public interest.' => '(v) Vous avez le droit, dans certaines circonstances, de restreindre le traitement de vos informations personnelles. Ces circonstances incluent : l\'exactitude de vos informations personnelles est contestée par vous et nous devons vérifier leur exactitude ; le traitement est illégal, mais vous vous opposez à l\'effacement de vos informations personnelles et demandez plutôt la restriction de leur utilisation ; nous n\'avons plus besoin de vos informations personnelles à des fins de traitement, mais vous en avez besoin pour établir, exercer ou défendre vos droits ; vous vous êtes opposé au traitement en attendant de vérifier si nos motifs légitimes prévalent sur vos motifs légitimes. Lorsque l’accès a été limité, ces informations personnelles seront identifiées en conséquence et, à l\'exception du stockage, ne seront traitées qu\'avec votre consentement ou pour l\'établissement, l\'exercice ou la défense de droits en justice, pour la protection des droits d\'une autre personne physique, ou une personne morale ou pour des raisons d\'intérêt public.',
    '(iv) You have the right to object to the processing of your information if the processing is carried out on a legal basis other than consent. Where Personal Information is processed for the public interest, in the exercise of an official authority vested in us, or for the purposes of the legitimate interests pursued by us, you may object to such processing by providing a ground related to your particular situation to justify the objection.' => '(iv) Vous avez le droit de vous opposer au traitement de vos informations si le traitement est effectué sur une base légale autre que le consentement. Lorsque des Informations Personnelles sont traitées dans l\'intérêt public, dans l\'exercice d\'une autorité publique dont nous sommes investis, vous pouvez vous opposer à ce traitement en fournissant un motif lié à votre situation particulière pour justifier l\'objection.',
    '(iii) You have the right to verify the accuracy of your information and ask for it to be updated or corrected. You also have the right to request us to complete the Personal Information you believe is incomplete.' => '(iii) Vous avez le droit de vérifier l\'exactitude de vos informations et de demander qu\'elles soient mises à jour ou corrigées. Vous avez également le droit de nous demander de compléter les informations personnelles que vous jugez incomplètes.',
    '(ii) You have the right to learn if your Personal Information is being processed by us, obtain disclosure regarding certain aspects of the processing, and obtain a copy of your Personal Information undergoing processing.' => '(ii) Vous avez le droit de savoir si vos informations personnelles sont traitées par nous, d\'obtenir des informations sur certains aspects du traitement et d\'obtenir une copie de vos informations personnelles en cours de traitement.',
    '(i) You have the right to withdraw consent where you have previously given your consent to the processing of your Personal Information. To the extent that the legal basis for our processing of your Personal Information is consent, you have the right to withdraw that consent at any time. Withdrawal will not affect the lawfulness of processing before the withdrawal.' => '(i) Vous avez le droit de retirer votre consentement si vous avez précédemment donné votre consentement au traitement de vos informations personnelles. Dans la mesure où la base juridique du traitement de vos informations personnelles est le consentement, vous avez le droit de retirer ce consentement à tout moment. Le retrait n\'affectera pas la légalité du traitement avant le retrait.',
    'If you are a resident of the European Economic Area (“EEA”), you have certain data protection rights and we aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Information. If you wish to be informed what Personal Information we hold about you and if you want it to be removed from our systems, please contact us. In certain circumstances, you have the following data protection rights:' => 'Si vous résidez dans l\'Espace économique européen (« EEE »), vous disposez de certains droits en matière de protection des données et nous nous efforçons de prendre des mesures raisonnables pour vous permettre de corriger, modifier, supprimer ou limiter l\'utilisation de vos informations personnelles. Si vous souhaitez être informé des informations personnelles que nous détenons à votre sujet et si vous souhaitez qu\'elles soient supprimées de nos systèmes, veuillez nous contacter. Dans certaines circonstances, vous disposez des droits suivants en matière de protection des données :',
    'Depending on your location, data transfers may involve transferring and storing your information in a country other than your own. However, this will not include countries outside the European Union and European Economic Area. If any such transfer takes place, you can find out more by checking the relevant sections of this Policy or inquire with us using the information provided in the contact section.' => 'Selon votre emplacement, les transferts de données peuvent impliquer le transfert et le stockage de vos informations dans un pays autre que le vôtre. Cependant, cela n\'inclura pas les pays en dehors de l\'Union européenne et de l\'Espace économique européen. Si un tel transfert a lieu, vous pouvez en savoir plus en consultant les sections pertinentes de la présente politique ou vous renseigner auprès de nous en utilisant les informations fournies dans la section « Nous contacter ».',
    'We may use any aggregated data derived from or incorporating your Personal Information after you update or delete it, but not in a manner that would identify you personally. Once the retention period expires, Personal Information shall be deleted. Therefore, the right to access, the right to erasure, the right to rectification, and the right to data portability cannot be enforced after the expiration of the retention period.' => 'Nous pouvons utiliser toutes les données dérivées de ou incorporant vos informations personnelles après que vous les ayez mises à jour ou supprimées, sans qu’elles permettent de vous identifier personnellement. Une fois la période de conservation expirée, les informations personnelles seront supprimées. Par conséquent, le droit d\'accès, le droit de suppression, le droit de rectification et le droit à la portabilité des données ne peuvent être exercés après l\'expiration de la période de conservation.',
    'We will retain and use your Personal Information for the period necessary as long as your user account remains active, to enforce our agreements, resolve disputes, and unless a longer retention period is required or permitted by law.' => 'Nous conserverons et utiliserons vos informations personnelles tant que votre compte client restera actif, à moins qu\'une période de conservation plus longue ne soit requise ou autorisée par la loi',
    'Service Providers are not authorized to use or disclose your information except as necessary to perform services on our behalf or comply with legal requirements. Service Providers are given the information they need only in order to perform their designated functions, and we do not authorize them to use or disclose any of the provided information for their own marketing or other purposes.' => 'Les prestataires de services ne sont pas autorisés à utiliser ou à divulguer vos informations personnelles, sauf si nécessaire pour effectuer des services en notre nom ou se conformer aux exigences légales. Ces derniers reçoivent uniquement les informations dont ils ont besoin pour exécuter leurs fonctions, et nous ne les autorisons pas à utiliser ou à divulguer les informations fournies',
    'Depending on the requested Services or as necessary to complete any transaction or provide any Service you have requested, we may share your information with our affiliates, contracted companies, and service providers (collectively, “Service Providers”) we rely upon to assist in the operation of the Website and Services available to you and whose privacy policies are consistent with ours or who agree to abide by our policies with respect to Personal Information. We will not share any personally identifiable information with third parties and will not share any information with unaffiliated third parties.' => 'En fonction des services demandés ou si nécessaire pour effectuer une transaction, nous pouvons partager vos informations avec nos sociétés partenaires, sur lesquelles nous comptons pour vous aider dans le fonctionnement du site Web et des services mis à votre disposition et dont les politiques de confidentialité sont conformes aux nôtres. Nous ne partagerons aucune information avec des tiers non affiliés.',
    'You are able to delete certain Personal Information we have about you. The Personal Information you can delete may change as the Website and Services change. When you delete Personal Information, however, we may maintain a copy of the unrevised Personal Information in our records for the duration necessary to comply with our obligations to our affiliates and partners, and for the purposes described below. If you would like to delete your Personal Information or permanently delete your account, you can do so on the settings page of your account on the Website or simply by contacting us.' => 'Vous pouvez supprimer certaines des informations personnelles que nous détenons à votre sujet. Les informations personnelles que vous pouvez supprimer peuvent changer à mesure que le site Web évolue. Cependant, lorsque vous supprimez des informations personnelles, nous pouvons en conserver une copie pendant la durée nécessaire à honorer nos obligations envers nos sociétés partenaires, et aux fins décrites ci-dessous. Si vous souhaitez supprimer vos informations personnelles ou supprimer définitivement votre compte, vous pouvez le faire via votre compte client directement sur le site Web ou simplement en nous contactant.',
    'Please note that the Payment Processors may collect some Personal Information from you, which allows them to process your payments (e.g., your email address, address, credit card details, and bank account number) and handle all the steps in the payment process through their systems, including data collection and data processing. The Payment Processors’ use of your Personal Information is governed by their respective privacy policies which may or may not contain privacy protections as protective as this Policy. We suggest that you review their respective privacy policies.' => 'Veuillez noter que le processeur de paiement peut collecter certaines informations personnelles auprès de vous (par exemple, votre adresse e-mail, votre adresse, les détails de votre carte de crédit) pour gérer toutes les étapes du processus de paiement via leur système informatique. L\'utilisation de vos informations personnelles par le processeur de paiement est régie par leur politique de confidentialité. Nous vous suggérons de consulter leur propre politique de confidentialité pour avoir plus d’informations à ce sujet.',
    'Payment Processors adhere to the latest security standards as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, MasterCard, American Express and Discover. Sensitive and private data exchange happens over a SSL secured communication channel and is encrypted and protected with digital signatures, and the Website and Services are also in compliance with strict vulnerability standards in order to create as secure of an environment as possible for Users. We will share payment data with the Payment Processors only to the extent necessary for the purposes of processing your payments, refunding such payments, and dealing with complaints and queries related to such payments and refunds.' => 'Le processeur de paiement adhère aux dernières normes de sécurité gérées par le Conseil des normes de sécurité PCI, qui est un groupe de marques telles que Visa, MasterCard, American Express et Discover. L\'échange de données sensibles et privées se fait via un canal de communication sécurisé SSL et est crypté et protégé par des signatures numériques. Le site Web est également conforme à des normes de sécurité strictes afin de créer un environnement aussi sécurisé que possible pour les utilisateurs. Le processeur de paiement utilise uniquement les données nécessaires au traitement de vos paiements, du remboursement de ces derniers et du traitement des requêtes liées à ces paiements et remboursements.',
    'In case of Services requiring payment, you may need to provide your credit card details or other payment account information, which will be used solely for processing payments. We use third-party payment processors (“Payment Processors”) to assist us in processing your payment information securely.' => 'En cas de services nécessitant un paiement, vous devrez peut-être fournir les détails de votre carte bancaire ou d\'autres informations qui seront utilisées uniquement pour le traitement du paiement. Nous utilisons un organisme de paiement tiers ("processeur de paiement") pour nous aider à traiter vos informations de paiement en toute sécurité.',
    'Note that under some legislations we may be allowed to process information until you object to such processing by opting out, without having to rely on consent or any other of the legal bases above. In any case, we will be happy to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Information is a statutory or contractual requirement, or a requirement necessary to enter into a contract.' => 'Notez qu\'en vertu de certaines législations, nous pouvons être autorisés à traiter des informations jusqu\'à ce que vous vous opposiez à ce traitement en vous désinscrivant, sans avoir à nous fier au consentement ou à toute autre base juridique ci-dessus. Dans tous les cas, nous serons heureux de clarifier la base juridique spécifique qui s\'applique au traitement, et notamment si la fourniture de données personnelles est une exigence légale ou contractuelle, ou une exigence nécessaire pour conclure un contrat.',
    'We rely on user’s consent as a legal base as defined in the GDPR upon which we collect and process your Personal Information.' => 'Nous nous appuyons sur le consentement de l\'utilisateur comme base juridique telle que définie dans le RGPD sur laquelle nous collectons et traitons vos informations personnelles.',
    'This document was last updated on August 25, 2022' => 'Ce document a été mis à jour pour la dernière fois le juin 2022',
    'We will attempt to resolve complaints and disputes and make every reasonable effort to honor your wish to exercise your rights as quickly as possible and in any event, within the timescales provided by applicable data protection laws.' => 'Nous nous efforcerons de répondre à votre demande dans les plus brefs délais et mettrons tous nos efforts pour honorer votre souhait d\'exercer vos droits, dans les délais prévus par les lois applicables en matière de protection des données.',
    'If you have any other questions, concerns, or complaints regarding this Policy, we encourage you to contact us using the details below:' => 'Si vous avez des questions concernant les informations que nous pouvons détenir à votre sujet ou si vous souhaitez exercer vos droits, vous pouvez soumettre votre demande en nous contactant à travers l’email suivante :',
    'You acknowledge that you have read this Policy and agree to all its terms and conditions. By accessing and using the Website and Services and submitting your information you agree to be bound by this Policy. If you do not agree to abide by the terms of this Policy, you are not authorized to access or use the Website and Services.' => 'Vous reconnaissez que vous avez lu cette politique et acceptez tous ses termes et conditions. En accédant et en utilisant le site Web et ses services et en soumettant vos informations, vous acceptez de vous soumettre à cette politique. Si vous n\'acceptez pas de respecter ses termes, vous n\'êtes pas autorisé à accéder ou à utiliser le site Web et ses services.',
    'An updated version of this Policy will be effective immediately upon the posting of the revised Policy unless otherwise specified. Your continued use of the Website and Services after the effective date of the revised Policy (or such other act specified at that time) will constitute your consent to those changes. However, we will not, without your consent, use your Personal Information in a manner materially different than what was stated at the time your Personal Information was collected.' => 'Une version mise à jour de cette politique entrera en vigueur immédiatement après la publication de la version révisée, sauf indication contraire. Votre utilisation continue du site Web et des services après la date d\'entrée en vigueur de la politique révisée (ou de tout autre acte spécifié à ce moment-là) constituera votre consentement à ces modifications. Cependant, nous n\'utiliserons pas, sans votre consentement, vos informations personnelles d\'une manière substantiellement différente de ce qui a été indiqué au moment où vos informations personnelles ont été collectées',
    'We reserve the right to modify this Policy or its terms related to the Website and Services at any time at our discretion. When we do, we will post a notification on the main page of the Website. We may also provide notice to you in other ways at our discretion, such as through the contact information you have provided.' => 'Nous nous réservons le droit de modifier cette politique ou les conditions relatives au site Web et à ses services selon nos besoins. Lorsque nous le ferons, vous en serez informé via les coordonnées que nous vous avez fournies.',
    'In the event we become aware that the security of the Website and Services has been compromised or Users’ Personal Information has been disclosed to unrelated third parties as a result of external activity, including, but not limited to, security attacks or fraud, we reserve the right to take reasonably appropriate measures, including, but not limited to, investigation and reporting, as well as notification to and cooperation with law enforcement authorities. In the event of a data breach, we will make reasonable efforts to notify affected individuals if we believe that there is a reasonable risk of harm to the User as a result of the breach or if notice is otherwise required by law. When we do, we will post a notice on the Website, send you an email.' => 'Si nous apprenons que la sécurité du site Web a été compromise ou que les informations personnelles des utilisateurs ont été divulguées à des tiers non affiliés, nous nous réservons le droit de prendre des mesures appropriées, y compris, mais sans s\'y limiter, des enquêtes et des rapports, ainsi que la notification et la coopération avec les autorités légales. En cas de violation de données, nous informerons les personnes concernées si nous estimons qu\'il existe un risque de préjudice pour l\'utilisateur à la suite de la violation ou si une notification est autrement requise par la loi.',
    'As the security of Personal Information depends in part on the security of the device you use to communicate with us and the security you use to protect your credentials, please take appropriate measures to protect this information.' => 'Étant donné que la sécurité des informations personnelles dépend en partie de la sécurité de l\'appareil que vous utilisez et de la sécurité dont vous faites preuve pour protéger vos informations d\'identification, veuillez prendre les mesures appropriées pour protéger au mieux ces informations.',
    'Therefore, while we strive to protect your Personal Information, you acknowledge that (i) there are security and privacy limitations of the Internet which are beyond our control; (ii) the security, integrity, and privacy of any and all information and data exchanged between you and the Website and Services cannot be guaranteed; and (iii) any such information and data may be viewed or tampered with in transit by a third party, despite best efforts.' => 'Par conséquent, alors que nous nous efforçons de protéger vos informations personnelles, vous reconnaissez que (i) il existe des limites de sécurité et de confidentialité d\'Internet qui échappent à notre contrôle ; (ii) la sécurité, l\'intégrité et la confidentialité de toutes les informations et données échangées entre vous et le site Web ne peuvent être garanties ; et (iii) ces informations et données peuvent être consultées ou altérées lorsqu’elles sont en transit vers un site tiers malgré tous nos efforts.',
    'We secure information you provide on computer servers in a controlled, secure environment, protected from unauthorized access, use, or disclosure. We maintain reasonable administrative, technical, and physical safeguards in an effort to protect against unauthorized access, use, modification, and disclosure of Personal Information in our control and custody. However, no data transmission over the Internet or wireless network can be guaranteed.' => 'Nous sécurisons les informations que vous fournissez sur des serveurs informatiques contrôlés, sécurisés et protégés contre tout accès, utilisation ou divulgation non autorisés. Nous maintenons des mesures de protection administratives et techniques pour nous protéger contre l\'accès, l\'utilisation, la modification et la divulgation non autorisés des données personnelles. Cependant, aucune transmission de données via Internet ou un réseau sans fil ne peut être garantie.',
    'The Website and Services contain links to other resources that are not owned or controlled by us. Please be aware that we are not responsible for the privacy practices of such other resources or third parties. We encourage you to be aware when you leave the Website and Services and to read the privacy statements of each and every resource that may collect Personal Information.' => 'Le site Web contient des liens vers d\'autres sites qui ne nous appartiennent pas et que nous ne contrôlons pas. Veuillez noter que nous ne sommes pas responsables des pratiques de confidentialité de ces sites tiers. Nous vous encourageons lorsque vous quittez le site Web à lire les déclarations de confidentialité de chaque site susceptible de collecter vos informations personnelles.',
    'In compliance with the CAN-SPAM Act, all e-mails sent from us will clearly state who the e-mail is from and provide clear information on how to contact the sender. You may choose to stop receiving our newsletter or marketing emails by following the unsubscribe instructions included in these emails or by contacting us. However, you will continue to receive essential transactional emails.' => 'Conformément à la loi CAN-SPAM, tous les e-mails que nous envoyons indiqueront clairement de qui provient l\'e-mail et fourniront des informations claires sur la manière de contacter l\'expéditeur. Vous pouvez choisir de ne plus recevoir nos newsletters en suivant les instructions de désabonnement incluses dans ces e-mails ou en nous contactant. Cependant, vous continuerez à recevoir les e-mails essentiels au traitement de vos commandes et gestion de compte client.',
    'We offer electronic newsletters to which you may voluntarily subscribe at any time. We are committed to keeping your e-mail address confidential and will not disclose your email address to any third parties except as allowed in the information use and processing section. We will maintain the information sent via e-mail in accordance with applicable laws and regulations.' => 'Nous proposons des newsletters électroniques auxquelles vous pouvez vous abonner à tout moment. Nous nous engageons à garder votre adresse e-mail confidentielle et à ne pas la divulguer à des tiers, sauf si vous en donnez l’autorisation. Nous conserverons les informations envoyées par e-mail conformément aux lois et réglementations applicables.',
    'Our Website and Services may include social media features, such as the Facebook and Twitter buttons, Share This buttons, etc (collectively, “Social Media Features”). These Social Media Features may collect your IP address, what page you are visiting on our Website and Services, and may set a cookie to enable Social Media Features to function properly. Social Media Features are hosted either by their respective providers or directly on our Website and Services. Your interactions with these Social Media Features are governed by the privacy policy of their respective providers.' => 'Notre site Web peut inclure certaines fonctionnalités de réseaux sociaux, telles que des liens vers Facebook et Instagram, des boutons de partage, etc. Ces fonctionnalités de réseaux sociaux peuvent collecter votre adresse IP, la page que vous visitez sur notre site Web, et peuvent définir un cookie pour leur permettre de fonctionner correctement. Les fonctionnalités des réseaux sociaux sont hébergées soit par leurs fournisseurs respectifs, soit directement sur notre site Web. Vos interactions avec ces fonctionnalités de réseaux sociaux sont régies par la politique de confidentialité de leurs fournisseurs respectifs.',
    'Some browsers incorporate a Do Not Track feature that signals to websites you visit that you do not want to have your online activity tracked. Tracking is not the same as using or collecting information in connection with a website. For these purposes, tracking refers to collecting personally identifiable information from consumers who use or visit a website or online service as they move across different websites over time. How browsers communicate the Do Not Track signal is not yet uniform. As a result, the Website and Services are not yet set up to interpret or respond to Do Not Track signals communicated by your browser. Even so, as described in more detail throughout this Policy, we limit our use and collection of your Personal Information.' => 'Certains navigateurs intègrent une fonction DO NOT TRACK qui signale aux sites Web que vous visitez que vous ne souhaitez pas que votre activité en ligne soit suivie. Le suivi n\'est pas la même chose que l\'utilisation ou la collecte d\'informations en relation avec un site Web. À ces fins, le suivi fait référence à la collecte d\'informations personnellement identifiables auprès des consommateurs qui utilisent ou visitent un site Web ou un service en ligne lorsqu\'ils se déplacent sur différents sites Web au fil du temps. La façon dont les navigateurs communiquent le signal Do Not Track n\'est pas encore uniforme. Par conséquent, le site Web et les services ne sont pas encore configurés pour interpréter ou répondre aux signaux Do Not Track communiqués par votre navigateur. Même ainsi, comme décrit plus en détail tout au long de cette politique, nous limitons notre utilisation et notre collecte de vos informations personnelles.',
    'Our Website and Services may use third-party analytics tools that use cookies, web beacons, or other similar information-gathering technologies to collect standard internet activity and usage information. The information gathered is used to compile statistical reports on User activity such as how often Users visit our Website and Services, what pages they visit and for how long, etc. We use the information obtained from these analytics tools to monitor the performance and improve our Website and Services. We do not use third-party analytics tools to track or to collect any personally identifiable information of our Users and we will not associate any information gathered from the statistical reports with any individual User.' => 'Notre site Web peut utiliser des outils d\'analyse tiers qui utilisent des cookies ou d\'autres technologies de collecte d\'informations similaires, pour collecter des informations standard sur l\'activité et l\'utilisation d\'Internet. Les informations recueillies sont utilisées pour compiler des rapports statistiques sur l\'activité des utilisateurs, tels que la fréquence à laquelle les utilisateurs visitent notre site Web, les pages qu\'ils visitent et pendant combien de temps, etc. Nous utilisons les informations obtenues à partir de ces outils d\'analyse pour surveiller les performances et améliorer notre Site Web. Nous n\'utilisons pas d\'outils d\'analyse tiers pour suivre ou collecter des informations personnellement identifiables sur nos utilisateurs et nous n\'associerons aucune information recueillie à partir des rapports statistiques à un utilisateur individuel.',
    'We may use cookies to collect, store, and track information for security and personalization, to operate the Website and Services, and for statistical purposes. Please note that you have the ability to accept or decline cookies. Most web browsers automatically accept cookies by default, but you can modify your browser settings to decline cookies if you prefer.' => 'Nous pouvons utiliser des cookies pour collecter, stocker et suivre des informations à des fins de sécurité et de personnalisation, pour exploiter le site Web et à des fins statistiques. Veuillez noter que vous avez la possibilité d’accepter ou de refuser les cookies. La plupart des navigateurs Web acceptent automatiquement les cookies par défaut, mais vous pouvez modifier les paramètres de votre navigateur pour refuser les cookies si vous préférez.',
    'Our Website and Services use “cookies” to help personalize your online experience. A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you, and can only be read by a web server in the domain that issued the cookie to you. If you choose to decline cookies, you may not be able to fully experience the features of the Website and Services.' => 'Notre site Web utilise des « cookies » pour vous aider dans votre expérience en ligne. Un cookie est un fichier texte placé sur votre disque dur par un serveur de pages Web. Les cookies ne peuvent pas être utilisés pour exécuter des programmes ou transmettre des virus à votre ordinateur. Les cookies vous sont attribués de manière unique et ne peuvent être lus que par un serveur Web du domaine qui vous a envoyé le cookie. Si vous choisissez de refuser les cookies, vous ne pourrez peut-être pas profiter pleinement des fonctionnalités du site Web.',
    'You must include sufficient details to allow us to properly understand the request and respond to it. We cannot respond to your request or provide you with Personal Information unless we first verify your identity or authority to make such a request and confirm that the Personal Information relates to you.' => 'Vous devez inclure suffisamment de détails pour nous permettre de bien comprendre la demande et d\'y répondre. Nous ne pouvons pas répondre à votre demande ou vous fournir des informations personnelles à moins que nous ne vérifiions d\'abord votre identité ou votre autorité pour faire une telle demande et confirmons que ces informations personnelles vous concernent.',
    'Any requests to exercise your rights can be directed to us through the contact details provided in this document. Please note that we may ask you to verify your identity before responding to such requests. Your request must provide sufficient information that allows us to verify that you are the person you are claiming to be or that you are the authorized representative of such person. If we receive your request from an authorized representative, we may request evidence that you have provided such an authorized representative with power of attorney or that the authorized representative otherwise has valid written authority to submit requests on your behalf.' => 'Toute demande d\'exercer vos droits peut nous être adressée via le contact fourni dans ce document. Veuillez noter que nous pouvons vous demander une vérification d’identité avant de répondre à une telle demande. Votre demande doit fournir suffisamment d\'informations nous permettant de vérifier que vous êtes la personne concernée par cette dernière ou que vous êtes son représentant légal. Si nous recevons cette demande par un représentant légal, nous pouvons exiger de fournir une procuration.',
    'This document was last updated on June, 2024' => 'Ce document a été mis à jour pour la dernière fois en juin 2024',
  ),
  'ShopThemeMenu' => 
  array (
    'Become a suplier' => 'Devenir Fournisseur',
    'Become a dealer' => 'Devenir Revendeur',
    'About Us' => 'Nous Connaitre',
    'Clearence' => 'DESTOCKAGE',
    'Catalogs' => 'RESSOURCES',
    'Brands' => 'Marques',
    'News' => 'Nouveautés',
  ...
  array (
    ...
    'Without stock' => 'Sans stock',
    'In stock' => 'En stock',
    'Limited stock, please contact us' => 'Stock limité, merci de nous contacter',
    'Canceled' => 'Annulé',
    'Shipped' => 'Expédié',
    'Backorder' => 'Commande différée',
    'In preparation' => 'En préparation',
    'Waiting payment' => 'En attente de paiement',
    'Waiting validation' => 'En validation',
    'Add a new address' => 'ajouter une nouvelle adresse',
    'No addresses are available.' => 'Aucune adresse n\'est disponible.',
    'Unavailable page!' => 'Page indisponible !',
    'Mail to' => 'Envoyer à',
    'Contacts' => 'Contacts',
    '(max 500 chars)' => '(max 500 caractères)',
...
Selon la Rec.30;Art.7(1)(c)',
  ...
  'ShopThemeCopyrights' => 
  array (
    '@ 2024 All Stars Distribution. All Rights Reserved.' => '@ 2024 All Stars Distribution. Tous les droits sont réservés.',
  ),
  'ShopThemeErrorsForm' => 
  array (
    'Please fill all required field!' => 'Veuillez remplir tous les champs obligatoires !',
    'error_message_6' => 'L\'URL saisie pour le champ \'Réseaux sociaux\' n\'est pas valide. Veuillez vérifier.',
    'error_message_5' => 'L\'URL saisie pour le champ \'Site\' n\'est pas valide. Veuillez vérifier.',
    'error_message_4' => 'L\'adresse e-mail saisie n\'est pas valide. Veuillez vérifier.',
    'error_message_3' => 'Vous devez sélectionner au moins un \'Marché principal\'.',
    'error_message_2' => 'Vous devez sélectionner au moins un \'Type d\'entreprise\'.',
    'error_message_1' => 'Vous devez remplir au moins l\'un des champs \'Site\' ou \'Réseaux sociaux\'.',
  ),
  'ShopThemeLegalNotice' => 
  array (
    'Copyright 2024 : All Stars Distribution - All Rights Reserved' => 'Copyright 2024 : All Stars Distribution - Tous Droits Réservés',
    'We do not share information about your use of our site with any third company.' => 'Aucune donnée collectée par ce biais ne seta partagées avec un tiers.',
    'This website uses cookies for optimal performance and to analyze our traffic.' => 'Pour assurer des performances optimales et analyser le trafic en ligne, ce site web utilise des cookies.',
    ...
    'Company:' => 'Société:',
    'PT / 513881387' => 'PT / 513881387',
    'VAT Number / License:' => 'Numero de TVA / SIRET : ',
  ),
  'ShopThemecatalog' => 
  array (
    'Updates' => 'Actualisation',
    'Website' => 'Website',
    'Facebook' => 'Facebook',
    'Logos' => 'Logos',
    'Pictures' => 'Photos',
    'Catalogue' => 'ressources',
    'Import File' => 'intégration',
    'Brand' => 'Marque',
    'Updated' => 'Actualisé',
  ),
  'ShopThemeCustomeraccount' => 
  array (
    'Export personal data' => 'Extraire',
    'Allows you to extract your personal data in a CSV document!.' => 'Vous permet d\'extraire vos données personnelles dans un fichier CSV!',
    'Portability of personal data' => 'Portabilité des données personnelles',
    'Remove Account' => 'Supprimer',
    'After the account has been removed you can not go back!.' => 'Une fois le compte supprimé, vous ne pouvez plus revenir en arrière !',
    'Remove account' => 'Supprimer le compte',
    'General Data Protection Regulation' => 'Protection des données',
    'Submit form' => 'Enregistrer',
    'Vat Number' => 'Numéro de TVA',
    'Company Name' => 'Société',
    'Your Company Information' => 'Entreprise',
    'Sign up for our newsletter!' => 'S\'inscrire à la newsletter ',
    ...
    'Last Name' => 'Nom',
    'First Name' => 'Prénom',
    'Please be sure to update your personal information if changed.' => 'Merci d\'actualiser vos informations si celles-ci ont changé',
    'Your Personal Information' => 'Informations personnelles',
    'Create new address' => 'Créer une nouvelle adresse',
    'Total purchases by brand (€)' => 'Montant commandé par marque (€)',
    'Total purchases per month' => 'Montant commandé par mois',
    ...
    'Waiting payment' => 'A Payer',
    'Waiting validation' => 'En validation',
    'Clean Filter' => 'Retirer filtre',
    'Not Invoiced' => 'Non facturé',
    'Partial Shipping' => 'Expédition partielle',
    'On Backorder' => 'En backorder',
    'Packing in progress' => 'Préparation en cours',
    'Awaiting payment' => 'En attente de paiement',
    'Awaiting confirmation' => 'En attente de validation',
    'Order ID' => 'Référence de la commande',
    'Tracking' => 'Suivi',
    'Carrier' => 'Transporteur',
    'Order history' => 'Historique des commandes',
    'Total Orders' => 'Total',
    'Rate per parcel up to 305cm girth ( 2 x H + 2 x B + 1 x L ) - Oversized applicable : 21.50 €' => 'Tarif par colis jusqu\'à 305 cm de circonférence (2xH + 2xL + 1L) - Applicable pour les colis volumineux : 21,50€',
    'destination' => 'PAYS DE LIVRAISON',
    'Euro shipping rates' => 'Tarifs d\'expédition',
  ...
  array (
    ...
    'Total:' => 'Total:',
    'Total shipping:' => 'Frais de port totaux :',
    'Total products:' => 'Total des produits :',
    'There is %product_count% item in your cart.' => 'Il y a %product_count% article dans votre panier.',
    'Select your payment method' => 'Sélectionnez un moyen de paiement',
    'Privacy policies' => 'Politique de confidentialité',
    'I declare that I have read and accept the privacy policies in force. To view the privacy policies, please click on:' => 'Je déclare que j\'ai lu et accepté la politique de confidentialité en vigueur. rnPour consulter la politique de confidentialité, cliquez sur:',
    'Use another address for invoice ?' => 'Livrer à une adresse différente?',
    'Contact us to update' => 'Contactez-nous pour actualiser vos informations',
    'Yes' => 'Oui',
    'No' => 'Non',
    'Public Administration' => 'Administration publique',
    'EPC address is required' => 'L\'adresse EPC est requise',
    'PEC address is not valid' => 'L\'adresse PEC n\'est pas valide',
    'PEC address' => 'Adresse PEC',
    'SDI code is required' => 'Le code SDI est requis',
    'SDI code is not valid' => 'Le code SDI n\'est pas valide',
    'SDI code' => 'Code SDI',
    'Private' => 'Privé',
    'Customer type' => 'Type de client',
    'VAT number is required' => 'Le numéro de TVA est requis',
    'VAT number is not valid' => 'Le numéro de TVA n\'est pas valide',
    'VAT number' => 'Numéro de TVA',
    'Identification number' => 'Numéro d\'identification',
    'Mobile phone is required' => 'Un téléphone portable est requis',
    'Mobile phone is not valid' => 'Le téléphone portable n\'est pas valide',
    'Mobile phone' => 'Téléphone mobile',
    'Privacy' => 'Confidentialité',
    'Conditions' => 'Conditions',
    'Phone is required' => 'Le numéro de téléphone est obligatoire',
    'Phone is not valid' => 'Le numéro de téléphone n\'est pas valide',
    'Phone' => 'Numéro de téléphone',
    'Country' => 'Pays',
    'Zip code is required' => 'Le code postal est obligatoire',
    'Zip code is not valid' => 'Le code postal n\'est pas valide',
    'Zip Code' => 'Code postal',
    'please choose' => 'Veuillez sélectionner un pays',
    'State' => 'État',
    'City is required' => 'La ville est obligatoire',
    'City is not valid' => 'La ville n\'est pas valide',
    'City' => 'Ville',
    'Other is required' => 'Un autre est requis',
    'Other is not valid' => 'L\'autre n\'est pas valide',
    'Additional information' => 'Informations Complémentaires',
    'Address Complement is required' => 'Le complément d\'adresse est obligatoire',
    'Address Complement is not valid' => 'Le complément d\'adresse n\'est pas valide',
    'Address Complement' => 'Complément d\'adresse',
    'Address is required' => 'Complément d\'adresse',
    'Address is not valid' => 'L\'adresse n\'est pas valide',
    'Address' => 'Adresse',
    'Company' => 'Société',
    'Last name is required' => 'Le nom est requis',
    'Last name is not valid' => 'le nom n\'est pas valide',
    'Last name' => 'Nom',
    'First name is required' => 'Le prénom est obligatoire',
    'First name is not valid' => 'Le prénom n\'est pas valide',
    'First name' => 'Prénom',
    'Alias is required' => 'L\'alias est requis',
    'Alias is not valid' => 'L\'alias n\'est pas valide',
    'Alias' => 'Alias',
    'I have read and accept the current terms, conditions and policies.' => 'J\'ai lu et j\'accepte les termes et conditions ganérales',
    'Deliver to a different address?
' => 'Livrer à une adresse différente?',
    'Billing address' => 'Coordonnées de facturation',
    'IMMEDIATE PROCESSING' => 'TRAITEMENT IMMEDIAT',
    'CREDIT CARD' => 'CARTE DE CREDIT',
    'PROCESSING UP TO 48H' => 'TRAITEMENT JUSQU\'A 48H',
    'BANK TRANSFER' => 'VIREMENT BANCAIRE',
    'VAT' => 'TVA',
    'Qty' => 'Quantité',
    'Product' => 'Produit',
    ...
    'Price' => 'Prix',
    'Pickup' => 'Pickup',
    'Pick up with your carrier' => 'Ramasse de la commande par votre transporteur',
    'Dropship' => 'Drop Shipping',
    'Deliver to a different address?' => 'Livrer à une adresse différente ?',
    'Stairs Nº' => 'Esc',
    'Floor Nº' => 'Etage',
    'Building' => 'Bât',
    'Door Nº' => 'Porte',
    'fees' => 'Frais',
    'No fees' => 'Sans frais',
    'Stairs number is not valid' => 'Le numéro d\'escalier n\'est pas valide',
    'Floor number is not valid' => 'L\'étage n\'est pas valide',
    'Building number is not valid' => 'Le numéro de bâtiment n\'est pas valide',
    'Door number is not valid' => 'Le numéro de porte n\'est pas valide',
    'Identification number is not valid' => '',
    'Identification number is required' => '',
    'Company is not valid' => 'La Société n\'est pas valide',
    'Total (Ex VAT)' => 'Total (HT)',
  ...
  array (
    ...
    'Name' => 'Nom',
    'My contact does not refer to any order' => 'Mon contact ne fait référence à aucune commande',
    'Order Reference' => 'Référence de commande',
    'Alias' => 'Alias',
    'Address' => 'Adresse',
    'Address Complement' => 'Complément d\'adresse',
  ...
  'ShopThemeStatistics' => 
  array (
    'You haven\'t made any purchases yet!' => 'Vous n\'avez pas encore effectué d\'achats !',
    'You haven\'t viewed any products yet!' => 'Vous n\'avez encore consulté aucun produit !',
    'Last viewed products' => 'Derniers produits consultés',
    'Average value per order' => 'Panier moyen',
    'Total orders amount' => 'Montant total commandé',
    'Number of orders' => 'Nombre de commandes',
    'My addresses' => 'Mes adresses',
    'Last purchase' => 'Dernier achat',
    'Default language' => 'Langue prédéfinie',
    'Client since' => 'Client depuis',
    'Company name' => 'Nom de la société',
    'Check Top 100' => 'Consulter Top 100',
    'Best seller products' => 'Produits les plus vendus',
    'Profile' => 'Profil',
    'Shipping Rates' => 'Frais d\'envoi',
    'Statistics' => 'Statistiques',
    'Dashboard' => 'Tableau de bord',
    'Orders history' => 'Historique des Commandes',
    'Most purchased products' => 'Produits les plus achetés',
    'Notifications' => 'Notifications',
    'Contact' => 'Contact',
    'Warranty' => 'Garantie',
    'Total purchases by brand (€)' => 'Total des achats par marque (€)',
    'Total purchases per month' => 'Total des achats par mois',
  ),
  'ShopThemeLinklist' => 
  array (
    'Payments' => 'Paiement',
  ...
  array (
    'View your order history' => 'Voir l\'historique de vos commandes',
    'Order reference:' => 'Référence de la commande:',
    'Once confirmed, an email will be sent within 48 hours with the total to be paid and a summary of the order. Please do not make the payment until you receive the email confirming the order.' => 'Votre commande a bien été enregistrée, un email vous sera envoyé dans les prochaines 48h quand cette dernière sera confirmée avec le récapitulatif de votre commande et le montant total à régler.',
    'Your order has been received.' => 'Votre commande a été reçue.',
    'Thank you for your purchase at' => 'Merci pour votre commande sur',
    'Thank you' => 'Merci',
    'Please do not make any payment before receiving and checking the order confirmation sent by our sales department.' => 'Attention, veuillez ne procéder à aucun paiement avant réception et contrôle de la validation de commande envoyée par notre service commercial.',
    'Please pay attention to any comments that may be present on the order confirmation (ETA, availability, modification, etc.).' => 'Veuillez prêter attention aux commentaires éventuellement présents sur la confirmation de commande (délai, disponibilité, modification, etc.).',
    'In the next few minutes, you will receive an order confirmation by email including the delivery costs to allow you to make your payment via the selected method.' => 'Dans les prochaines minutes, vous recevrez par mail une confirmation de commande incluant les frais de livraison afin de vous permettre d’effectuer votre paiement via la modalité sélectionnée.',
    'Registered' => 'ENREGISTREE',
    'Order' => 'COMMANDE',
  ),
  'ModulesEtsonepagecheckoutShippings' => 
  array (
    '(Tax excl.)' => '(hors taxes)',
  ),
  'ShopThemeModal' => 
  array (
    ...
    'Continue shopping' => 'Ajouter des produits',
    'Total' => 'Total',
    'Shipping' => 'Livraison',
    'VAT' => 'TVA',
    'ExVAT' => 'HT',
  ...
  array (
    ...
    'Cancel' => 'ANNULER',
    'here' => 'ici',
    'If necessary, you can contact our technical teams by clicking' => 'Vous pouvez, en cas de besoin, contacter nos équipes techniques en cliquant',
    'Click on "Cancel" to return to the main page.' => 'Cliquez sur "Annuler" pour revenir à la page principale. ',
    'Please enter the email associated with your customer account and click on "Reset" to receive a temporary link allowing you to reset your password.' => 'Veuillez saisir l\'adresse mail associée à votre compte client puis cliquez sur "Réinitialiser" pour recevoir un lien temporaire vous permettant de redéfinir votre mot de passe.',
