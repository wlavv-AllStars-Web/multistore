...
<div class="alert alert-info">
	{l s='You can define a model for meta, title and content of the catalog view for compatible products.' d='Shop.Theme.Admin'} {l s='Use the "SEO tags" (eg. {FILTER:5}) in your models to generate unique texts for each search.' d='Modules.Ukoocompat.Admin'}
</div>
