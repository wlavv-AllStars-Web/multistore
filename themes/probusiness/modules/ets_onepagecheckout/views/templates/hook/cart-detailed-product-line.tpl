        ...
        <div class="product-line-info">
          <a class="label" href="{$product.url}"
            ...
            {foreach from=$product.attributes key="attribute" item="value"}
              <div class="attribute {$attribute|lower}">
      ...
      <td class="cart_unit" data-title="Preço unitário">
        <div class="product-line-info product-price h5 desktop {if $product.has_discount}has-discount{/if}">
          ...
          <div class="current-price">
            <span class="price"><span class="text_mobile">{l s="Unit price" d="Shop.Theme.Checkout"}</span>{$product.price_with_reduction_without_tax|number_format:2:'.':' '} € </span>
        ...
        <div class="price desktop">
          <span class="product-price">
            <strong>
              ...
              {else}
                {* {$product.total} *}
                <span class="text_mobile">{l s="Total" d="Shop.Theme.Checkout"}</span>{($product.price_with_reduction_without_tax * $product.quantity)|number_format:2:'.':' '} €
              {/if}
            </strong>
          </span>
        </div>
