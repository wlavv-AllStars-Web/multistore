    ...
    {if $field_address}
        ...
        {foreach from=$field_address key='key' item='field'}
            ...
            {if $key=='firstname' && in_array('firstname',$ETS_OPC_ADDRESS_DISPLAY_FIELD)}
                <div class="form-group row firstname col-lg-6">
            ...
            {if $key=='lastname' && in_array('lastname',$ETS_OPC_ADDRESS_DISPLAY_FIELD)}
                <div class="form-group row lastname col-lg-6">
            ...
            {if $key=='company' && in_array('company',$ETS_OPC_ADDRESS_DISPLAY_FIELD)}
                <div class="form-group row {$address_type|escape:'html':'UTF-8'}_customer_type_invoice col-lg-6">
            ...
            {if $key=='other' && in_array('other',$ETS_OPC_ADDRESS_DISPLAY_FIELD)}
                <div class="form-group row  col-lg-12" {if $address_type|escape:'html':'UTF-8' == 'shipping_address'} style="display: none;" {/if}>
                    <label class="{if $opc_layout =='layout_3'}col-md-12{else}col-md-4{/if} form-control-label{if in_array('other',$ETS_OPC_ADDRESS_DISPLAY_FIELD_REQUIRED)} required{/if}"> {l s='Additional information' mod='ets_onepagecheckout'} </label>
                    <div class="{if $opc_layout =='layout_3'}col-md-12{else}col-md-8{/if} opc_field_right">
            ...
            {if $key=='state' && in_array('state',$ETS_OPC_ADDRESS_DISPLAY_FIELD)}
                <div class="form-group row address_state  col-lg-6" {if !$states} style="display:none"{/if}>
