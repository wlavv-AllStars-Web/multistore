      ...
      <div class="col-md-7 product-thumb" >
        <span class="product-image media-middle">
          {if $product.default_image}
              <img src="{$link->getImageLink($product.reference, $product.id_image, null, 'jpg', $product.id_product, $product.id_manufacturer, 'thumb')}" alt="{$product.name|escape:'quotes'}" loading="lazy" style="width:100px;">
          {else}
              <img src="{$link->getImageLink($product.reference, $product.id_image, null, 'jpg', $product.id_product, $product.id_manufacturer, 'thumb')}" loading="lazy" />
          {/if}
        </span>
      </div>
  </div>
