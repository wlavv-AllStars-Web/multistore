    ...
    <div class="hidden-sm-down">
        <table id="order-products" class="table table-bordered">
            ...
            <tfoot>
                ...
                <tr style="font-size: 18px;text-align: center;" class="line-{$order.totals.total.type|escape:'html':'UTF-8'}">
                    <td colspan="5" style="text-align: right;">{l s='Total taxes' d='Shop.Theme.Catalog'}</td>
                    <td>{number_format($order.totals.total_including_tax.amount - $order.totals.total_excluding_tax.amount, 2, '.', ',')} €</td>
                </tr>
                {/if}

                <tr style="font-size: 18px;text-align: center;" class="line-{$order.totals.total.type|escape:'html':'UTF-8'}">
                    <td colspan="5" style="text-align: right;">{l s='Total paid' d='Shop.Theme.Catalog'}</td>
