            ...
            {* <div class="swiper products-mobile">
              ...
              {foreach from=$accessories item="product_accessory" key="position"}
                {if $position < 4}
                  ...
                  {block name='product_miniature'}
                    {include file='catalog/_partials/miniatures/product.tpl' product=$product_accessory position=$position productClasses="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-3" complementary=true}
                  {/block}
                  </div>
                {/if}
              {/foreach}
