                    ...
                    <div class="tab-description" style="display: flex;justify-content:center;">
                      ...
                      {if !empty($product.youtube_code)}
                        <div class="column_video" style="width: 40%;display:flex;justify-content:center;align-items:center;">
                          ...
                          <img src="{if $product.cover.large.url}{$product.cover.large.url}{else}{$link->getImageLink($product.reference, $product.id_image, null, 'jpg', $product.id_product, $product.id_manufacturer, '600')}{/if}" style="width: 100%;max-height:318px;object-fit:cover;" loading="lazy"/>
