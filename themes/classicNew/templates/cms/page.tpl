     ...
     {block name='cms_content'}
       {if $cms.id == 52}
         ...
         <form class="form_specificRequest needs-validation" method="post" novalidate>
             ...
             <button 
             class="btn btn-submit-specific g-recaptcha"
             name="submitMessage"
             data-sitekey="6LePv_oqAAAAAJz5p1N-VGJBZNuC6ok9jw0z7CRj" 
             data-callback='onSubmit' 
             data-action='submit'>{l s='Submit' d='Shop.Forms.SpecificRequest'}</button>
           </form>
         </div>
         
       <script defer="defer">
         function onSubmit(token) {
             document.querySelector("form.form_specificRequest").submit();
           }
       </script>
