        ...
        <div class="order-line row">
          <div class="col-sm-2 col-xs-3">
            <span class="image">
              ...
              {else}
                <picture>
                  {if !empty($urls.no_picture_image.bySize.tm_large_default.sources.avif)}<source srcset="{$urls.no_picture_image.bySize.tm_large_default.sources.avif}" type="image/avif">{/if}
                  {if !empty($urls.no_picture_image.bySize.tm_large_default.sources.webp)}<source srcset="{$urls.no_picture_image.bySize.tm_large_default.sources.webp}" type="image/webp">{/if}
                  <img src="{$urls.no_picture_image.bySize.tm_large_default.url}" loading="lazy" />
                </picture>
              {/if}
            </span>
          </div>
