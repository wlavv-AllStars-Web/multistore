  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Addresses' d='Shop.Theme.Checkout'}
        <span class="step-edit step-to-addresses js-edit-addresses"><i class="material-icons edit" translate="no">mode_edit</i> {l s='edit' d='Shop.Theme.Actions'}</span>
      </h4>
    </div>
  </div>
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 class="h4">
          ...
          <span class="step-edit step-to-delivery js-edit-delivery"><i class="material-icons edit" translate="no">mode_edit</i> {l s='edit' d='Shop.Theme.Actions'}</span>
        </h4>
