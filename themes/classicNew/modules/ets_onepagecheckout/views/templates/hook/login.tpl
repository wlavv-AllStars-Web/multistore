...
{else}
    ...
    <div class="form-group type-checkout-option opc_hasaccount create sugguest" style="display:none;">
    ...
    <div id="customer-login" class="type-checkout-option login guest create">
        <div class="form-group type-checkout-option login" style="display:none;">
        ...
        {if $PS_GUEST_CHECKOUT_ENABLED}
            {if in_array('social_title',$ETS_OPC_GUEST_DISPLAY_FIELD)}
                <div class="form-group type-checkout-option social_title_field guest" style="display:none;">
            ...
            {if $opc_layout=='layout_2'}
                <div class="form-group type-checkout-option guest" style="display:none;">
        ...
        {if in_array('social_title',$ETS_OPC_CREATEACC_DISPLAY_FIELD)}
            <div class="form-group type-checkout-option social_title_field create" style="display:none;">
        ...
        {/if}
        {if $opc_layout=='layout_2'}
            <div class="form-group type-checkout-option create " style="display:none;">
                <div class="col-xs-12 col-sm-6">
                    <div class="row">
                        <label class="col-md-4 form-control-label required"> {l s='First name' mod='ets_onepagecheckout'}</label>
                        <div class="col-md-8 opc_field_right">
        ...
        {if Module::isEnabled('ps_dataprivacy') && in_array('customer_privacy',$ETS_OPC_CREATEACC_DISPLAY_FIELD)}
            <div class="form-group type-checkout-option create agree_field" style="display:none;">
                {if $opc_layout =='layout_2'}
                    <div class="col-md-4"></div>
                {/if}
        ...
        {if $ETS_OPC_CAPTCHA_ENABLED && ($ETS_OPC_LOGIN_CAPTCHA_ENABLED || $ETS_OPC_GUEST_CAPTCHA_ENABLED || $ETS_OPC_CREATEACC_CAPTCHA_ENABLED)}
            <div class="form-group type-checkout-option catpcha_field {if $ETS_OPC_LOGIN_CAPTCHA_ENABLED} login{/if}{if $ETS_OPC_GUEST_CAPTCHA_ENABLED} guest{/if}{if $ETS_OPC_CREATEACC_CAPTCHA_ENABLED} create{/if} " style="display:none;">
                {if $opc_layout =='layout_2'}
                    <div class="col-md-4"></div>
                {/if}
        ...
        {/if}
        <div class="type-checkout-option login opc_forgot_submit" style="display:none;">
            {if $opc_layout =='layout_2'}
                <div class="col-md-4"></div>
            {/if}
            <div class="{if $opc_layout =='layout_2'}col-md-8{else} col-xs-12 col-sm-12{/if}">
        ...
        {if $ETS_OPC_PAGE_ENABLED_SOCIAL && in_array('checkout_page',$ETS_OPC_PAGE_ENABLED_SOCIAL) && $list_socials }
            <div class="type-checkout-option login create" style="display:none;">
        ...
        {/if}
        <div class="form-group type-checkout-option opc_hasaccount login sugguest" style="display:none;">
