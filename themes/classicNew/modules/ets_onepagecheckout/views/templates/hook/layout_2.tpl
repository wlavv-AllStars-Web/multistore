        ...
        <div class="onepagecheckout-left col-lg-12">
            {* <div class="block-onepagecheckout block-customer ">
                <div class="title-heading">
                    ...
                    {l s='Your account' d='Shop.Theme.Checkout'}
                </div>
            ...
            <div class="block-onepagecheckout block-shopping-cart">
                ...
                {if $ETS_OPC_SHOW_SHIPPING}
                    <div class="alert alert-info buy_more_fee_shipping" style="display:none">
                        {l s='Add' d='Shop.Theme.Checkout'} <strong></strong> {l s='more to your order to get free shipping' d='Shop.Theme.Checkout'}
            ...
            {if $hookDisplayShopLicenseField}
                <div class="block-onepagecheckout block-shop-license-info">
                    <div class="title-heading">
                        ...
                        {l s='Shop(s) to install' d='Shop.Theme.Checkout'}
                    </div>
                    <div class="help-block">{l s='Please specify the shop domain(s) to install your purchased product(s)' d='Shop.Theme.Checkout'}</div>
                    <div class="block-content">
            ...
            {if $additional_info}
                <div class="block-onepagecheckout block-additional-info">
                    <div class="title-heading">
                        ...
                        {l s='Additional info' d='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
            ...
            {if $ETS_OPC_CART_COMMENT_ENABLED}
                <div class="block-onepagecheckout block-comment">
                    <div class="title-heading">
                        ...
                        {l s='Order comment' d='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
                        <div id="delivery">
                            <label id="label_delivery_message" style="cursor: pointer;">{l s='Would you like to add a comment about your order?' d='Shop.Theme.Checkout'}</label>
                        ...
                        <div class="gift-box">
                            {if Configuration::get('PS_RECYCLABLE_PACK')}
                                <span class="custom-checkbox">
                                        <label for="input_recyclable" class="ets_checkinput"> <input id="input_recyclable" name="recyclable" value="1" type="checkbox"{if $recyclable} checked="checked"{/if} /><i class="ets_checkbox"></i>{l s=' I would like to receive my order in recycled packaging.' d='Shop.Theme.Checkout'}</label>
                                    </span>
                            {/if}
            ...
            <div class="checkout card-block">
                <div class="text-center">
                    <button class="btn btn-primary" name="submitCompleteMyOrder"{if $isAvailable} disabled=""{/if}>{l s='Complete my order' d='Shop.Theme.Checkout'}</button>
                    {if $safe_icon}
            ...
            <div id="payment-confirmation" style="overflow:hidden;opacity:0;">
                <div class="ps-shown-by-js">
                    <button class="btn btn-primary center-block" type="submit"> {l s='Complete my order' d='Shop.Theme.Checkout'} </button>
                </div>
