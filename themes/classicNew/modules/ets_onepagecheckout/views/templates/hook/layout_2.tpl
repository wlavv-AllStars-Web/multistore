        ...
        <div class="onepagecheckout-left col-lg-12">
            <div class="block-onepagecheckout block-customer ">
                <div class="title-heading">
                    ...
                    {l s='Your account' mod='Shop.Theme.Checkout'}
                </div>
            ...
            <div class="block-onepagecheckout block-shopping-cart">
                <div class="title-heading">
                    ...
                    {l s='Shopping cart' mod='Shop.Theme.Checkout'}
                </div>
                {if $ETS_OPC_SHOW_SHIPPING}
                    <div class="alert alert-info buy_more_fee_shipping" style="display:none">
                        {l s='Add' mod='Shop.Theme.Checkout'} <strong></strong> {l s='more to your order to get free shipping' mod='Shop.Theme.Checkout'}
            ...
            <div class="block-onepagecheckout block-address">
                <div class="title-heading">
                    ...
                    {l s='Address' mod='Shop.Theme.Checkout'}
                </div>
            ...
            <div {if !$shipping_methods} style="display:none"{/if}>
                <div class="block-onepagecheckout block-shipping">
                    <div class="title-heading">
                        ...
                        {l s='Shipping method' mod='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
            ...
            <div class="" {if !$payment_methods} style="display:none"{/if}>
                <div class="block-onepagecheckout block-payment">
                    <div class="title-heading">
                        ...
                        {l s='Payment method' mod='Shop.Theme.Checkout'}
                    </div>
            ...
            {if $hookDisplayShopLicenseField}
                <div class="block-onepagecheckout block-shop-license-info">
                    <div class="title-heading">
                        ...
                        {l s='Shop(s) to install' mod='Shop.Theme.Checkout'}
                    </div>
                    <div class="help-block">{l s='Please specify the shop domain(s) to install your purchased product(s)' mod='Shop.Theme.Checkout'}</div>
                    <div class="block-content">
            ...
            {if $additional_info}
                <div class="block-onepagecheckout block-additional-info">
                    <div class="title-heading">
                        ...
                        {l s='Additional info' mod='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
            ...
            {if $ETS_OPC_CART_COMMENT_ENABLED}
                <div class="block-onepagecheckout block-comment">
                    <div class="title-heading">
                        ...
                        {l s='Order comment' mod='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
                        <div id="delivery">
                            <label id="label_delivery_message" style="cursor: pointer;">{l s='Would you like to add a comment about your order?' mod='Shop.Theme.Checkout'}</label>
            ...
            {if (Configuration::get('PS_GIFT_WRAPPING') || Configuration::get('PS_RECYCLABLE_PACK')) && !$is_virtual_cart }
                <div class="block-onepagecheckout block-gift">
                    <div class="title-heading">
                        ...
                        {l s='Gift wrapping' mod='Shop.Theme.Checkout'}
                    </div>
                    <div class="block-content">
                        <div class="gift-box">
                            {if Configuration::get('PS_RECYCLABLE_PACK')}
                                <span class="custom-checkbox">
                                        <label for="input_recyclable" class="ets_checkinput"> <input id="input_recyclable" name="recyclable" value="1" type="checkbox"{if $recyclable} checked="checked"{/if} /><i class="ets_checkbox"></i>{l s=' I would like to receive my order in recycled packaging.' mod='Shop.Theme.Checkout'}</label>
                                    </span>
                            {/if}
                            {if Configuration::get('PS_GIFT_WRAPPING')}
                                ...
                                <div id="gift"{if $gift} style="display:block"{else} style="display:none"{/if}>
                                    <label for="gift_message">{l s='If you\'d like, you can add a note to the gift:' mod='Shop.Theme.Checkout'}</label>
                        ...
                        <li>
                            ...
                            <div class="condition-label">
                                <label class="js-terms required" for="conditions_to_approve">
                                    {l s='I agree to the' mod='Shop.Theme.Checkout'} <a href="{$link->getCMSLink(43)}" id="cta-terms-and-conditions-0">{l s='terms and conditions' mod='Shop.Theme.Checkout'}</a> {l s='and will adhere to them unconditionally.' mod='Shop.Theme.Checkout'}
                                </label>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="checkout card-block">
                <div class="text-center">
                    <button class="btn btn-primary" name="submitCompleteMyOrder"{if $isAvailable} disabled=""{/if}>{l s='Complete my order' mod='Shop.Theme.Checkout'}</button>
                    {if $safe_icon}
            ...
            <div id="payment-confirmation" style="overflow:hidden;opacity:0;">
                <div class="ps-shown-by-js">
                    <button class="btn btn-primary center-block" type="submit"> {l s='Complete my order' mod='Shop.Theme.Checkout'} </button>
                </div>
