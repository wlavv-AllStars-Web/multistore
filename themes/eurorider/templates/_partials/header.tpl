...
<div class="header_content">
  {block name='header_nav'}
    <nav class="header-nav d-none d-lg-block"
      style="margin-bottom:0;background:linear-gradient(to bottom, #969696,#282828);">
      <div class="container-fluid">
        <div class="nav"
          style="display: flex;justify-content:space-between;width:100%;align-items:center;margin-top: -2px;">
          <div class="left-nav">
            <div style="display: flex;">
              ...
              {* <a title="Whatsapp" class="social-icon"
                ...
                onmouseout="this.style.color='#fff';this.style.background='unset'">
                <img src="https://www.all-stars-motorsport.com/img/whatsapp_search.png"
                  style="width: 24px; height: 24px;padding:3px;margin-left:1rem;" alt="Whatsapp">
          ...
          <div class="right-nav" style="display: flex;gap:1rem;align-items:center;">
            <a class="alma-options-header"
              href="{$link->getCMSLink(5)}">{l s='PAY IN 3 / 4 INSTALLMENTS BY CREDIT CARD - LEARN MORE' d='Shop.Theme.Homepage'}</a>
    ...
    <nav class="header-nav mobile" style="margin-bottom:0;background: #111111;height: 43px;">
      <div class="container-fluid">
        <div class="nav"
          style="display: flex;justify-content:space-between;width:100%;align-items:center;padding-top: 5px;">
          <div class="left-nav col-4 d-flex justify-content-start align-items-center">
            <i onclick="dropdownSearch()" class="fa-solid fa-magnifying-glass"
              style="cursor:pointer;padding-right: 12px;"></i>
  ...
  {block name='header_top'}
    <div class="menu-login-mobile">
      <form id="login-form" action="{$urls.pages.authentication}" method="post">
        ...
        <div class="form-group col">
          ...
          <input class="form-control whtbl" name="email" type="email" value="{$smarty.post.email}" required
        ...
        <div class="form-group col">
          ...
          <input class="form-control js-child-focus js-visible-password whtbl" name="password" type="password" value=""
            required placeholder="{l s="Password" d='Shop.Theme.Actions'}">
        </div>
        <div class="form-group col">
          <div>
      ...
      <div>
        <div class="form-group col">
          <input type="hidden" name="submitLogin" value="1">
          <a class="btn btn-secondary form-control-submit whtbl" href="{$urls.pages.register}"
            data-link-action="display-register-form" type="submit">
    ...
    <div class="header-top" style="background:  #282828;margin:0;">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12 col-lg-4 d-flex justify-content-sm-center justify-content-lg-start p-0"
            id="_desktop_logo">
          ...
          <div class="col-md-4 d-none d-lg-flex justify-content-end align-items-center"
            style="position: relative;z-index:1;padding-right: 3rem;">
            {hook h='displaySearch'}
      ...
      <div class="menu d-none d-lg-flex col-12 js-top-menu position-static hidden-sm-down d-desktop"
        ...
        <ul class="list-menu-desktop">
          ...
          <li class="dropdown-brands">
            ...
            <div class="dropdown-menu menu-logos" style="background: #333;border-bottom: 3px solid var(--asm-color)">
              ...
              <div class="brands-menu-title">
                <h1 style="color:#fff;text-align:center;font-weight:600;padding:1rem;">
                  {l s="Select a Vehicle" d="Shop.Theme.Header"}</h1>
              </div>
          ...
          <li class="dropdown brands-drop">
            <a class="dropdown-toggle-brands" role="button" data-toggle="dropdown"
              ...
              {foreach from=$manufacturers item=$manufacturer }
                <li class="col-lg-3">
                  <a
                    ...
                    {* {$manufacturer.name} *}
                      <img src="/img/eurorider/brands/brand_{$manufacturer.id_manufacturer}_2.png" alt="logo-{$manufacturer.name}"/>
                  </a>
                </li>
              {/foreach}
            </ul>
      ...
      <div class="d-mobile mobile-menu">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark"
          style="width: 100%;background-color: #333 !important;padding:0;">
          ...
          <div id="mySidenav" class="sidenav">
            <ul class="navbar-nav mr-auto">
              ...
              <div class="offcanvas-header"
                style="display: flex;justify-content: space-around;align-items: center;margin-bottom: 2rem;">
                <img class="logo img-responsive" src="{$shop.logo}" style="max-width: 180px;
              padding: 0px;
              margin: 20px 45px;">
                  ...
                  <div class="section menu-select-car">
                    <div class="menu-select-car-container">
                      ...
                      <div class="menu-select-car-content">
                        ...
                        <button id="search-button-car" type="submit" name="" class="button btn btn-default button-medium"
                          disabled="disabled">
                                ...
                                success: function(data) {
                                  ...
                                  if (data.length > 0) {
                                    ...
                                    $.each(data, function(index, item) {
                                        ...
                                        selectElement.append('<option value="' + item.id_brand + '">' + item.name +
                                          '</option>');
                                        }else if(placeholder == "{l s='Model' d='Shop.Theme.Homepage'}") {
                                        selectElement.append('<option value="' + item.id_model + '">' + item.name +
                                          '</option>');
                                        }else if(placeholder == "{l s='Type' d='Shop.Theme.Homepage'}") {
                                        selectElement.append('<option value="' + item.id_type + '">' + item.name +
                                          '</option>');
                                        }else if(placeholder == "{l s='Version' d='Shop.Theme.Homepage'}") {
                                        selectElement.append('<option value="' + item.id_version + '">' + item
                                          .name + '</option>');
              ...
              <li class="dropdown brands-drop">
                <div class="btn" type="button" data-toggle="dropdown" aria-expanded="false">
                  {l s='Brands' d='Shop.Theme.Homepage'}</div>
                  ...
                  {foreach from=$manufacturers item=$manufacturer }
                    <li class="col-xs-6 col-sm-4 col-md-4 col-lg-3">
                      <a class="dropdown-item"
                        href="/{$currentLanguage->iso_code }/brand/{$manufacturer.id_manufacturer}-{$manufacturer.link_rewrite}">
                        {* {$manufacturer.name} *}
                        <img alt="{$manufacturer.name}" style="width: 100%;max-width:300px;height:auto;" width="300"
                          height="150" src="/img/m/{$manufacturer.id_manufacturer}-small_default.jpg" loading="lazy">
                      </a>
                    </li>
                  {/foreach}
                </ul>
              ...
              <li class="nav-item"><a
                  href="{$link->getPageLink('contact', true)}">{l s='Contact' d='Shop.Theme.Homepage'}</a></li>
            </ul>
          </div>
        </nav>
      </div>
...
<style>
  @media screen and (min-width: 768px) and (max-width: 1500px) {
    ...
    .versions_cars .model_group_cars .swiper-button-prev,
    .versions_cars .model_group_cars .swiper-button-next {
      top: 50%;
