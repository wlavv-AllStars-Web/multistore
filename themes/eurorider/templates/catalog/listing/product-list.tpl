    ...
    <div class="description_box" style="display:flex;align-items:center;">
      ...
      {if !empty($manufacturer.short_description)}
        ...
        {if strlen($manufacturer.short_description) > 550}
          <div id="manufacturer-short_description" class="text_description hiddenTextDescription" style="font-size:15px;line-height:22px;font-weight:500;padding:1rem 3rem 0 3rem;margin:0 !important;text-align:center;">
