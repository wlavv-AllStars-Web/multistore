...
<div id="js-product-list">
  ...
  {if $cars_products_page}
    {if $compat}
      ...
      <div style="display:flex;flex-direction:column;align-items:center;height:100%;border-radius:.25rem;padding:1rem;width:100%;justify-content:center;border: 2px solid var(--asm-color)">
