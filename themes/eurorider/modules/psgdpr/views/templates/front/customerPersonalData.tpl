...
<div class="container">
    <section class="page_content">
        <div class="col-xs-12 psgdprinfo17">
            ...
            <div class="container-btns-psgdprinfo17">
                <a id="exportDataToCsv" class="btn btn-secondary psgdprgetdatabtn17" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO CSV' mod='psgdpr'}</a>
                <a id="exportDataToPdf" class="btn btn-secondary psgdprgetdatabtn17" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO PDF' mod='psgdpr'}</a>
            </div>
        </div>
        <div class="col-xs-12 psgdprinfo17">
