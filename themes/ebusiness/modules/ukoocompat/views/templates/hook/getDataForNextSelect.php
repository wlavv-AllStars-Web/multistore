...
$sql = "SELECT "._DB_PREFIX_."ukoocompat_criterion_lang.id_ukoocompat_criterion, "._DB_PREFIX_."ukoocompat_criterion_lang.value 
        FROM "._DB_PREFIX_."ukoocompat_criterion 
        INNER JOIN "._DB_PREFIX_."ukoocompat_criterion_lang
        ON "._DB_PREFIX_."ukoocompat_criterion_lang.id_ukoocompat_criterion = "._DB_PREFIX_."ukoocompat_criterion.id_ukoocompat_criterion 
        WHERE id_ukoocompat_filter = " .  $nextSelect . " AND id_lang=" . $id_lang . " AND id_parent_item=" . $id_parent_item . " GROUP BY id_ukoocompat_criterion ORDER BY "._DB_PREFIX_."ukoocompat_criterion_lang.value";
