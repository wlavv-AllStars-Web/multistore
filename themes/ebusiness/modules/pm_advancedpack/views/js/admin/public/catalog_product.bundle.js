...
;// CONCATENATED MODULE: ./pages/product/bundle-form-handler.js
/**
 *
 * Advanced Pack
 *
...
/* harmony default export */ const bundle_form_handler = (BundleFormHandler);

;// CONCATENATED MODULE: ./pages/product/index.js
/**
 *
 * Advanced Pack
 *
...
const {$: product_$} = window;

product_$(() => {
  new bundle_form_handler();
});
