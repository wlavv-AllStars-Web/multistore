{if $universals}
    ...
    {if !$noMoreProducts}
        ...
        document.addEventListener("DOMContentLoaded", updateLastProductId);
          ...
          if (document.querySelector(".noMoreProducts").getAttribute('list_complete') != 'true' && !isFetching && (window.innerHeight + window.scrollY) >= document.documentElement.scrollHeight - 105) {
              isFetching = true;
