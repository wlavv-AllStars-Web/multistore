...
{* <div class="product-line-grid"> *}
  ...
  {if $product.quantity_available <= 0}
    <div class="order-availability zero-stock">
      <div>10-14 days</div>
      <div title="This product is currently out of stock or requires a specific order. Please check ETA mentioned as working days to know approximative shipping date for this item."><i class="fas fa-search"></i></div>
    </div>
  {elseif $product.quantity_available < 3}
    <div class="order-availability low-stock">
      <div>Last Items Available</div>
      <div><i class="fas fa-search"></i></div>
    </div>
  {else}
    <div class="order-availability stock">
      <div>In Stock</div>
      <div title="This product is in stock in our warehouses and will ship the same day if ordered before 12:30 or next weekday if ordered later"><i class="fas fa-search"></i></div>
    </div>
  {/if}
  </div>
{* <pre>{print_r($product,1)}</pre> *}
{* {$cart.product.quantity} *}
  ...
  <div class="product-line-grid-right product-line-actions col-md-3 col-xs-12 pt-2">
