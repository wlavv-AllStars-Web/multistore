...
{block name='js_content'}
  ...
  document.querySelector("#cars-products .pagination").addEventListener("click", function(e) {
      if (e.target && (e.target.matches(".js-search-link") || e.target.matches(".next.js-search-link") || e.target.matches(".previous.js-search-link") || e.target.matches(".next.js-search-link i") || e.target.matches(".previous.js-search-link i"))) {
