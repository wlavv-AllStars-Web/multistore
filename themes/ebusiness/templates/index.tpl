...
{extends file='page.tpl'}
    ...
    {block name='page_content_container'}
      ...
      @media screen and (max-width:768px) {
        .card-yourcar {
          background: url("/img/asm/homepage/yourcar_{$language.iso_code}.webp?t=1597494218");
          background-position: center;
          background-size: cover;
        }
        .card-news {
          background: url("/img/asm/homepage/news_{$language.iso_code}.webp?t=1521401943");
          background-position: center;
          background-size: cover;
        }
        .card-brands {
          background: url("/img/asm/homepage/brands_{$language.iso_code}.webp?t=1849194914");
          background-position: center;
          background-size: cover;
        }

        .card-wheels {
          background: url("/img/asm/homepage/wheels_{$language.iso_code}.webp?t=1743148996");
          background-position: center;
          background-size: cover;
        }
      }
