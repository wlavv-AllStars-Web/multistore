...
class OrderDetailCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'product_quantity_sent' => ['type' => self::TYPE_INT, 'validate' => 'isInt'],
    ...
    protected function updateProductQuantityInStock($product, $orderStateId): void
    {
        ...
        }else if($this->context->shop->id == 2 ||  $this->context->shop->id == 1 || $this->context->shop->id == 6){
            $dismissOrderStateIds = Configuration::getMultiple([
                'PS_OS_CANCELED',
                'PS_OS_ERROR',
                'PS_OS_BANKWIRE'
