...
class FrontControllerCore extends Controller
{
    ...
    public function postProcess()
    {
        ...
        if(Tools::getValue('getdataBrands')){
            ...
            // if(Tools::getValue('getdataBrandsMobile')){
            //     // pre($decodedJson);
            //     $paulo = 'paulo';
            //     header('Content-Type: application/json');
            //     echo json_encode($paulo);
            //     exit;
            // }
            ...
            if(Tools::getValue('type') == 'brand') {
                ...
                foreach ($decodedJson['data'] as $key => $brand) {
                    $html_brands .= '<li class="swiper-slide brand_'.$brand['id_brand'].'" style="background:transparent;flex:unset;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:1rem;aspect-ratio: 1;" onclick="openModels(this,'.$brand['id_brand'].')">
