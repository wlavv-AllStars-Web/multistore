...
abstract class ProductListingFrontControllerCore extends ProductPresentingFrontController
{
    ...
    protected function getProductSearchVariables()
    {
        ...
        // pre($pagination);
            ...
            // euro-rider
        }elseif($this->context->shop->id == 6 && $query->getQueryType() == 'new-products' || $this->context->shop->id == 6 && $query->getQueryType() == 'category' || $this->context->shop->id == 6 && $query->getQueryType() == 'manufacturer'|| $this->context->shop->id == 6 && (Tools::getValue('id_compat') !== 'undefined' && Tools::getValue('id_compat') > 0)){
