...
class MyCarsControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        ...
        if(Tools::getValue('deleteCarGarage')){
            ...
            $url = 'https://webtools.'.$_SERVER['SERVER_NAME'].'/api/remove/car/'.$id_customer.'/'.$id_compat.'/'.$shop_id.'/'.$key;
            // pre($url);
        ...
        $url = 'https://webtools.'.$_SERVER['SERVER_NAME'].'/api/get/cars/'.$id_customer.'/'.$shop_id.'/'.$key;
        // pre($url);
