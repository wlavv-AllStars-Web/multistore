                    ...
                    foreach($data->data AS $dataSpecs){
                        foreach($dataSpecs->wheels AS $wheels){
                            if($wheels->rear->rim == null){
                                ...
                                $html .='<tr style="background: #fff;color: #000;text-align: center;border-bottom: 1px solid #666;" onclick="setFilterFromSelector(\'15:' . $boltPattern . '|17:' . $rimDiameter . '\')">';
                                    ...
                                    $html .='<td style="text-align: center;padding: .5rem 0;"><i style="color: var(--asm-color);padding: 4px;cursor: pointer;font-size: 1.5rem;" class="fa-solid fa-circle-chevron-right" onclick="setFilterFromSelector(\'15:' . $boltPattern . '|17:' . $rimDiameter . '\')"></i></td>';
                                $html .='</tr>';                            
                            }else{
                                ...
                                $html .='<tr style="background: #fff;color: #000;text-align: center;" onclick="setFilterFromSelector(\'15:' . $boltPattern . '|17:' . $rimDiameter . '\')">';
