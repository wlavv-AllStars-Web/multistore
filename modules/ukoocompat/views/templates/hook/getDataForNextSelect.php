...
$sql = "SELECT "._DB_PREFIX_."ukoocompat_criterion_lang.id_ukoocompat_criterion, "._DB_PREFIX_."ukoocompat_criterion_lang.value
        ...
        WHERE id_ukoocompat_filter = " .  $nextSelect . " AND id_lang=2 AND id_parent_item=" . $id_parent_item . " GROUP BY id_ukoocompat_criterion ORDER BY "._DB_PREFIX_."ukoocompat_criterion_lang.value";
