...
function insert_data_into_ps_ukoocompat_compat_asm( $id_ukoocompat_criterion_1, $id_ukoocompat_criterion_2, $id_ukoocompat_criterion_3, $id_ukoocompat_criterion_4) {
    insert_data("INSERT INTO "._DB_PREFIX_."ukoocompat_compat_asm (id_filter_value_1, id_filter_value_2, id_filter_value_3, id_filter_value_4) VALUES ('".$id_ukoocompat_criterion_1."','".$id_ukoocompat_criterion_2."','".$id_ukoocompat_criterion_3."','".$id_ukoocompat_criterion_4. "')");
}
