...
class Ps_WirepaymentValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $status = ( $this->context->shop->id == 3 ) ? 24 : Configuration::get('PS_OS_BANKWIRE');

        $this->module->validateOrder($cart->id, (int) $status, $total, $this->module->displayName, null, $mailVars, (int) $currency->id, false, $customer->secure_key);
