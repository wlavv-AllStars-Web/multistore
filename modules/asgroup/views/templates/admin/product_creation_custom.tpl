        ...
        <div class="col-lg-9 bg-creation-container br25">
            ...
            <div class="form-group">
                <h3>
                    Related Documents
                    <span class="help-box" data-toggle="popover" data-trigger="hover" data-html="true"
                        data-content="Attach manuals, guides, or PDF specs here." data-placement="top"></span>
                </h3>
                <p class="subtitle">These documents will appear below the product description.</p>

                <div class="small font-secondary">
                    <a target="_blank" href="/admineuromus1/index.php/sell/attachments/?_token={$token}"
                ...
                <div id="product_details_attachments">
                    <div class="form-group">
                        <div id="product_details_attachments_attached_files"
                            ...
                            <div id="product_details_attachments_2_attached_files_list" class="entities-list-container"
                                style="display: none;">
                                <div class="row">
                                    <div class="col-sm">
                                        <table class="table">
