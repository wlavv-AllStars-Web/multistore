    ...
    public function uninstall()
{
    ...
    public function hookActionAdminControllerSetMedia()
    {
        ...
        if (Tools::getValue('controller') === 'AdminProducts') {
            $this->context->controller->addJS($this->_path . 'views/js/duplicate-modal-override.js?v=' . time());
        }
    }
...
public function getASGProductCreation($product) {
    ...
    $relatedProducts = Db::getInstance()->executeS("
        ...
        AND pl.id_lang = ".(int)$id_lang." AND pl.id_shop = ".(int)$this->context->shop->id."
...
public function buildSpecificPriceTable($productId)
{
    ...
    public function getCompats($product_id) {
        ...
        $urlCompats = 'https://webtools.all-stars-motorsport.com/api/get/product/compats/'. $product_id .'/'.$storeId.'/'.$keyFront;
