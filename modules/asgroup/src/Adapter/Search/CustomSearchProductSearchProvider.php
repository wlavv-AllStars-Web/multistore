...
namespace PrestaShop\Module\AsGroup\Adapter\Search;
 ...
 */
class CustomSearchProductSearchProvider implements ProductSearchProviderInterface
{
    /**
    ...
    public function runQuery(
        ...
        if($query->getCompatsProducts()){

            $products = $query->getCompatsProducts();
        ...
        if (!empty($products)) {
            ...
            if($query->getCompatsProducts()){
                $result
                    ...
                    ->setTotalProductsCount(count($products));
            }else{
                $result
                    ->setProducts($products)
