...
namespace PrestaShop\Module\AsGroup\Form\Admin\Sell\Product\Combination;
...
class CombinationItemType extends TranslatorAwareType
{
    ...
    /**
     * Override the buildForm method to customize form fields
     */
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $actionButtons = [
            'ean13' => [
                ...
                'options' => [
                    ...
                    // 'icon' => 'barcode-icon',
                    'attr' => [
                        'class' => 'ean_print barcode',
                        'onclick' => 'generateEanCombination(__combination_id__ , __ean13__)'
        ...
        $builder
            ...
            //     'required' => false,
            //     'label' => $this->trans('EAN-13', 'Admin.Catalog.Feature'),
    ...
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        // pre($view->vars['placeholder_data']);
    }
