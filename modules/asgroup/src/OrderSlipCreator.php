...
use PrestaShop\PrestaShop\Adapter\Order\Refund\OrderSlipCreator as BaseOrderSlipCreator;
...
/**
 * Class OrderSlipCreator is responsible for creating an OrderSlip for a refund
 */
class OrderSlipCreator extends BaseOrderSlipCreator
{
    /**
    ...
    public function create(
        Order $order,
        \PrestaShop\PrestaShop\Adapter\Order\Refund\OrderRefundSummary $orderRefundSummary // Use fully qualified class name
    ) {
