...
namespace PrestaShop\AsGroup\Grid\Query;
 ...
 */
final class OrderQueryBuilder implements AbstractDoctrineQueryBuilder
{
    /**
     * @var Connection
     */
    ...
    public function getSearchQueryBuilder(SearchCriteriaInterface $searchCriteria)
    {
        ...
        ->select('GROUP_CONCAT(od.product_reference SEPARATOR ", ")')
        ...
        $qb = $this
            ...
            ->addSelect('(' . $subQuery . ') AS product_reference')
    ...
    private function getBaseQueryBuilder(array $filters)
    {
        $qb = $this->connection
            ...
            // ->addSelect('od.product_reference AS product_reference')
            // 
