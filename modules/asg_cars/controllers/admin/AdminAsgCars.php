        ...
        foreach ($cars as $row) {
            ...
            if (!isset($groupedCars[$carId])) {
                $groupedCars[$carId] = [
                    ...
                    'details_pt' => $row['details_pt'],
                    'details_it' => $row['details_it'],
        ...
        if (Tools::getValue('id') == 0) {
            ...
            Db::getInstance(_PS_USE_SQL_SLAVE_)->execute(
                'INSERT INTO ' . _DB_PREFIX_ . 'asg_cars (
                    id_shop, name, description_en,description_es,description_fr,description_pt,description_it,details_en,details_es,details_fr,details_pt,details_it,budget_en,budget_es,budget_fr,budget_pt,budget_it, display,  
                    images, created_at
                ) VALUES (
                    ...
                    "' . pSQL(Tools::getValue('details_en')) . '",
                    "' . pSQL(Tools::getValue('details_es')) . '",
                    "' . pSQL(Tools::getValue('details_fr')) . '",
                    "' . pSQL(Tools::getValue('details_pt')) . '",
                    "' . pSQL(Tools::getValue('details_it')) . '",
            ...
            Db::getInstance(_PS_USE_SQL_SLAVE_)->execute(
                ...
                SET 
                    ...
                    details_en="' . pSQL(Tools::getValue('details_en')) . '",
                    details_es="' . pSQL(Tools::getValue('details_es')) . '",
                    details_fr="' . pSQL(Tools::getValue('details_fr')) . '",
                    details_pt="' . pSQL(Tools::getValue('details_pt')) . '",
                    details_it="' . pSQL(Tools::getValue('details_it')) . '",
